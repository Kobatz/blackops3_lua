...
function Lobby.Process.CreateDedicatedModsLobby(arg0, arg1)
...
function Lobby.Process.JoinSystemlink(arg0, arg1, arg2, arg3, arg4, arg5)
	local registerVal6 = Lobby.Actions.OpenSpinner()
	local registerVal7 = Lobby.Actions.CloseSpinner()
	local registerVal8 = Lobby.Actions.JoinHost(arg0, arg1, arg2, arg3, arg4)
	local registerVal9 = Lobby.Actions.CloseSpinner()
	local registerVal10 = Lobby.Actions.ErrorPopup(registerVal8)
	local registerVal11 = Lobby.Actions.CloseSpinner()
	registerVal11.name = (registerVal11.name .. "CheckMods")
	{}.probeResult = {}
	{}.probeResult.ugcInfo = arg5
	local registerVal13 = Lobby.Actions.CheckMods(arg0, {}, true)
	local registerVal14 = Lobby.Actions.ErrorPopup(registerVal13)
	local registerVal15 = Lobby.Actions.SubscribeUGC(arg0, registerVal13)
	local registerVal16 = Lobby.Actions.ErrorPopup(registerVal15)
	local registerVal17 = Lobby.Actions.CloseSpinner()
	registerVal17.name = (registerVal9.name .. "SubscribeUGC")
	local registerVal18 = Lobby.Actions.InstalledUGC(arg0, registerVal13)
	local registerVal19 = Lobby.Actions.ErrorPopup(registerVal18)
	local registerVal20 = Lobby.Actions.CloseSpinner()
	registerVal20.name = (registerVal9.name .. "InstalledUGC")
	local registerVal21 = Lobby.Actions.LoadMod(arg0, registerVal13)
	local registerVal22 = Lobby.Actions.ErrorPopup(registerVal21)
	local registerVal23 = Lobby.Actions.CloseSpinner()
	registerVal23.name = (registerVal9.name .. "LoadedMod")
	Lobby.Process.ForceAction(registerVal9, registerVal10)
	local registerVal24 = {}
	registerVal24.head = registerVal6
	registerVal24.interrupt = Lobby.Interrupt.NONE
	registerVal24.force = true
	registerVal24.cancellable = true
	Lobby.Process.AddActions(registerVal6, registerVal13)
	Lobby.Process.AddActions(registerVal13, registerVal15, registerVal9, registerVal11)
	Lobby.Process.AddActions(registerVal15, registerVal18, registerVal9, registerVal17)
	Lobby.Process.AddActions(registerVal18, registerVal21, registerVal9, registerVal20)
	Lobby.Process.AddActions(registerVal21, registerVal8, registerVal9, registerVal23)
	Lobby.Process.AddActions(registerVal8, registerVal7, registerVal9, registerVal9)
	Lobby.Process.ForceAction(registerVal11, registerVal14)
	Lobby.Process.ForceAction(registerVal17, registerVal16)
	Lobby.Process.ForceAction(registerVal20, registerVal19)
	Lobby.Process.ForceAction(registerVal23, registerVal22)
	return registerVal24
end
...
function Lobby.Process.PromoteClientToPrivateLobbyHost(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)
	...
	Engine.PrintInfo(Enum.consoleLabel.LABEL_LOBBYHOST, ("Lobby.Process.PromoteClientToPrivateLobbyHost: menuId(" .. registerVal9 .. "), lobbyType(" .. arg2 .. "), mainMode(" .. arg1 .. "), lobbyTimerType(" .. registerVal10.lobbyTimerType .. ").
"))
...
function Lobby.Process.PromoteClientToGameLobbyHost(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)
	...
	Engine.PrintInfo(Enum.consoleLabel.LABEL_LOBBYHOST, ("Lobby.Process.PromoteClientToGameLobbyHost: menuId(" .. registerVal9 .. "), lobbyType(" .. arg2 .. "), mainMode(" .. arg1 .. "), lobbyTimerType(" .. registerVal10.lobbyTimerType .. ").
"))
...
function Lobby.Process.LoadMod(arg0, arg1)
	Engine.PrintInfo(Enum.consoleLabel.LABEL_LOBBY, ("LoadMod: " .. arg1.ugcName .. "
"))
	...
	{}.probeResult = {}
	{}.probeResult.ugcInfo = arg1
	local registerVal6 = Lobby.Actions.CheckMods(arg0, {}, false)
...
function Lobby.Process.NeedInstallUGC(arg0, arg1)
	Engine.PrintInfo(Enum.consoleLabel.LABEL_LOBBY, ("NeedInstallUGC: " .. arg1.ugcType .. " " .. arg1.ugcName .. "
"))
	local registerVal2 = Lobby.Actions.OpenSpinner()
	local registerVal3 = Lobby.Actions.CloseSpinner()
	local registerVal4 = Lobby.Actions.CloseSpinner()
