...
CoD.StartMenu_Options_PC_Graphics_Video = registerVal2
local function __FUNC_4D5_(arg0, arg1)
	...
	registerVal2:setClass(CoD.StartMenu_Options_PC_Graphics_Video)
	registerVal2.id = "StartMenu_Options_PC_Graphics_Video"
	...
	registerVal3:setDataSource("OptionGraphicsVideo")
	...
	local function __FUNC_AA6_(arg0)
	...
	registerVal4:linkToElementModel(registerVal3, "description", true, __FUNC_AA6_)
	...
	registerVal4:linkToElementModel(registerVal3, "label", true, __FUNC_B7F_)
	...
	registerVal2:registerEventHandler("gain_focus", __FUNC_C6F_)
	local function __FUNC_D74_(arg0)
		arg0.graphicsList:close()
		arg0.optionInfo:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_D74_)
	if __FUNC_278_ then
...
CoD.StartMenu_Options_PC_Graphics_Video.new = __FUNC_4D5_
