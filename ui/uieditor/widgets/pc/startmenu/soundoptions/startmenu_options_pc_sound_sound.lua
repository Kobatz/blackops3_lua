...
local function __FUNC_275_(arg0, arg1)
	...
	local function __FUNC_3A1_(arg0, arg1)
	...
	arg0:registerEventHandler("dropdown_triggered", __FUNC_3A1_)
end

local registerVal2 = InheritFrom(LUI.UIElement)
CoD.StartMenu_Options_PC_Sound_Sound = registerVal2
local function __FUNC_4D1_(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.StartMenu_Options_PC_Sound_Sound)
	registerVal2.id = "StartMenu_Options_PC_Sound_Sound"
	...
	registerVal3:setDataSource("OptionSoundSound")
	...
	registerVal4:linkToElementModel(registerVal3, "description", true, __FUNC_A9C_)
	local function __FUNC_B77_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal4:linkToElementModel(registerVal3, "label", true, __FUNC_B77_)
	...
	registerVal2:registerEventHandler("gain_focus", __FUNC_C67_)
	local function __FUNC_D6C_(arg0)
		arg0.graphicsList:close()
		arg0.optionInfo:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_D6C_)
	if __FUNC_275_ then
...
CoD.StartMenu_Options_PC_Sound_Sound.new = __FUNC_4D1_
