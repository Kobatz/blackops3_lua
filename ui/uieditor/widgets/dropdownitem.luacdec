...
CoD.DropdownItem = registerVal1
function CoD.DropdownItem.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.DropdownItem)
	registerVal2.id = "DropdownItem"
	...
	registerVal2.Text:linkToElementModel(registerVal2, "itemName", true, __FUNC_AB0_)
	local registerVal8 = {}
	local registerVal9 = {}
	...
	registerVal9.DefaultClip = __FUNC_B44_
	local function __FUNC_D0B_()
		registerVal2:setupElementClipCounter(3.000000)
		registerVal4:completeAnimation()
		registerVal2.Text:setRGB(1.000000, 1.000000, 1.000000)
		registerVal2.clipFinished(registerVal4, {})
	...
	registerVal9.LoseFocus = __FUNC_D0B_
	local function __FUNC_F50_()
		registerVal2:setupElementClipCounter(3.000000)
		registerVal4:completeAnimation()
		registerVal2.Text:setRGB(1.000000, 1.000000, 1.000000)
		registerVal2.clipFinished(registerVal4, {})
	...
	registerVal9.Focus = __FUNC_F50_
	...
	registerVal9.DefaultClip = __FUNC_1112_
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_121C_)
