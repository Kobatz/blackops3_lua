...
CoD.MissionRecordVault_AccoladesGroundVehicleDestroy = registerVal1
function CoD.MissionRecordVault_AccoladesGroundVehicleDestroy.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.MissionRecordVault_AccoladesGroundVehicleDestroy)
	registerVal2.id = "MissionRecordVault_AccoladesGroundVehicleDestroy"
	...
	registerVal3:setRGB(1.000000, 0.980000, 0.490000)
	registerVal3:setImage(RegisterImage("uie_ground_vehicle"))
	...
	registerVal4:linkToElementModel(registerVal2, "centerText", true, __FUNC_8E6_)
	...
	registerVal6.DefaultClip = __FUNC_AA4_
	local function __FUNC_C07_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.GainFocus = __FUNC_C07_
	...
	registerVal2:linkToElementModel(registerVal2, "completed", true, __FUNC_D9D_)
	local function __FUNC_EBB_(arg0)
		arg0.centerText:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_EBB_)
