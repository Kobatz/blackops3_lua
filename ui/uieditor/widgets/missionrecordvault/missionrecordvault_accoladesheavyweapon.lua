...
CoD.MissionRecordVault_AccoladesHeavyWeapon = registerVal1
function CoD.MissionRecordVault_AccoladesHeavyWeapon.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.MissionRecordVault_AccoladesHeavyWeapon)
	registerVal2.id = "MissionRecordVault_AccoladesHeavyWeapon"
	...
	registerVal3:setImage(RegisterImage("uie_heavy_weapon"))
	...
	registerVal4:linkToElementModel(registerVal2, "centerText", true, __FUNC_8D3_)
