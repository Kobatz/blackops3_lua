...
CoD.MissionRecordVault_AccoladesBullshark = registerVal1
function CoD.MissionRecordVault_AccoladesBullshark.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.MissionRecordVault_AccoladesBullshark)
	registerVal2.id = "MissionRecordVault_AccoladesBullshark"
	...
	registerVal3:setImage(RegisterImage("uie_bullshark"))
