...
CoD.MissionRecordVault_AccoladesKills = registerVal2
local function __FUNC_2CE_(arg0, arg1)
	...
	registerVal2:setClass(CoD.MissionRecordVault_AccoladesKills)
	registerVal2.id = "MissionRecordVault_AccoladesKills"
	...
	registerVal3:setRGB(1.000000, 0.980000, 0.590000)
	registerVal3:setImage(RegisterImage("uie_kill"))
	registerVal2:addElement(registerVal3)
	registerVal2.image = registerVal3
	local registerVal4 = LUI.UIText.new()
	registerVal4:setLeftRight(true, true, 39.000000, -35.000000)
	registerVal4:setTopBottom(false, false, -33.000000, -3.000000)
	...
	registerVal4:linkToElementModel(registerVal2, "centerText", true, __FUNC_949_)
	...
	registerVal8.condition = __FUNC_C06_
	registerVal7 = {registerVal8}
	registerVal2:mergeStateConditions(registerVal7)
	local function __FUNC_C7D_(arg1)
		local registerVal4 = {}
	...
	registerVal2:linkToElementModel(registerVal2, "completed", true, __FUNC_C7D_)
	local function __FUNC_D9B_(arg0)
		arg0.centerText:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_D9B_)
	if __FUNC_1D2_ then
...
CoD.MissionRecordVault_AccoladesKills.new = __FUNC_2CE_
