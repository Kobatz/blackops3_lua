...
local function __FUNC_1D1_(arg0)
...
CoD.MissionRecordVault_AccoladesFind = registerVal2
local function __FUNC_2CE_(arg0, arg1)
	...
	registerVal2:setClass(CoD.MissionRecordVault_AccoladesFind)
	registerVal2.id = "MissionRecordVault_AccoladesFind"
	...
	registerVal3:setRGB(1.000000, 0.980000, 0.580000)
	registerVal3:setImage(RegisterImage("uie_collectibles"))
	registerVal2:addElement(registerVal3)
	registerVal2.image = registerVal3
	local registerVal4 = LUI.UIText.new()
	registerVal4:setLeftRight(true, true, 33.500000, -40.500000)
	registerVal4:setTopBottom(false, false, -48.500000, -18.500000)
	registerVal4:setRGB(1.000000, 1.000000, 0.000000)
	registerVal4:setAlpha(0.000000)
	registerVal4:setTTF("fonts/escom.ttf")
	registerVal4:setAlignment(Enum.LUIAlignment.LUI_ALIGNMENT_CENTER)
	registerVal4:setAlignment(Enum.LUIAlignment.LUI_ALIGNMENT_TOP)
	local function __FUNC_958_(arg0)
	...
	registerVal4:linkToElementModel(registerVal2, "centerText", true, __FUNC_958_)
	registerVal2:addElement(registerVal4)
	registerVal2.centerText = registerVal4
	local registerVal5 = {}
	local registerVal6 = {}
	local function __FUNC_A12_()
		registerVal2:setupElementClipCounter(2.000000)
		registerVal3:completeAnimation()
		registerVal2.image:setRGB(1.000000, 0.960000, 0.000000)
		registerVal2.clipFinished(registerVal3, {})
		registerVal4:completeAnimation()
		registerVal2.centerText:setRGB(1.000000, 0.960000, 0.000000)
		registerVal2.clipFinished(registerVal4, {})
	end

	registerVal6.DefaultClip = __FUNC_A12_
	...
	local function __FUNC_CDF_(arg0, arg2, arg3)
		local registerVal3 = IsSelfModelValueTrue(arg2, arg1, "completed")
		return (not registerVal3)
	end

	registerVal8.condition = __FUNC_CDF_
	registerVal7 = {registerVal8}
	registerVal2:mergeStateConditions(registerVal7)
	local function __FUNC_D55_(arg1)
		local registerVal4 = {}
	...
	registerVal2:linkToElementModel(registerVal2, "completed", true, __FUNC_D55_)
	local function __FUNC_E73_(arg0)
		arg0.centerText:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_E73_)
	if __FUNC_1D1_ then
		__FUNC_1D1_(registerVal2, arg1, arg0)
	end
	return registerVal2
end

CoD.MissionRecordVault_AccoladesFind.new = __FUNC_2CE_
