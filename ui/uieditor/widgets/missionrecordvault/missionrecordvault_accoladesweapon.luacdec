...
CoD.MissionRecordVault_AccoladesWeapon = registerVal1
function CoD.MissionRecordVault_AccoladesWeapon.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.MissionRecordVault_AccoladesWeapon)
	registerVal2.id = "MissionRecordVault_AccoladesWeapon"
	...
	registerVal3:setImage(RegisterImage("uie_weapons"))
	...
	registerVal4:linkToElementModel(registerVal2, "centerText", true, __FUNC_8C1_)
	...
	registerVal6.GainFocus = __FUNC_BE3_
	local function __FUNC_C42_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.Focus = __FUNC_C42_
	local function __FUNC_CA2_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.LoseFocus = __FUNC_CA2_
	registerVal5.Incomplete = registerVal6
	registerVal2.clipsPerState = registerVal5
	local registerVal7 = {}
	local registerVal8 = {}
	registerVal8.stateName = "Incomplete"
	local function __FUNC_D02_(arg0, arg2, arg3)
		local registerVal3 = IsSelfModelValueTrue(arg2, arg1, "completed")
		return (not registerVal3)
	end

	registerVal8.condition = __FUNC_D02_
	...
	registerVal2:linkToElementModel(registerVal2, "completed", true, __FUNC_D79_)
	local function __FUNC_E97_(arg0)
		arg0.centerText:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_E97_)
