...
CoD.MissionRecordVault_AccoladesTraversal = registerVal1
function CoD.MissionRecordVault_AccoladesTraversal.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.MissionRecordVault_AccoladesTraversal)
	registerVal2.id = "MissionRecordVault_AccoladesTraversal"
	...
	registerVal3:setImage(RegisterImage("uie_traversal"))
