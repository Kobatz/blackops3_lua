...
CoD.MissionRecordVault_AccoladesGrenade = registerVal1
function CoD.MissionRecordVault_AccoladesGrenade.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.MissionRecordVault_AccoladesGrenade)
	registerVal2.id = "MissionRecordVault_AccoladesGrenade"
	...
	registerVal3:setRGB(1.000000, 0.980000, 0.570000)
	registerVal3:setImage(RegisterImage("uie_grenade"))
	...
	local function __FUNC_BE7_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.GainFocus = __FUNC_BE7_
	local function __FUNC_C46_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.Focus = __FUNC_C46_
	local function __FUNC_CA6_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.LoseFocus = __FUNC_CA6_
	registerVal5.Incomplete = registerVal6
	registerVal2.clipsPerState = registerVal5
	local registerVal7 = {}
	local registerVal8 = {}
	registerVal8.stateName = "Incomplete"
	local function __FUNC_D06_(arg0, arg2, arg3)
		local registerVal3 = IsSelfModelValueTrue(arg2, arg1, "completed")
		return (not registerVal3)
	end

	registerVal8.condition = __FUNC_D06_
	registerVal7 = {registerVal8}
	registerVal2:mergeStateConditions(registerVal7)
	local function __FUNC_D7D_(arg1)
		local registerVal4 = {}
	...
	registerVal2:linkToElementModel(registerVal2, "completed", true, __FUNC_D7D_)
	local function __FUNC_E9B_(arg0)
		arg0.centerText:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_E9B_)
