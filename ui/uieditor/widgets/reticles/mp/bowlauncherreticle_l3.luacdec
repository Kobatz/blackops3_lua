...
CoD.BowLauncherReticle_L3 = registerVal1
function CoD.BowLauncherReticle_L3.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.BowLauncherReticle_L3)
	registerVal2.id = "BowLauncherReticle_L3"
	...
	registerVal3:setImage(RegisterImage("uie_bowlauncher_line3"))
	registerVal3:setMaterial(LUI.UIImage.GetCachedMaterial("ui_add"))
	registerVal2:addElement(registerVal3)
	registerVal2.Line3 = registerVal3
	local registerVal4 = {}
	local registerVal5 = {}
