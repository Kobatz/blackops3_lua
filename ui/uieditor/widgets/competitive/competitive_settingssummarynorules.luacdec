...
CoD.Competitive_SettingsSummaryNoRules = registerVal1
function CoD.Competitive_SettingsSummaryNoRules.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.Competitive_SettingsSummaryNoRules)
	registerVal2.id = "Competitive_SettingsSummaryNoRules"
	...
	registerVal5:setLeftRight(true, false, 5.000000, 270.000000)
	...
	registerVal6:setLeftRight(true, false, 7.000000, 270.000000)
	...
	registerVal8.DefaultClip = __FUNC_BE3_
	local function __FUNC_C42_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal8.FadeIn = __FUNC_C42_
	local function __FUNC_CA2_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal8.HideForGameStart = __FUNC_CA2_
