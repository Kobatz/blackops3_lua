...
CoD.BackgroundPattern03 = registerVal1
function CoD.BackgroundPattern03.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.BackgroundPattern03)
	registerVal2.id = "BackgroundPattern03"
	...
	registerVal3:setShaderVector(0.000000, 2.500000, 1.000000, 0.000000, 0.000000)
