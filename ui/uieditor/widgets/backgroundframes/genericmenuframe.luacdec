...
CoD.GenericMenuFrame = registerVal1
function CoD.GenericMenuFrame.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.GenericMenuFrame)
	registerVal2.id = "GenericMenuFrame"
	...
	local function __FUNC_B2A_(arg0)
		registerVal7:setModel(arg0, arg1)
	end

	registerVal7:linkToElementModel(registerVal2, nil, false, __FUNC_B2A_)
	local function __FUNC_B7A_(arg0, arg2)
	...
	registerVal7:registerEventHandler("menu_loaded", __FUNC_B7A_)
	registerVal2:addElement(registerVal7)
	registerVal2.feFooterContainerNOTLobby = registerVal7
	local function __FUNC_C0D_(arg0, arg2)
	...
	LUI.OverrideFunction_CallOriginalFirst(registerVal2, "setState", __FUNC_C0D_)
