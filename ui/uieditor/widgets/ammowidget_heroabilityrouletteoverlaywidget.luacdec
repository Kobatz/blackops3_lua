...
CoD.AmmoWidget_HeroAbilityRouletteOverlayWidget = registerVal1
function CoD.AmmoWidget_HeroAbilityRouletteOverlayWidget.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.AmmoWidget_HeroAbilityRouletteOverlayWidget)
	registerVal2.id = "AmmoWidget_HeroAbilityRouletteOverlayWidget"
	...
	LUI.OverrideFunction_CallOriginalFirst(registerVal5, "setText", __FUNC_AF9_)
	...
	registerVal8.DefaultClip = __FUNC_B59_
	registerVal7.DefaultState = registerVal8
	registerVal2.clipsPerState = registerVal7
	local function __FUNC_CB7_(arg0)
		arg0.FEButtonPanel0:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_CB7_)
