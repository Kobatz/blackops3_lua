...
CoD.scorestreakVignetteContainer = registerVal1
function CoD.scorestreakVignetteContainer.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.scorestreakVignetteContainer)
	registerVal2.id = "scorestreakVignetteContainer"
	...
	registerVal5.DefaultClip = __FUNC_5F0_
