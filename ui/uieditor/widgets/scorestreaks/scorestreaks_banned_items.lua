...
CoD.scorestreaks_Banned_Items = registerVal1
function CoD.scorestreaks_Banned_Items.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.scorestreaks_Banned_Items)
	registerVal2.id = "scorestreaks_Banned_Items"
	...
	registerVal6.DefaultClip = __FUNC_90C_
	registerVal5.DefaultState = registerVal6
	registerVal6 = {}
	local function __FUNC_A71_()
		registerVal2:setupElementClipCounter(2.000000)
		registerVal3:completeAnimation()
	...
	registerVal6.DefaultClip = __FUNC_A71_
	...
	registerVal8.condition = __FUNC_BD5_
	registerVal7 = {registerVal8}
	registerVal2:mergeStateConditions(registerVal7)
	local function __FUNC_C2E_(arg1)
		local registerVal4 = {}
	...
	registerVal2:linkToElementModel(registerVal2, nil, true, __FUNC_C2E_)
