...
CoD.scorestreaks_TitleBox = registerVal1
function CoD.scorestreaks_TitleBox.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.scorestreaks_TitleBox)
	registerVal2.id = "scorestreaks_TitleBox"
	...
	registerVal5:setText(LocalizeIntoString("", "Care Package"))
	...
	local function __FUNC_B3A_(arg0, arg1)
		ScaleWidgetToLabel(registerVal2, arg0, 2.000000)
	end

	LUI.OverrideFunction_CallOriginalFirst(registerVal5, "setText", __FUNC_B3A_)
	registerVal2:addElement(registerVal5)
	registerVal2.ScorestreaksLabel = registerVal5
	local registerVal6 = LUI.UIImage.new()
	registerVal6:setLeftRight(true, false, -25.000000, 7.000000)
	registerVal6:setTopBottom(false, false, -27.000000, 27.000000)
	...
	registerVal2.pixelb = registerVal6
	local function __FUNC_B99_(arg0)
		arg0.TitleGlow1:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_B99_)
