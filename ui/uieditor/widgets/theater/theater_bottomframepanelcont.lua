...
CoD.Theater_BottomFramePanelCont = registerVal1
function CoD.Theater_BottomFramePanelCont.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.Theater_BottomFramePanelCont)
	registerVal2.id = "Theater_BottomFramePanelCont"
	...
	registerVal3:setImage(RegisterImage("uie_t7_hud_theater_bottomframe"))
	...
	registerVal2.bottomframe = registerVal3
