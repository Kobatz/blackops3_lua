...
CoD.Theater_TopFramePanelCont = registerVal1
function CoD.Theater_TopFramePanelCont.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.Theater_TopFramePanelCont)
	registerVal2.id = "Theater_TopFramePanelCont"
	...
	registerVal3:setImage(RegisterImage("uie_t7_hud_theater_topframe"))
	...
	registerVal2.topframe = registerVal3
