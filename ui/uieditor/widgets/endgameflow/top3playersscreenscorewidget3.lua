...
CoD.Top3PlayersScreenScoreWidget3 = registerVal1
function CoD.Top3PlayersScreenScoreWidget3.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.Top3PlayersScreenScoreWidget3)
	registerVal2.id = "Top3PlayersScreenScoreWidget3"
	...
	registerVal6:setTopBottom(true, false, 46.000000, 106.000000)
	registerVal6.Image00001:setAlpha(0.000000)
	registerVal6.Image2:setAlpha(0.000000)
	local function __FUNC_11D6_(arg0)
		registerVal6:setModel(arg0, arg1)
	end

	registerVal6:linkToElementModel(registerVal2, nil, false, __FUNC_11D6_)
	...
	registerVal6:linkToElementModel(registerVal2, "heading", true, __FUNC_1226_)
	...
	local function __FUNC_1302_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal7:linkToElementModel(registerVal2, "score", true, __FUNC_1302_)
	...
	registerVal8:setImage(RegisterImage("uie_t7_hud_mp_notifications_endgame_ribbon3"))
	...
	registerVal9:setImage(RegisterImage("uie_t7_hud_mp_notifications_endgame_ribbon3"))
	registerVal9:setMaterial(LUI.UIImage.GetCachedMaterial("ui_add"))
	registerVal2:addElement(registerVal9)
	registerVal2.RibbonImage = registerVal9
	local registerVal10 = CoD.KillcamWidgetFctnLine.new(arg0, arg1)
	registerVal10:setLeftRight(true, false, -4.000000, 316.000000)
	...
	registerVal11:setLeftRight(true, false, -4.000000, 316.000000)
	...
	registerVal12:linkToElementModel(registerVal2, "score", true, __FUNC_13BA_)
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_148F_)
