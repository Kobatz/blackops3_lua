...
CoD.Top3PlayersScreenScoreWidget2 = registerVal1
function CoD.Top3PlayersScreenScoreWidget2.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.Top3PlayersScreenScoreWidget2)
	registerVal2.id = "Top3PlayersScreenScoreWidget2"
	...
	registerVal5:setTopBottom(true, false, 0.000000, 108.000000)
	...
	registerVal6:setLeftRight(true, false, 3.000000, 300.000000)
	registerVal6:setTopBottom(true, false, 48.000000, 108.000000)
	...
	registerVal6:linkToElementModel(registerVal2, nil, false, __FUNC_11C7_)
	...
	registerVal7:linkToElementModel(registerVal2, "score", true, __FUNC_12F2_)
	registerVal2:addElement(registerVal7)
	registerVal2.Score0 = registerVal7
	local registerVal8 = LUI.UIImage.new()
	registerVal8:setLeftRight(true, false, 47.000000, 103.000000)
	registerVal8:setTopBottom(true, false, -1.000000, 41.000000)
	registerVal8:setRGB(0.600000, 0.600000, 0.600000)
	registerVal8:setImage(RegisterImage("uie_t7_hud_mp_notifications_endgame_ribbon2"))
	...
	registerVal9:setLeftRight(true, false, 47.000000, 103.000000)
	registerVal9:setTopBottom(true, false, -1.000000, 41.000000)
	registerVal9:setImage(RegisterImage("uie_t7_hud_mp_notifications_endgame_ribbon2"))
	...
	registerVal10:setTopBottom(true, false, -9.000000, -1.000000)
	...
	registerVal11:setTopBottom(true, false, 110.000000, 118.000000)
	...
	registerVal12:setTopBottom(false, false, -53.000000, -13.000000)
	...
	registerVal12:linkToElementModel(registerVal2, "score", true, __FUNC_13AA_)
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_147F_)
