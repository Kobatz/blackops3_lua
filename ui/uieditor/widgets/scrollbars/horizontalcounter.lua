...
CoD.horizontalCounter = registerVal1
function CoD.horizontalCounter.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.horizontalCounter)
	registerVal2.id = "horizontalCounter"
	...
	registerVal9.DefaultClip = __FUNC_C85_
	...
	registerVal9.DefaultClip = __FUNC_1006_
	...
	registerVal9.DefaultClip = __FUNC_1609_
	registerVal8.AtRight = registerVal9
	registerVal9 = {}
	local function __FUNC_1951_()
		registerVal2:setupElementClipCounter(5.000000)
		registerVal3:completeAnimation()
	...
	registerVal9.DefaultClip = __FUNC_1951_
	registerVal8.NoItems = registerVal9
	registerVal2.clipsPerState = registerVal8
	local registerVal10 = {}
	local registerVal11 = {}
	registerVal11.stateName = "AtLeftAndRight"
	local function __FUNC_1BA7_(arg0, arg1, arg2)
		return IsSelfInState(registerVal2, "AtLeftAndRight")
	end

	registerVal11.condition = __FUNC_1BA7_
	local registerVal12 = {}
	registerVal12.stateName = "AtLeft"
	local function __FUNC_1C13_(arg0, arg1, arg2)
		return IsSelfInState(registerVal2, "AtLeft")
	end

	registerVal12.condition = __FUNC_1C13_
	local registerVal13 = {}
	registerVal13.stateName = "AtRight"
	local function __FUNC_1C77_(arg0, arg1, arg2)
		return IsSelfInState(registerVal2, "AtRight")
	end

	registerVal13.condition = __FUNC_1C77_
	local registerVal14 = {}
	registerVal14.stateName = "NoItems"
	local function __FUNC_1CDC_(arg0, arg1, arg2)
		return true
	end

	registerVal14.condition = __FUNC_1CDC_
