...
CoD.systemOverlay_Layout_SaveEmblem = registerVal1
function CoD.systemOverlay_Layout_SaveEmblem.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.systemOverlay_Layout_SaveEmblem)
	registerVal2.id = "systemOverlay_Layout_SaveEmblem"
	...
	registerVal3:linkToElementModel(registerVal2, "categoryType", true, __FUNC_F71_)
	...
	local function __FUNC_1053_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal4:linkToElementModel(registerVal2, "title", true, __FUNC_1053_)
	...
	local function __FUNC_110A_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal5:linkToElementModel(registerVal2, "description", true, __FUNC_110A_)
	...
	local function __FUNC_11DC_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal6:linkToElementModel(registerVal2, "listDatasource", true, __FUNC_11DC_)
	local function __FUNC_1276_(arg2)
		local registerVal2 = {}
	...
	registerVal6:linkToElementModel(registerVal6, "disabled", true, __FUNC_1276_)
	local function __FUNC_1431_(arg2, arg3)
	...
	registerVal6:registerEventHandler("gain_focus", __FUNC_1431_)
	local function __FUNC_15C3_(arg0, arg1)
	...
	registerVal6:registerEventHandler("lose_focus", __FUNC_15C3_)
	local function __FUNC_1692_(arg0, arg1, arg2, arg3)
	...
	local function __FUNC_171F_(arg0, arg1, arg2)
	...
	arg0:AddButtonCallbackFunction(registerVal6, arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", __FUNC_1692_, __FUNC_171F_, false)
	...
	registerVal7:linkToElementModel(registerVal2, nil, false, __FUNC_184E_)
	...
	registerVal7:linkToElementModel(registerVal2, "inputText", true, __FUNC_189E_)
	local function __FUNC_194A_(arg0, arg2)
		EmblemEditor_HandleKeyboardComplete(registerVal2, arg0, arg1, arg2)
		if not nil then
	...
	registerVal7:registerEventHandler("ui_keyboard_input", __FUNC_194A_)
	local function __FUNC_19FA_(arg2, arg3)
		if arg2.gainFocus then
			local registerVal3 = arg2.gainFocus(arg2, arg3)
		else
			if arg2.super.gainFocus then
	...
	registerVal7:registerEventHandler("gain_focus", __FUNC_19FA_)
	...
	registerVal7:registerEventHandler("lose_focus", __FUNC_1B8B_)
	local function __FUNC_1C5A_(arg0, arg1, arg2, arg3)
		ProcessKeyboardCompleteAction(registerVal2, arg0, arg2, arg1)
		return true
	end

	local function __FUNC_1CCB_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT")
		return true
	end

	arg0:AddButtonCallbackFunction(registerVal7, arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", __FUNC_1C5A_, __FUNC_1CCB_, false)
	...
	registerVal2:registerEventHandler("gain_focus", __FUNC_1DC6_)
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1EC7_)
