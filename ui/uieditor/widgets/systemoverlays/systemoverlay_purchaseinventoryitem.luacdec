...
CoD.SystemOverlay_PurchaseInventoryItem = registerVal1
function CoD.SystemOverlay_PurchaseInventoryItem.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.SystemOverlay_PurchaseInventoryItem)
	registerVal2.id = "SystemOverlay_PurchaseInventoryItem"
	...
	registerVal5:setLeftRight(true, false, 50.000000, 384.000000)
	registerVal5:setTopBottom(true, false, 50.000000, 272.000000)
	...
	registerVal5:linkToElementModel(registerVal2, "image", true, __FUNC_1644_)
	...
	registerVal6:linkToElementModel(registerVal2, "categoryType", true, __FUNC_16F8_)
	...
	local function __FUNC_17DB_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal7:linkToElementModel(registerVal2, "title", true, __FUNC_17DB_)
	...
	local function __FUNC_1892_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal8:linkToElementModel(registerVal2, "description", true, __FUNC_1892_)
	...
	registerVal9:linkToElementModel(registerVal2, "listDatasource", true, __FUNC_1964_)
	local function __FUNC_19FE_(arg2)
		local registerVal2 = {}
	...
	registerVal9:linkToElementModel(registerVal9, "disabled", true, __FUNC_19FE_)
	local function __FUNC_1BB9_(arg2, arg3)
	...
	registerVal9:registerEventHandler("gain_focus", __FUNC_1BB9_)
	...
	registerVal9:registerEventHandler("lose_focus", __FUNC_1D4B_)
	...
	arg0:AddButtonCallbackFunction(registerVal9, arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", __FUNC_1E1A_, __FUNC_1EA7_, true)
	...
	registerVal10:linkToElementModel(registerVal2, nil, false, __FUNC_1FD6_)
	local registerVal13 = {}
	local registerVal14 = {}
	registerVal14.stateName = "ShownInsufficientFunds"
	local function __FUNC_2026_(arg0, arg2, arg3)
	...
	registerVal14.condition = __FUNC_2026_
	local registerVal15 = {}
	registerVal15.stateName = "Shown"
	local function __FUNC_211E_(arg0, arg1, arg2)
		return AlwaysFalse()
	end

	registerVal15.condition = __FUNC_211E_
	local registerVal16 = {}
	registerVal16.stateName = "BalanceShownInsufficientFunds"
	local function __FUNC_2169_(arg0, arg2, arg3)
		local registerVal3 = IsControllerModelValueGreaterThanOrEqualToSelfModelValue(arg2, arg1, "CryptoKeyProgress.codPoints", "itemCODPointCost")
		if not registerVal3 then
	...
	registerVal10:subscribeToModel(registerVal13, __FUNC_246E_)
	local function __FUNC_259D_(arg1)
		local registerVal4 = {}
		registerVal4.name = "model_validation"
		registerVal4.menu = arg0
		local registerVal5 = Engine.GetModelValue(arg1)
	...
	registerVal10:linkToElementModel(registerVal10, "codpointcost", true, __FUNC_259D_)
	registerVal2:addElement(registerVal10)
	registerVal2.BlackMarketCODPointContainerSmall = registerVal10
	local registerVal11 = LUI.UIText.new()
	registerVal11:setLeftRight(true, false, 421.000000, 621.000000)
	registerVal11:setTopBottom(true, false, 110.500000, 135.500000)
	registerVal11:setTTF("fonts/default.ttf")
	registerVal11:setAlignment(Enum.LUIAlignment.LUI_ALIGNMENT_LEFT)
	registerVal11:setAlignment(Enum.LUIAlignment.LUI_ALIGNMENT_TOP)
	local function __FUNC_26BE_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal11:linkToElementModel(registerVal2, "codpointcostString", true, __FUNC_26BE_)
	registerVal2:addElement(registerVal11)
	registerVal2.codpointCostString = registerVal11
	local registerVal12 = CoD.cac_PurchasingExtraSlots.new(arg0, arg1)
	registerVal12:setLeftRight(true, false, 399.000000, 705.000000)
	registerVal12:setTopBottom(true, false, 115.000000, 211.000000)
	registerVal12:setAlpha(0.000000)
	registerVal12.PurchasingText:setText(Engine.Localize("MENU_PROCESSING_PURCHASE"))
	registerVal2:addElement(registerVal12)
	registerVal2.PurchasingWidget = registerVal12
	registerVal13 = {}
	registerVal14 = {}
	local function __FUNC_2776_()
	...
	registerVal14.DefaultClip = __FUNC_2776_
	registerVal13.DefaultState = registerVal14
	registerVal14 = {}
	local function __FUNC_28E1_()
		registerVal2:setupElementClipCounter(3.000000)
		registerVal5:completeAnimation()
		registerVal2.largeImage:setLeftRight(true, false, 64.000000, 384.000000)
		registerVal2.largeImage:setTopBottom(true, true, 53.000000, -53.000000)
	...
	registerVal14.DefaultClip = __FUNC_28E1_
	registerVal13.CWLPackage = registerVal14
	registerVal14 = {}
	local function __FUNC_2B19_()
		registerVal2:setupElementClipCounter(2.000000)
		registerVal11:completeAnimation()
	...
	registerVal14.DefaultClip = __FUNC_2B19_
	registerVal13.Purchasing = registerVal14
	registerVal2.clipsPerState = registerVal13
	registerVal15 = {}
	registerVal16 = {}
	registerVal16.stateName = "CWLPackage"
	local function __FUNC_2C85_(arg0, arg2, arg3)
		return IsSelfModelValueEqualTo(arg2, arg1, "state", "ESPORTS")
	end

	registerVal16.condition = __FUNC_2C85_
	registerVal17 = {}
	registerVal17.stateName = "Purchasing"
	local function __FUNC_2D0D_(arg0, arg1, arg2)
		return AlwaysFalse()
	end

	registerVal17.condition = __FUNC_2D0D_
	registerVal15 = {registerVal16, registerVal17}
	registerVal2:mergeStateConditions(registerVal15)
	local function __FUNC_2D59_(arg1)
		local registerVal4 = {}
		registerVal4.name = "model_validation"
		registerVal4.menu = arg0
		local registerVal5 = Engine.GetModelValue(arg1)
	...
	registerVal2:subscribeToModel(registerVal15, __FUNC_2E73_)
	local function __FUNC_3040_(arg0, arg1, arg2, arg3)
		...
		if not registerVal4 and registerVal4 and not registerVal4 and not registerVal4 then
			GoBackAndOpenStoreCodPointsOverlayOnParent(registerVal2, "InventoryItemCPStore", arg2)
			return true
		end
	end

	local function __FUNC_31D5_(arg0, arg1, arg2)
	...
	arg0:AddButtonCallbackFunction(registerVal2, arg1, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, nil, __FUNC_3040_, __FUNC_31D5_, false)
	registerVal9.id = "options"
	local function __FUNC_33E2_(arg0, arg1)
	...
	registerVal2:registerEventHandler("gain_focus", __FUNC_33E2_)
	local function __FUNC_34E3_(arg0)
		arg0.text:close()
		arg0.options:close()
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_34E3_)
