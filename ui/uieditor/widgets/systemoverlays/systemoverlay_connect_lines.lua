...
CoD.systemOverlay_Connect_Lines = registerVal1
function CoD.systemOverlay_Connect_Lines.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.systemOverlay_Connect_Lines)
	registerVal2.id = "systemOverlay_Connect_Lines"
	...
	local function __FUNC_617_()
		...
		local function __FUNC_8A0_(arg0, arg1)
			if not arg1.interrupted then
				arg0:beginAnimation("keyframe", 3009.000000, false, true, CoD.TweenType.Linear)
			end
		...
		__FUNC_8A0_(registerVal4, {})
		registerVal2.nextClip = "DefaultClip"
	end

	registerVal6.DefaultClip = __FUNC_617_
