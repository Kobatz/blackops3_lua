...
CoD.SystemOverlay_MapPackFrame = registerVal1
function CoD.SystemOverlay_MapPackFrame.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.SystemOverlay_MapPackFrame)
	registerVal2.id = "SystemOverlay_MapPackFrame"
	...
	registerVal3:linkToElementModel(registerVal2, "image", true, __FUNC_818_)
