...
CoD.MediaManager_PaintshopListItem = registerVal1
function CoD.MediaManager_PaintshopListItem.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.MediaManager_PaintshopListItem)
	registerVal2.id = "MediaManager_PaintshopListItem"
	...
	registerVal7:setLeftRight(true, true, 0.000000, -212.000000)
	...
	registerVal7:linkToElementModel(registerVal2, "showBuyImage", true, __FUNC_1353_)
	local function __FUNC_13FD_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
			registerVal7:setupWCPaintjobIconExtraCamRender(GetPaintshopExtraCamParameters(arg1, registerVal1))
		end
	end

	registerVal7:linkToElementModel(registerVal2, "paintjobSlotAndIndex", true, __FUNC_13FD_)
	registerVal2:addElement(registerVal7)
	registerVal2.extraCamRender = registerVal7
	...
	local function __FUNC_14DE_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
			registerVal8.itemName:setText(GetPaintjobName(registerVal1))
		end
	end

	registerVal8:linkToElementModel(registerVal2, "paintjobName", true, __FUNC_14DE_)
	...
	registerVal16:setLeftRight(true, false, 13.000000, 57.000000)
	...
	registerVal16:linkToElementModel(registerVal2, "plusImageSrc", true, __FUNC_15AF_)
	registerVal2:addElement(registerVal16)
	registerVal2.PlusImage = registerVal16
	local function __FUNC_1660_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal2.PlusImage:linkToElementModel(registerVal2, "showBuyImage", true, __FUNC_1660_)
	local registerVal17 = {}
	local registerVal18 = {}
	local function __FUNC_16F5_()
	...
	registerVal18.DefaultClip = __FUNC_16F5_
	local function __FUNC_1800_()
	...
	registerVal18.GainFocus = __FUNC_1800_
	...
	registerVal18.Focus = __FUNC_1A9F_
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1EF2_)
