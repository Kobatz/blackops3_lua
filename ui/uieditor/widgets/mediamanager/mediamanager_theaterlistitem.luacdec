...
CoD.MediaManager_TheaterListItem = registerVal1
function CoD.MediaManager_TheaterListItem.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.MediaManager_TheaterListItem)
	registerVal2.id = "MediaManager_TheaterListItem"
	...
	local function __FUNC_1327_(arg0)
	...
	registerVal7:linkToElementModel(registerVal2, "showPlusImage", true, __FUNC_1327_)
	local function __FUNC_13D1_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal7:linkToElementModel(registerVal2, "fileId", true, __FUNC_13D1_)
	...
	local function __FUNC_14BD_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal8:linkToElementModel(registerVal2, "fileName", true, __FUNC_14BD_)
	...
	registerVal16:linkToElementModel(registerVal2, "showPlusImage", true, __FUNC_1594_)
	local function __FUNC_1629_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal16:linkToElementModel(registerVal2, "plusImageSrc", true, __FUNC_1629_)
	registerVal2:addElement(registerVal16)
	registerVal2.PlusImage = registerVal16
	local registerVal17 = {}
	local registerVal18 = {}
	local function __FUNC_16DC_()
	...
	registerVal18.DefaultClip = __FUNC_16DC_
	local function __FUNC_17E8_()
	...
	registerVal18.GainFocus = __FUNC_17E8_
	local function __FUNC_1A87_()
		registerVal2:setupElementClipCounter(3.000000)
		registerVal4:completeAnimation()
		registerVal2.BoxButtonLrgInactive:setAlpha(1.000000)
		registerVal2.clipFinished(registerVal4, {})
	...
	registerVal18.Focus = __FUNC_1A87_
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1EDA_)
