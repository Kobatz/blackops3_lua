...
CoD.MediaManager_TheaterFileItemLarge = registerVal1
function CoD.MediaManager_TheaterFileItemLarge.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.MediaManager_TheaterFileItemLarge)
	registerVal2.id = "MediaManager_TheaterFileItemLarge"
	...
	registerVal5:setLeftRight(true, true, 1.250000, -1.250000)
	registerVal5:setTopBottom(true, false, 2.000000, 200.000000)
	...
	registerVal5:linkToElementModel(registerVal2, "fileId", true, __FUNC_C27_)
	...
	registerVal7:linkToElementModel(registerVal2, "fileName", true, __FUNC_D11_)
	...
	registerVal8:linkToElementModel(registerVal2, "fileDescription", true, __FUNC_DCA_)
	registerVal2:addElement(registerVal8)
	registerVal2.Description = registerVal8
	...
	registerVal11.DefaultClip = __FUNC_E82_
	registerVal10.DefaultState = registerVal11
	registerVal11 = {}
	local function __FUNC_11A3_()
		registerVal2:setupElementClipCounter(7.000000)
		registerVal3:completeAnimation()
		registerVal2.BG:setAlpha(0.000000)
		registerVal2.clipFinished(registerVal3, {})
	...
	local function __FUNC_150B_(arg1)
		local registerVal4 = {}
	...
	registerVal2:subscribeToModel(registerVal12, __FUNC_150B_)
	local function __FUNC_1634_(arg0)
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1634_)
