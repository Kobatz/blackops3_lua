...
CoD.GunsmithStatName = registerVal1
function CoD.GunsmithStatName.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.GunsmithStatName)
	registerVal2.id = "GunsmithStatName"
	...
	registerVal2.statName = registerVal4
