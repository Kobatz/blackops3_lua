...
CoD.GunsmithSlotsFull = registerVal1
function CoD.GunsmithSlotsFull.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.GunsmithSlotsFull)
	registerVal2.id = "GunsmithSlotsFull"
	...
	local function __FUNC_1009_(arg0)
		UpdateSlotCountText(registerVal2, registerVal7, arg1, Enum.StorageFileType.STORAGE_GUNSMITH)
	end

	registerVal7:subscribeToGlobalModel(arg1, "PerController", "Gunsmith.UpdateDataSource", __FUNC_1009_)
	...
	registerVal8:setText(Engine.Localize("MENU_GUNSMITH_SLOTS"))
