...
CoD.PaintshopSlotsFull = registerVal1
function CoD.PaintshopSlotsFull.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.PaintshopSlotsFull)
	registerVal2.id = "PaintshopSlotsFull"
	...
	local function __FUNC_100B_(arg0)
		UpdateSlotCountText(registerVal2, registerVal7, arg1, Enum.StorageFileType.STORAGE_PAINTJOBS)
	end

	registerVal7:subscribeToGlobalModel(arg1, "PerController", "Paintshop.UpdateDataSource", __FUNC_100B_)
	...
	registerVal8:setText(Engine.Localize("MENU_PAINTJOB_SLOTS"))
	...
	registerVal13.DefaultClip = __FUNC_10C7_
	...
	registerVal13.DefaultClip = __FUNC_1350_
	registerVal12.SlotsFull = registerVal13
	registerVal2.clipsPerState = registerVal12
	local function __FUNC_1858_(arg0)
		arg0.BackgroundPattern010:close()
		arg0.count:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1858_)
