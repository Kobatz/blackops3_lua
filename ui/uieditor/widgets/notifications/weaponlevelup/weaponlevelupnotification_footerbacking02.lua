...
CoD.WeaponLevelUpNotification_FooterBacking02 = registerVal1
function CoD.WeaponLevelUpNotification_FooterBacking02.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.WeaponLevelUpNotification_FooterBacking02)
	registerVal2.id = "WeaponLevelUpNotification_FooterBacking02"
	...
	local registerVal6 = {}
	local registerVal7 = {}
	local function __FUNC_72C_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal7.DefaultClip = __FUNC_72C_
	local function __FUNC_78E_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal7.TimeUp = __FUNC_78E_
