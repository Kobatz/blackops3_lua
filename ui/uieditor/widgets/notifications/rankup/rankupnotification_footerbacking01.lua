...
CoD.RankUpNotification_FooterBacking01 = registerVal1
function CoD.RankUpNotification_FooterBacking01.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.RankUpNotification_FooterBacking01)
	registerVal2.id = "RankUpNotification_FooterBacking01"
