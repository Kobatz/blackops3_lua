...
CoD.Notification2xpWeaponReward = registerVal1
function CoD.Notification2xpWeaponReward.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.Notification2xpWeaponReward)
	registerVal2.id = "Notification2xpWeaponReward"
	...
	registerVal6.DefaultClip = __FUNC_819_
	local function __FUNC_974_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.TimeUp = __FUNC_974_
	local function __FUNC_9D6_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.Combined = __FUNC_9D6_
	...
	registerVal6.DefaultClip = __FUNC_A36_
	...
	registerVal8.condition = __FUNC_C72_
