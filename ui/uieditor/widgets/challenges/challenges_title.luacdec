...
CoD.Challenges_Title = registerVal1
function CoD.Challenges_Title.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.Challenges_Title)
	registerVal2.id = "Challenges_Title"
	...
	local function __FUNC_A08_(arg0)
	...
	registerVal5:linkToElementModel(registerVal2, "name", true, __FUNC_A08_)
	local function __FUNC_AC2_(arg0, arg1)
		ScaleWidgetToLabel(registerVal2, arg0, 2.000000)
	end

	LUI.OverrideFunction_CallOriginalFirst(registerVal5, "setText", __FUNC_AC2_)
