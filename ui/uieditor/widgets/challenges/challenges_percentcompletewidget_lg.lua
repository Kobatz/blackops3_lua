...
CoD.Challenges_PercentCompleteWidget_LG = registerVal1
function CoD.Challenges_PercentCompleteWidget_LG.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.Challenges_PercentCompleteWidget_LG)
	registerVal2.id = "Challenges_PercentCompleteWidget_LG"
	...
	registerVal3:setTopBottom(true, true, -16.000000, 16.000000)
	...
	registerVal4:setTopBottom(true, true, -16.000000, 16.000000)
	...
	registerVal5:setLeftRight(false, false, -96.000000, 96.000000)
	...
	registerVal6:setLeftRight(true, true, -16.000000, 16.000000)
	registerVal6:setTopBottom(true, true, -16.000000, 16.000000)
	registerVal6:setRGB(0.950000, 0.910000, 0.110000)
	registerVal6:setImage(RegisterImage("uie_t7_menu_aar_whiteringthin"))
	...
	LUI.OverrideFunction_CallOriginalFirst(registerVal7, "setText", __FUNC_C28_)
	...
	registerVal9.DefaultClip = __FUNC_CFD_
	registerVal8.DefaultState = registerVal9
	registerVal9 = {}
	local function __FUNC_F5F_()
