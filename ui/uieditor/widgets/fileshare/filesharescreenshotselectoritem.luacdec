...
CoD.FileshareScreenshotSelectorItem = registerVal1
function CoD.FileshareScreenshotSelectorItem.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.FileshareScreenshotSelectorItem)
	registerVal2.id = "FileshareScreenshotSelectorItem"
	...
	local function __FUNC_C4B_(arg0)
		...
		if registerVal1 then
			registerVal5:setAlpha(Negate(registerVal1))
		end
	end

	registerVal5:linkToElementModel(registerVal2, "showPlusImage", true, __FUNC_C4B_)
	local function __FUNC_CF5_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal5:linkToElementModel(registerVal2, "fileId", true, __FUNC_CF5_)
	registerVal2:addElement(registerVal5)
	registerVal2.ImageViewer0 = registerVal5
	...
	local function __FUNC_DE1_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal2.PlusImage:linkToElementModel(registerVal2, "showPlusImage", true, __FUNC_DE1_)
	local function __FUNC_E75_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal2.LabelButton:linkToElementModel(registerVal2, "fileName", true, __FUNC_E75_)
	local registerVal9 = {}
	local registerVal10 = {}
	...
	registerVal10.GainFocus = __FUNC_102C_
	local function __FUNC_11E7_()
		registerVal2:setupElementClipCounter(3.000000)
		registerVal3:completeAnimation()
		registerVal2.BoxButtonLrgIdle:setAlpha(0.800000)
		registerVal2.clipFinished(registerVal3, {})
	...
	registerVal10.Focus = __FUNC_11E7_
	local function __FUNC_139F_()
		registerVal2:setupElementClipCounter(3.000000)
		registerVal3:completeAnimation()
		registerVal2.BoxButtonLrgIdle:setAlpha(0.300000)
		registerVal2.clipFinished(registerVal3, {})
	...
	registerVal10.LoseFocus = __FUNC_139F_
	registerVal9.DefaultState = registerVal10
	registerVal2.clipsPerState = registerVal9
	local function __FUNC_1557_(arg0)
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1557_)
