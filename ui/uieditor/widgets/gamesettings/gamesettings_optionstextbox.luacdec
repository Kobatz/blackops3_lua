...
CoD.GameSettings_Optionstextbox = registerVal1
function CoD.GameSettings_Optionstextbox.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.GameSettings_Optionstextbox)
	registerVal2.id = "GameSettings_Optionstextbox"
	...
	registerVal4:setLeftRight(true, false, 3.000000, 422.000000)
	...
	local function __FUNC_826_(arg0, arg1)
		ScaleWidgetToLabelWrapped(registerVal2, arg0, 0.000000, 0.000000)
	end

	LUI.OverrideFunction_CallOriginalFirst(registerVal4, "setText", __FUNC_826_)
	...
	local function __FUNC_8F2_(arg0)
		arg0.CACvarientTitlePanel0:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_8F2_)
