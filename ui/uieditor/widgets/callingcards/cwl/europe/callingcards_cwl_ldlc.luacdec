...
CoD.CallingCards_cwl_ldlc = registerVal1
function CoD.CallingCards_cwl_ldlc.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.CallingCards_cwl_ldlc)
	registerVal2.id = "CallingCards_cwl_ldlc"
	...
	registerVal11:setLeftRight(true, false, 11.710000, 480.290000)
	registerVal11:setTopBottom(true, false, 0.000000, 120.000000)
	registerVal11:setImage(RegisterImage("uie_callingcards_cwl_ldlc"))
