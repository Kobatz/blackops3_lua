...
CoD.CallingCards_cwl_splyce = registerVal1
function CoD.CallingCards_cwl_splyce.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.CallingCards_cwl_splyce)
	registerVal2.id = "CallingCards_cwl_splyce"
	...
	registerVal11:setImage(RegisterImage("uie_callingcards_cwl_splyce"))
	...
	local function __FUNC_F99_()
		...
		local function __FUNC_1358_(arg0, arg1)
			local function __FUNC_14D3_(arg0, arg1)
				local function __FUNC_1628_(arg0, arg1)
				...
				if arg1.interrupted then
					__FUNC_1628_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 319.000000, false, false, CoD.TweenType.Linear)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1628_)
			end
		...
		__FUNC_1358_(registerVal4, {})
		local function __FUNC_17DD_(arg0, arg1)
			...
			if arg1.interrupted then
				__FUNC_1934_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1934_)
		end

		registerVal5:completeAnimation()
		registerVal2.BG2:setAlpha(0.000000)
		__FUNC_17DD_(registerVal5, {})
		local function __FUNC_1C61_(arg0, arg1)
			local function __FUNC_1DB8_(arg0, arg1)
				local function __FUNC_1F10_(arg0, arg1)
					local function __FUNC_2068_(arg0, arg1)
						local function __FUNC_21E3_(arg0, arg1)
							if not arg1.interrupted then
						...
						if arg1.interrupted then
							__FUNC_21E3_(arg0, arg1)
							return 
						end
						arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
						arg0:setAlpha(1.000000)
						arg0:registerEventHandler("transition_complete_keyframe", __FUNC_21E3_)
					end
				...
				if arg1.interrupted then
					__FUNC_1F10_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 379.000000, false, false, CoD.TweenType.Linear)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1F10_)
			end

			if arg1.interrupted then
				__FUNC_1DB8_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 620.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1DB8_)
		end

		registerVal6:completeAnimation()
		registerVal2.BG5Glow:setAlpha(0.000000)
		__FUNC_1C61_(registerVal6, {})
		local function __FUNC_2395_(arg0, arg1)
			local function __FUNC_25A2_(arg0, arg1)
				local function __FUNC_27D0_(arg0, arg1)
					local function __FUNC_2A00_(arg0, arg1)
						if not arg1.interrupted then
					...
					arg0:registerEventHandler("transition_complete_keyframe", __FUNC_2A00_)
				end
			...
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_25A2_)
		end
		...
		__FUNC_2395_(registerVal12, {})
		registerVal2.nextClip = "DefaultClip"
	end

	registerVal14.DefaultClip = __FUNC_F99_
	registerVal13.DefaultState = registerVal14
	registerVal2.clipsPerState = registerVal13
	local function __FUNC_2CA4_(arg0)
		arg0.CallingCardscwlworldmapwidget0:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_2CA4_)
