...
CoD.CallingCards_cwl_supremacy = registerVal1
function CoD.CallingCards_cwl_supremacy.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.CallingCards_cwl_supremacy)
	registerVal2.id = "CallingCards_cwl_supremacy"
	...
	registerVal11:setImage(RegisterImage("uie_callingcards_cwl_supremacy"))
	...
	local registerVal13 = {}
	local registerVal14 = {}
	local function __FUNC_FA9_()
		registerVal2:setupElementClipCounter(5.000000)
		registerVal3:completeAnimation()
		registerVal2.BG5Empty:setAlpha(1.000000)
		registerVal2.clipFinished(registerVal3, {})
		local function __FUNC_1368_(arg0, arg1)
			local function __FUNC_14E3_(arg0, arg1)
				...
				if arg1.interrupted then
					__FUNC_1638_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 319.000000, false, false, CoD.TweenType.Linear)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1638_)
			end
		...
		__FUNC_1368_(registerVal4, {})
		local function __FUNC_17ED_(arg0, arg1)
			local function __FUNC_1944_(arg0, arg1)
				local function __FUNC_1ABF_(arg0, arg1)
					if not arg1.interrupted then
				...
				if arg1.interrupted then
					__FUNC_1ABF_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 319.000000, false, false, CoD.TweenType.Linear)
				arg0:setAlpha(1.000000)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1ABF_)
			end

			if arg1.interrupted then
				__FUNC_1944_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1944_)
		end

		registerVal5:completeAnimation()
		registerVal2.BG2:setAlpha(0.000000)
		__FUNC_17ED_(registerVal5, {})
		local function __FUNC_1C71_(arg0, arg1)
			local function __FUNC_1DC8_(arg0, arg1)
				...
				if arg1.interrupted then
					__FUNC_1F20_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 379.000000, false, false, CoD.TweenType.Linear)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1F20_)
			end
		...
		__FUNC_1C71_(registerVal6, {})
		local function __FUNC_23A5_(arg0, arg1)
			local function __FUNC_25B2_(arg0, arg1)
				local function __FUNC_27E0_(arg0, arg1)
				...
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_27E0_)
			end

			if arg1.interrupted then
				__FUNC_25B2_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			...
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_25B2_)
		end
		...
		__FUNC_23A5_(registerVal12, {})
		registerVal2.nextClip = "DefaultClip"
	end

	registerVal14.DefaultClip = __FUNC_FA9_
	registerVal13.DefaultState = registerVal14
	registerVal2.clipsPerState = registerVal13
	local function __FUNC_2CB4_(arg0)
		arg0.CallingCardscwlworldmapwidget0:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_2CB4_)
