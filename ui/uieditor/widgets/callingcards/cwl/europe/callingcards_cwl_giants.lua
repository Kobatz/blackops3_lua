...
CoD.CallingCards_cwl_giants = registerVal1
function CoD.CallingCards_cwl_giants.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.CallingCards_cwl_giants)
	registerVal2.id = "CallingCards_cwl_giants"
	...
	registerVal11:setLeftRight(true, false, 11.710000, 480.000000)
	registerVal11:setTopBottom(true, false, 0.000000, 119.930000)
	registerVal11:setImage(RegisterImage("uie_callingcards_cwl_giants"))
	...
	local registerVal13 = {}
	local registerVal14 = {}
	local function __FUNC_FB1_()
		registerVal2:setupElementClipCounter(5.000000)
		registerVal3:completeAnimation()
		registerVal2.BG5Empty:setAlpha(1.000000)
		registerVal2.clipFinished(registerVal3, {})
		local function __FUNC_1370_(arg0, arg1)
			local function __FUNC_14EB_(arg0, arg1)
			...
			if arg1.interrupted then
				__FUNC_14EB_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			arg0:setAlpha(1.000000)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_14EB_)
		end

		registerVal4:completeAnimation()
		registerVal2.BG1:setAlpha(0.000000)
		__FUNC_1370_(registerVal4, {})
		local function __FUNC_17F5_(arg0, arg1)
			local function __FUNC_194C_(arg0, arg1)
				local function __FUNC_1AC7_(arg0, arg1)
					if not arg1.interrupted then
				...
				if arg1.interrupted then
					__FUNC_1AC7_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 319.000000, false, false, CoD.TweenType.Linear)
				arg0:setAlpha(1.000000)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1AC7_)
			end

			if arg1.interrupted then
				__FUNC_194C_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_194C_)
		end

		registerVal5:completeAnimation()
		registerVal2.BG2:setAlpha(0.000000)
		__FUNC_17F5_(registerVal5, {})
		local function __FUNC_1C79_(arg0, arg1)
			local function __FUNC_1DD0_(arg0, arg1)
				local function __FUNC_1F28_(arg0, arg1)
				...
				if arg1.interrupted then
					__FUNC_1F28_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 379.000000, false, false, CoD.TweenType.Linear)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1F28_)
			end

			if arg1.interrupted then
				__FUNC_1DD0_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 620.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1DD0_)
		end

		registerVal6:completeAnimation()
		registerVal2.BG5Glow:setAlpha(0.000000)
		__FUNC_1C79_(registerVal6, {})
		local function __FUNC_23AD_(arg0, arg1)
			local function __FUNC_25BA_(arg0, arg1)
				local function __FUNC_27E8_(arg0, arg1)
					local function __FUNC_2A18_(arg0, arg1)
						if not arg1.interrupted then
					...
					arg0:registerEventHandler("transition_complete_keyframe", __FUNC_2A18_)
				end
			...
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_25BA_)
		end
		...
		__FUNC_23AD_(registerVal12, {})
		registerVal2.nextClip = "DefaultClip"
	end

	registerVal14.DefaultClip = __FUNC_FB1_
