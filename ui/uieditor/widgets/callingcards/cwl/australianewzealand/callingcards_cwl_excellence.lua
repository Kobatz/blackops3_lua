...
CoD.CallingCards_cwl_excellence = registerVal1
function CoD.CallingCards_cwl_excellence.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.CallingCards_cwl_excellence)
	registerVal2.id = "CallingCards_cwl_excellence"
	...
	registerVal3:setImage(RegisterImage("uie_callingcards_cwl_gold_01"))
	...
	registerVal4:setImage(RegisterImage("uie_callingcards_cwl_gold_bg0b"))
	...
	registerVal5:setImage(RegisterImage("uie_callingcards_cwl_gold_bg0c"))
	...
	registerVal6:setImage(RegisterImage("uie_callingcards_cwl_gold_02c"))
	...
	registerVal11:setLeftRight(true, false, 9.000000, 480.000000)
	registerVal11:setTopBottom(true, false, 0.070000, 120.700000)
	registerVal11:setImage(RegisterImage("uie_callingcards_cwl_excellence"))
	...
	registerVal12:setRGB(1.000000, 0.750000, 0.000000)
	...
	local function __FUNC_FA5_()
		...
		local function __FUNC_1364_(arg0, arg1)
			local function __FUNC_14DF_(arg0, arg1)
				...
				if arg1.interrupted then
					__FUNC_1634_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 319.000000, false, false, CoD.TweenType.Linear)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1634_)
			end

			if arg1.interrupted then
				__FUNC_14DF_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			arg0:setAlpha(1.000000)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_14DF_)
		end

		registerVal4:completeAnimation()
		registerVal2.BG1:setAlpha(0.000000)
		__FUNC_1364_(registerVal4, {})
		local function __FUNC_17E9_(arg0, arg1)
			local function __FUNC_1940_(arg0, arg1)
				local function __FUNC_1ABB_(arg0, arg1)
					if not arg1.interrupted then
				...
				if arg1.interrupted then
					__FUNC_1ABB_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 319.000000, false, false, CoD.TweenType.Linear)
				arg0:setAlpha(1.000000)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1ABB_)
			end

			if arg1.interrupted then
				__FUNC_1940_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1940_)
		end

		registerVal5:completeAnimation()
		registerVal2.BG2:setAlpha(0.000000)
		__FUNC_17E9_(registerVal5, {})
		local function __FUNC_1C6D_(arg0, arg1)
			local function __FUNC_1DC4_(arg0, arg1)
				local function __FUNC_1F1C_(arg0, arg1)
				...
				if arg1.interrupted then
					__FUNC_1F1C_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 379.000000, false, false, CoD.TweenType.Linear)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1F1C_)
			end

			if arg1.interrupted then
				__FUNC_1DC4_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 620.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1DC4_)
		end

		registerVal6:completeAnimation()
		registerVal2.BG5Glow:setAlpha(0.000000)
		__FUNC_1C6D_(registerVal6, {})
		local function __FUNC_23A1_(arg0, arg1)
			local function __FUNC_25AE_(arg0, arg1)
				local function __FUNC_27DC_(arg0, arg1)
					local function __FUNC_2A0C_(arg0, arg1)
						if not arg1.interrupted then
					...
					arg0:registerEventHandler("transition_complete_keyframe", __FUNC_2A0C_)
				end

				if arg1.interrupted then
					__FUNC_27DC_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 159.000000, false, false, CoD.TweenType.Linear)
				...
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_27DC_)
			end

			if arg1.interrupted then
				__FUNC_25AE_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			...
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_25AE_)
		end
		...
		__FUNC_23A1_(registerVal12, {})
		registerVal2.nextClip = "DefaultClip"
	end

	registerVal14.DefaultClip = __FUNC_FA5_
	registerVal13.DefaultState = registerVal14
	registerVal2.clipsPerState = registerVal13
	local function __FUNC_2CB0_(arg0)
		arg0.CallingCardscwlworldmapwidget0:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_2CB0_)
