...
CoD.CallingCards_cwl_taintedminds = registerVal1
function CoD.CallingCards_cwl_taintedminds.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.CallingCards_cwl_taintedminds)
	registerVal2.id = "CallingCards_cwl_taintedminds"
	...
	registerVal4:setImage(RegisterImage("uie_callingcards_cwl_green_bg0b"))
	...
	registerVal5:setImage(RegisterImage("uie_callingcards_cwl_green_bg0c"))
	...
	registerVal11:setLeftRight(true, false, 1.000000, 481.000000)
	registerVal11:setTopBottom(true, false, -0.930000, 122.000000)
	registerVal11:setImage(RegisterImage("uie_callingcards_cwl_taintedminds"))
	...
	local function __FUNC_FAD_()
		...
		local function __FUNC_142C_(arg0, arg1)
			local function __FUNC_15A7_(arg0, arg1)
				local function __FUNC_16FC_(arg0, arg1)
					if not arg1.interrupted then
						arg0:beginAnimation("keyframe", 29.000000, false, false, CoD.TweenType.Linear)
					end
					arg0:setAlpha(0.000000)
					arg0:setImage(RegisterImage("uie_callingcards_cwl_green_02"))
				...
				if arg1.interrupted then
					__FUNC_16FC_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 319.000000, false, false, CoD.TweenType.Linear)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_16FC_)
			end
		...
		registerVal2.BG1:setImage(RegisterImage("uie_callingcards_cwl_green_02"))
		__FUNC_142C_(registerVal4, {})
		local function __FUNC_1915_(arg0, arg1)
			local function __FUNC_1A6C_(arg0, arg1)
				local function __FUNC_1BE7_(arg0, arg1)
					...
					arg0:setAlpha(0.000000)
					arg0:setImage(RegisterImage("uie_callingcards_cwl_green_02b"))
					if arg1.interrupted then
						registerVal2.clipFinished(arg0, arg1)
					else
						arg0:registerEventHandler("transition_complete_keyframe", registerVal2.clipFinished)
		...
		registerVal2.BG2:setImage(RegisterImage("uie_callingcards_cwl_green_02b"))
		__FUNC_1915_(registerVal5, {})
		...
		__FUNC_1DFE_(registerVal6, {})
		local function __FUNC_2531_(arg0, arg1)
			local function __FUNC_273E_(arg0, arg1)
				local function __FUNC_296C_(arg0, arg1)
					local function __FUNC_2B9C_(arg0, arg1)
						if not arg1.interrupted then
					...
					arg0:registerEventHandler("transition_complete_keyframe", __FUNC_2B9C_)
				end
			...
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_273E_)
		end
		...
		__FUNC_2531_(registerVal12, {})
		registerVal2.nextClip = "DefaultClip"
	end

	registerVal14.DefaultClip = __FUNC_FAD_
	registerVal13.DefaultState = registerVal14
	registerVal2.clipsPerState = registerVal13
	local function __FUNC_2E40_(arg0)
		arg0.CallingCardscwlworldmapwidget0:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_2E40_)
