...
CoD.CallingCards_cwl_orbit = registerVal1
function CoD.CallingCards_cwl_orbit.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.CallingCards_cwl_orbit)
	registerVal2.id = "CallingCards_cwl_orbit"
	...
	registerVal11:setImage(RegisterImage("uie_callingcards_cwl_orbit"))
	...
	local registerVal13 = {}
	local registerVal14 = {}
	local function __FUNC_FB7_()
		registerVal2:setupElementClipCounter(5.000000)
		registerVal3:completeAnimation()
		registerVal2.BG5Empty:setAlpha(1.000000)
		registerVal2.clipFinished(registerVal3, {})
		local function __FUNC_1374_(arg0, arg1)
		...
		__FUNC_1374_(registerVal4, {})
		local function __FUNC_17F9_(arg0, arg1)
			local function __FUNC_1950_(arg0, arg1)
			...
			if arg1.interrupted then
				__FUNC_1950_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1950_)
		end

		registerVal5:completeAnimation()
		registerVal2.BG2:setAlpha(0.000000)
		__FUNC_17F9_(registerVal5, {})
		local function __FUNC_1C7D_(arg0, arg1)
			local function __FUNC_1DD4_(arg0, arg1)
				local function __FUNC_1F2C_(arg0, arg1)
					local function __FUNC_2084_(arg0, arg1)
						local function __FUNC_21FF_(arg0, arg1)
							if not arg1.interrupted then
						...
						if arg1.interrupted then
							__FUNC_21FF_(arg0, arg1)
							return 
						end
						arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
						arg0:setAlpha(1.000000)
						arg0:registerEventHandler("transition_complete_keyframe", __FUNC_21FF_)
					end
			...
			if arg1.interrupted then
				__FUNC_1DD4_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 620.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1DD4_)
		end

		registerVal6:completeAnimation()
		registerVal2.BG5Glow:setAlpha(0.000000)
		__FUNC_1C7D_(registerVal6, {})
		local function __FUNC_23B1_(arg0, arg1)
			local function __FUNC_25BE_(arg0, arg1)
				local function __FUNC_27EC_(arg0, arg1)
					local function __FUNC_2A1C_(arg0, arg1)
						if not arg1.interrupted then
					...
					arg0:registerEventHandler("transition_complete_keyframe", __FUNC_2A1C_)
				end

				if arg1.interrupted then
					__FUNC_27EC_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 159.000000, false, false, CoD.TweenType.Linear)
				...
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_27EC_)
			end

			if arg1.interrupted then
				__FUNC_25BE_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			...
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_25BE_)
		end
		...
		__FUNC_23B1_(registerVal12, {})
		registerVal2.nextClip = "DefaultClip"
	end

	registerVal14.DefaultClip = __FUNC_FB7_
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_2CC0_)
