...
CoD.CallingCards_cwl_mindfreak = registerVal1
function CoD.CallingCards_cwl_mindfreak.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.CallingCards_cwl_mindfreak)
	registerVal2.id = "CallingCards_cwl_mindfreak"
	...
	registerVal11:setImage(RegisterImage("uie_callingcards_cwl_mindfreak"))
	...
	registerVal14.DefaultClip = __FUNC_FB2_
