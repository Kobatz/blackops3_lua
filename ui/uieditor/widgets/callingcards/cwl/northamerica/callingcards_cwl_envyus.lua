...
CoD.CallingCards_cwl_envyus = registerVal1
function CoD.CallingCards_cwl_envyus.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.CallingCards_cwl_envyus)
	registerVal2.id = "CallingCards_cwl_envyus"
	...
	registerVal3:setImage(RegisterImage("uie_callingcards_cwl_blue_01"))
	...
	registerVal4:setImage(RegisterImage("uie_callingcards_cwl_blue_bg0b"))
	...
	registerVal5:setImage(RegisterImage("uie_callingcards_cwl_blue_bg0c"))
	...
	registerVal6:setImage(RegisterImage("uie_callingcards_cwl_blue_02c"))
	...
	registerVal11:setLeftRight(true, false, 9.000000, 477.510000)
	registerVal11:setTopBottom(true, false, 1.070000, 120.070000)
	registerVal11:setImage(RegisterImage("uie_callingcards_cwl_envyus"))
	...
	registerVal12:setRGB(0.000000, 0.820000, 0.950000)
	...
	local function __FUNC_FA3_()
		...
		local function __FUNC_1360_(arg0, arg1)
			...
			if arg1.interrupted then
				__FUNC_14DB_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			arg0:setAlpha(1.000000)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_14DB_)
		end

		registerVal4:completeAnimation()
		registerVal2.BG1:setAlpha(0.000000)
		__FUNC_1360_(registerVal4, {})
		local function __FUNC_17E5_(arg0, arg1)
			local function __FUNC_193C_(arg0, arg1)
				local function __FUNC_1AB7_(arg0, arg1)
					if not arg1.interrupted then
				...
				if arg1.interrupted then
					__FUNC_1AB7_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 319.000000, false, false, CoD.TweenType.Linear)
				arg0:setAlpha(1.000000)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1AB7_)
			end

			if arg1.interrupted then
				__FUNC_193C_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_193C_)
		end

		registerVal5:completeAnimation()
		registerVal2.BG2:setAlpha(0.000000)
		__FUNC_17E5_(registerVal5, {})
		local function __FUNC_1C69_(arg0, arg1)
			local function __FUNC_1DC0_(arg0, arg1)
				local function __FUNC_1F18_(arg0, arg1)
					local function __FUNC_2070_(arg0, arg1)
						local function __FUNC_21EB_(arg0, arg1)
							if not arg1.interrupted then
						...
						if arg1.interrupted then
							__FUNC_21EB_(arg0, arg1)
							return 
						end
						arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
						arg0:setAlpha(1.000000)
						arg0:registerEventHandler("transition_complete_keyframe", __FUNC_21EB_)
					end
				...
				if arg1.interrupted then
					__FUNC_1F18_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 379.000000, false, false, CoD.TweenType.Linear)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1F18_)
			end

			if arg1.interrupted then
				__FUNC_1DC0_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 620.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1DC0_)
		end

		registerVal6:completeAnimation()
		registerVal2.BG5Glow:setAlpha(0.000000)
		__FUNC_1C69_(registerVal6, {})
		local function __FUNC_239D_(arg0, arg1)
			local function __FUNC_25AA_(arg0, arg1)
				local function __FUNC_27D8_(arg0, arg1)
					local function __FUNC_2A08_(arg0, arg1)
						if not arg1.interrupted then
					...
					arg0:registerEventHandler("transition_complete_keyframe", __FUNC_2A08_)
				end

				if arg1.interrupted then
					__FUNC_27D8_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 159.000000, false, false, CoD.TweenType.Linear)
				...
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_27D8_)
			end

			if arg1.interrupted then
				__FUNC_25AA_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			...
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_25AA_)
		end
		...
		__FUNC_239D_(registerVal12, {})
		registerVal2.nextClip = "DefaultClip"
	end

	registerVal14.DefaultClip = __FUNC_FA3_
	registerVal13.DefaultState = registerVal14
	registerVal2.clipsPerState = registerVal13
	local function __FUNC_2CAC_(arg0)
		arg0.CallingCardscwlworldmapwidget0:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_2CAC_)
