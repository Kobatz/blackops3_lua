...
CoD.CallingCards_cwl_cloud9 = registerVal1
function CoD.CallingCards_cwl_cloud9.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.CallingCards_cwl_cloud9)
	registerVal2.id = "CallingCards_cwl_cloud9"
	...
	registerVal3:setImage(RegisterImage("uie_callingcards_cwl_bluedrk_01"))
	...
	registerVal4:setImage(RegisterImage("uie_callingcards_cwl_bluedrk_bg0b"))
	...
	registerVal5:setImage(RegisterImage("uie_callingcards_cwl_bluedrk_bg0c"))
	...
	registerVal6:setImage(RegisterImage("uie_callingcards_cwl_bluedrk_02c"))
	...
	registerVal11:setImage(RegisterImage("uie_callingcards_cwl_cloud9"))
	...
	local registerVal13 = {}
	local registerVal14 = {}
	local function __FUNC_FBD_()
		registerVal2:setupElementClipCounter(5.000000)
		registerVal3:completeAnimation()
		registerVal2.BG5Empty:setAlpha(1.000000)
		registerVal2.clipFinished(registerVal3, {})
		local function __FUNC_137C_(arg0, arg1)
		...
		__FUNC_137C_(registerVal4, {})
		local function __FUNC_1801_(arg0, arg1)
			local function __FUNC_1958_(arg0, arg1)
				local function __FUNC_1AD3_(arg0, arg1)
					if not arg1.interrupted then
				...
				if arg1.interrupted then
					__FUNC_1AD3_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 319.000000, false, false, CoD.TweenType.Linear)
				arg0:setAlpha(1.000000)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1AD3_)
			end

			if arg1.interrupted then
				__FUNC_1958_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1958_)
		end

		registerVal5:completeAnimation()
		registerVal2.BG2:setAlpha(0.000000)
		__FUNC_1801_(registerVal5, {})
		local function __FUNC_1C85_(arg0, arg1)
			local function __FUNC_1DDC_(arg0, arg1)
				local function __FUNC_1F34_(arg0, arg1)
					local function __FUNC_208C_(arg0, arg1)
					...
					if arg1.interrupted then
						__FUNC_208C_(arg0, arg1)
						return 
					end
					arg0:beginAnimation("keyframe", 399.000000, false, false, CoD.TweenType.Linear)
					arg0:registerEventHandler("transition_complete_keyframe", __FUNC_208C_)
				end

				if arg1.interrupted then
					__FUNC_1F34_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 379.000000, false, false, CoD.TweenType.Linear)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1F34_)
			end

			if arg1.interrupted then
				__FUNC_1DDC_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 620.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1DDC_)
		end

		registerVal6:completeAnimation()
		registerVal2.BG5Glow:setAlpha(0.000000)
		__FUNC_1C85_(registerVal6, {})
		local function __FUNC_23B9_(arg0, arg1)
			local function __FUNC_25C6_(arg0, arg1)
			...
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_25C6_)
		end
		...
		__FUNC_23B9_(registerVal12, {})
		registerVal2.nextClip = "DefaultClip"
	end

	registerVal14.DefaultClip = __FUNC_FBD_
	registerVal13.DefaultState = registerVal14
	registerVal2.clipsPerState = registerVal13
	local function __FUNC_2CC8_(arg0)
		arg0.CallingCardscwlworldmapwidget0:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_2CC8_)
