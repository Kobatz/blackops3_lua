...
CoD.CallingCards_cwl_opticgaming = registerVal1
function CoD.CallingCards_cwl_opticgaming.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.CallingCards_cwl_opticgaming)
	registerVal2.id = "CallingCards_cwl_opticgaming"
	...
	registerVal3:setImage(RegisterImage("uie_callingcards_cwl_green_01"))
	...
	registerVal4:setImage(RegisterImage("uie_callingcards_cwl_green_02"))
	...
	registerVal5:setImage(RegisterImage("uie_callingcards_cwl_green_02b"))
	...
	registerVal6:setImage(RegisterImage("uie_callingcards_cwl_green_02c"))
	...
	registerVal11:setTopBottom(true, false, -1.930000, 121.000000)
	registerVal11:setImage(RegisterImage("uie_callingcards_cwl_opticgaming"))
	...
	registerVal12:setRGB(0.190000, 1.000000, 0.000000)
	...
	local function __FUNC_F9E_()
		...
		local function __FUNC_135C_(arg0, arg1)
			local function __FUNC_14D7_(arg0, arg1)
				local function __FUNC_162C_(arg0, arg1)
				...
				if arg1.interrupted then
					__FUNC_162C_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 319.000000, false, false, CoD.TweenType.Linear)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_162C_)
			end
		...
		__FUNC_135C_(registerVal4, {})
		local function __FUNC_17E1_(arg0, arg1)
			local function __FUNC_1938_(arg0, arg1)
				local function __FUNC_1AB3_(arg0, arg1)
					if not arg1.interrupted then
				...
				if arg1.interrupted then
					__FUNC_1AB3_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 319.000000, false, false, CoD.TweenType.Linear)
				arg0:setAlpha(1.000000)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1AB3_)
			end

			if arg1.interrupted then
				__FUNC_1938_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1938_)
		end

		registerVal5:completeAnimation()
		registerVal2.BG2:setAlpha(0.000000)
		__FUNC_17E1_(registerVal5, {})
		local function __FUNC_1C65_(arg0, arg1)
			local function __FUNC_1DBC_(arg0, arg1)
				local function __FUNC_1F14_(arg0, arg1)
					local function __FUNC_206C_(arg0, arg1)
						local function __FUNC_21E7_(arg0, arg1)
							if not arg1.interrupted then
						...
						if arg1.interrupted then
							__FUNC_21E7_(arg0, arg1)
							return 
						end
						arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
						arg0:setAlpha(1.000000)
						arg0:registerEventHandler("transition_complete_keyframe", __FUNC_21E7_)
					end

					if arg1.interrupted then
						__FUNC_206C_(arg0, arg1)
						return 
					end
					arg0:beginAnimation("keyframe", 399.000000, false, false, CoD.TweenType.Linear)
					arg0:registerEventHandler("transition_complete_keyframe", __FUNC_206C_)
				end
		...
		local function __FUNC_2399_(arg0, arg1)
			local function __FUNC_25A6_(arg0, arg1)
				local function __FUNC_27D4_(arg0, arg1)
					...
					arg0:registerEventHandler("transition_complete_keyframe", __FUNC_2A04_)
				end
			...
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_25A6_)
		end
		...
		__FUNC_2399_(registerVal12, {})
		registerVal2.nextClip = "DefaultClip"
	end

	registerVal14.DefaultClip = __FUNC_F9E_
	registerVal13.DefaultState = registerVal14
	registerVal2.clipsPerState = registerVal13
	local function __FUNC_2CA8_(arg0)
		arg0.CallingCardscwlworldmapwidget0:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_2CA8_)
