...
CoD.CallingCard_FlyingBee_Wing_Back_Anim = registerVal1
function CoD.CallingCard_FlyingBee_Wing_Back_Anim.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.CallingCard_FlyingBee_Wing_Back_Anim)
	registerVal2.id = "CallingCard_FlyingBee_Wing_Back_Anim"
	registerVal2.soundSet = "default"
	registerVal2:setLeftRight(true, false, 0.000000, 32.000000)
	registerVal2:setTopBottom(true, false, 0.000000, 32.000000)
	registerVal2.anyChildUsesUpdateState = true
	local registerVal3 = CoD.CallingCard_FlyingBee_Wing_Back.new(arg0, arg1)
	...
	local function __FUNC_5FF_()
		...
		local function __FUNC_70C_(arg0, arg1)
			local function __FUNC_886_(arg0, arg1)
			...
			if arg1.interrupted then
				__FUNC_886_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 70.000000, true, true, CoD.TweenType.Linear)
			arg0:setZRot(-23.000000)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_886_)
		end

		registerVal3:completeAnimation()
		registerVal2.Wing:setZRot(3.000000)
		__FUNC_70C_(registerVal3, {})
