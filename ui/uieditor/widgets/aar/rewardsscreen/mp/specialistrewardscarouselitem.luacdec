...
CoD.SpecialistRewardsCarouselItem = registerVal1
function CoD.SpecialistRewardsCarouselItem.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.SpecialistRewardsCarouselItem)
	registerVal2.id = "SpecialistRewardsCarouselItem"
	...
	local registerVal3 = CoD.SpecialistRewardsCarouselItemInternal.new(arg0, arg1)
	registerVal3:setLeftRight(true, true, 0.000000, 0.000000)
	registerVal3:setTopBottom(true, true, 0.000000, 0.000000)
	registerVal3:setScale(1.100000)
	local function __FUNC_B40_(arg0)
		registerVal3:setModel(arg0, arg1)
	end

	registerVal3:linkToElementModel(registerVal2, nil, false, __FUNC_B40_)
	registerVal2:addElement(registerVal3)
	registerVal2.SpecialistRewardsCarouselItemInternal = registerVal3
	...
	local function __FUNC_B92_()
		...
		registerVal2.SpecialistRewardsCarouselItemInternal:setScale(1.000000)
		registerVal2.SpecialistRewardsCarouselItemInternal.FEButtonPanel0:setAlpha(0.500000)
		registerVal2.SpecialistRewardsCarouselItemInternal.IndividualRewardItem1.Border:setRGB(0.370000, 0.370000, 0.370000)
		registerVal2.SpecialistRewardsCarouselItemInternal.IndividualRewardItem2.Border:setRGB(0.370000, 0.370000, 0.370000)
		registerVal2.SpecialistRewardsCarouselItemInternal.IndividualRewardItem3.Border:setRGB(0.370000, 0.370000, 0.370000)
		registerVal2.SpecialistRewardsCarouselItemInternal.IndividualRewardItem4.Border:setRGB(0.370000, 0.370000, 0.370000)
	...
	registerVal10.DefaultClip = __FUNC_B92_
	local function __FUNC_10FE_()
		registerVal2:setupElementClipCounter(6.000000)
		local function __FUNC_1666_(arg0, arg1)
			local function __FUNC_1AFC_(arg0, arg1)
			...
			if arg1.interrupted then
				__FUNC_1AFC_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 90.000000, false, false, CoD.TweenType.Linear)
			arg0.FEButtonPanel0:beginAnimation("subkeyframe", 90.000000, false, false, CoD.TweenType.Linear)
			arg0.IndividualRewardItem1.Border:beginAnimation("subkeyframe", 90.000000, false, false, CoD.TweenType.Linear)
			arg0.IndividualRewardItem2.Border:beginAnimation("subkeyframe", 90.000000, false, false, CoD.TweenType.Linear)
			arg0.IndividualRewardItem3.Border:beginAnimation("subkeyframe", 90.000000, false, false, CoD.TweenType.Linear)
			arg0.IndividualRewardItem4.Border:beginAnimation("subkeyframe", 90.000000, false, false, CoD.TweenType.Linear)
			...
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1AFC_)
		end
	...
	registerVal10.GainFocus = __FUNC_10FE_
	local function __FUNC_1FCE_()
	...
	registerVal10.Over = __FUNC_1FCE_
	local function __FUNC_2385_()
		registerVal2:setupElementClipCounter(5.000000)
		registerVal3:completeAnimation()
		registerVal2.SpecialistRewardsCarouselItemInternal:setScale(1.100000)
		registerVal2.clipFinished(registerVal3, {})
		registerVal4:completeAnimation()
	...
	registerVal10.Focus = __FUNC_2385_
	registerVal9.DefaultState = registerVal10
	registerVal2.clipsPerState = registerVal9
	local function __FUNC_2706_(arg0)
		arg0.SpecialistRewardsCarouselItemInternal:close()
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_2706_)
