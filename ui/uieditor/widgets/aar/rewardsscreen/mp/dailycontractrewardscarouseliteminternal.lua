...
CoD.DailyContractRewardsCarouselItemInternal = registerVal1
function CoD.DailyContractRewardsCarouselItemInternal.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.DailyContractRewardsCarouselItemInternal)
	registerVal2.id = "DailyContractRewardsCarouselItemInternal"
	...
	registerVal10:linkToElementModel(registerVal2, "rewardCarouselItemImage", true, __FUNC_1C30_)
	...
	local function __FUNC_1CE4_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal11:linkToElementModel(registerVal2, "reward1InfoVisible", true, __FUNC_1CE4_)
	local function __FUNC_1D79_(arg0)
		registerVal11:setModel(arg0, arg1)
	end

	registerVal11:linkToElementModel(registerVal2, "reward1Info", false, __FUNC_1D79_)
	local registerVal14 = {}
	local registerVal15 = {}
	registerVal15.stateName = "Incentive"
	local function __FUNC_1DCA_(arg0, arg1, arg2)
		return AlwaysTrue()
	end

	registerVal15.condition = __FUNC_1DCA_
	registerVal14 = {registerVal15}
	registerVal11:mergeStateConditions(registerVal14)
	local function __FUNC_1E14_(arg1)
		local registerVal4 = {}
	...
	registerVal11:linkToElementModel(registerVal11, "rewardDesc", true, __FUNC_1E14_)
	...
	registerVal12:linkToElementModel(registerVal2, "reward2InfoVisible", true, __FUNC_1F34_)
	local function __FUNC_1FC9_(arg0)
		registerVal12:setModel(arg0, arg1)
	end

	registerVal12:linkToElementModel(registerVal2, "reward2Info", false, __FUNC_1FC9_)
	registerVal15 = {}
	local registerVal16 = {}
	...
	registerVal12:linkToElementModel(registerVal12, "rewardDesc", true, __FUNC_2064_)
	...
	registerVal13:linkToElementModel(registerVal2, "reward3InfoVisible", true, __FUNC_2184_)
	local function __FUNC_2219_(arg0)
		registerVal13:setModel(arg0, arg1)
	end

	registerVal13:linkToElementModel(registerVal2, "reward3Info", false, __FUNC_2219_)
	registerVal16 = {}
	local registerVal17 = {}
	...
	registerVal13:linkToElementModel(registerVal13, "rewardDesc", true, __FUNC_22B4_)
	...
	local function __FUNC_23D4_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal14:linkToElementModel(registerVal2, "reward4InfoVisible", true, __FUNC_23D4_)
	local function __FUNC_2469_(arg0)
		registerVal14:setModel(arg0, arg1)
	end

	registerVal14:linkToElementModel(registerVal2, "reward4Info", false, __FUNC_2469_)
	registerVal17 = {}
	local registerVal18 = {}
	registerVal18.stateName = "Incentive"
	local function __FUNC_24BA_(arg0, arg1, arg2)
		return AlwaysTrue()
	end

	registerVal18.condition = __FUNC_24BA_
	registerVal17 = {registerVal18}
	registerVal14:mergeStateConditions(registerVal17)
	local function __FUNC_2504_(arg1)
		local registerVal4 = {}
		registerVal4.name = "model_validation"
		registerVal4.menu = arg0
		local registerVal5 = Engine.GetModelValue(arg1)
	...
	registerVal14:linkToElementModel(registerVal14, "rewardDesc", true, __FUNC_2504_)
	...
	local function __FUNC_2624_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal17:linkToElementModel(registerVal2, "rewardCarouselItemSubtitle", true, __FUNC_2624_)
	...
	local function __FUNC_26FB_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal18:linkToElementModel(registerVal2, "rewardCarouselItemTitle", true, __FUNC_26FB_)
	...
	registerVal19.text:setText(Engine.Localize("MPUI_BM_CONTRACT_DAILY_CONTRACTS"))
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_27B2_)
