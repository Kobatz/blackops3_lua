...
CoD.BlackmarketRewardsCarouselItem = registerVal1
function CoD.BlackmarketRewardsCarouselItem.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.BlackmarketRewardsCarouselItem)
	registerVal2.id = "BlackmarketRewardsCarouselItem"
	...
	local registerVal3 = CoD.BlackmarketRewardsCarouselItemInternal.new(arg0, arg1)
	registerVal3:setLeftRight(true, true, 0.000000, 0.000000)
	registerVal3:setTopBottom(true, true, 0.000000, 0.000000)
	registerVal3.CardTitleBacking:setRGB(ColorSet.BlackMarketCommon.r, ColorSet.BlackMarketCommon.g, ColorSet.BlackMarketCommon.b)
	local function __FUNC_BFB_(arg0)
		registerVal3:setModel(arg0, arg1)
	end

	registerVal3:linkToElementModel(registerVal2, nil, false, __FUNC_BFB_)
	registerVal2:addElement(registerVal3)
	registerVal2.BlackmarketRewardsCarouselItemInternal = registerVal3
	...
	local function __FUNC_C4A_()
		...
		registerVal2.BlackmarketRewardsCarouselItemInternal:setScale(1.000000)
		registerVal2.BlackmarketRewardsCarouselItemInternal.FEButtonPanel0:setAlpha(0.500000)
	...
	local function __FUNC_F96_()
		...
		registerVal3:completeAnimation()
		registerVal3.FEButtonPanel0:completeAnimation()
		registerVal2.BlackmarketRewardsCarouselItemInternal:setScale(1.100000)
		registerVal2.BlackmarketRewardsCarouselItemInternal.FEButtonPanel0:setAlpha(0.750000)
		registerVal2.clipFinished(registerVal3, {})
		registerVal4:completeAnimation()
	...
	registerVal10.Focus = __FUNC_F96_
	local function __FUNC_13D1_()
		registerVal2:setupElementClipCounter(4.000000)
		local function __FUNC_166C_(arg0, arg1)
			local function __FUNC_1883_(arg0, arg1)
			...
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1883_)
		end
	...
	registerVal10.GainFocus = __FUNC_13D1_
	local function __FUNC_1AD1_()
	...
	registerVal10.Over = __FUNC_1AD1_
	registerVal9.DefaultState = registerVal10
	registerVal2.clipsPerState = registerVal9
	local function __FUNC_1E89_(arg0)
		arg0.BlackmarketRewardsCarouselItemInternal:close()
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1E89_)
