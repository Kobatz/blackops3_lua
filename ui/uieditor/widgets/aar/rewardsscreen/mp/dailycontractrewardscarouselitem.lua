...
CoD.DailyContractRewardsCarouselItem = registerVal1
function CoD.DailyContractRewardsCarouselItem.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.DailyContractRewardsCarouselItem)
	registerVal2.id = "DailyContractRewardsCarouselItem"
	...
	local registerVal3 = CoD.DailyContractRewardsCarouselItemInternal.new(arg0, arg1)
	...
	registerVal3:linkToElementModel(registerVal2, nil, false, __FUNC_B23_)
	registerVal2:addElement(registerVal3)
	registerVal2.DailyContractRewardsCarouselItemInternal = registerVal3
	...
	local function __FUNC_B72_()
		...
		registerVal2.DailyContractRewardsCarouselItemInternal:setAlpha(1.000000)
		registerVal2.DailyContractRewardsCarouselItemInternal:setScale(1.000000)
	...
	registerVal10.DefaultClip = __FUNC_B72_
	local function __FUNC_E7F_()
		registerVal2:setupElementClipCounter(6.000000)
		registerVal3:completeAnimation()
		registerVal2.DailyContractRewardsCarouselItemInternal:setScale(1.100000)
		registerVal2.clipFinished(registerVal3, {})
		registerVal4:completeAnimation()
	...
	registerVal10.Focus = __FUNC_E7F_
	local function __FUNC_125E_()
		registerVal2:setupElementClipCounter(4.000000)
		local function __FUNC_1519_(arg0, arg1)
			local function __FUNC_1693_(arg0, arg1)
			...
			if arg1.interrupted then
				__FUNC_1693_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 90.000000, false, false, CoD.TweenType.Linear)
			arg0:setScale(1.150000)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_1693_)
		end

		registerVal3:completeAnimation()
		registerVal2.DailyContractRewardsCarouselItemInternal:setLeftRight(true, true, 0.000000, 0.000000)
		registerVal2.DailyContractRewardsCarouselItemInternal:setTopBottom(true, true, 0.000000, 0.000000)
		registerVal2.DailyContractRewardsCarouselItemInternal:setScale(1.000000)
		__FUNC_1519_(registerVal3, {})
		registerVal6:completeAnimation()
		registerVal2.FETitleNumBrdr0:setAlpha(0.000000)
		registerVal2.clipFinished(registerVal6, {})
		registerVal7:completeAnimation()
	...
	registerVal10.GainFocus = __FUNC_125E_
	...
	registerVal10.Over = __FUNC_18A6_
	registerVal9.DefaultState = registerVal10
	registerVal2.clipsPerState = registerVal9
	local function __FUNC_1C5D_(arg0)
		arg0.DailyContractRewardsCarouselItemInternal:close()
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1C5D_)
