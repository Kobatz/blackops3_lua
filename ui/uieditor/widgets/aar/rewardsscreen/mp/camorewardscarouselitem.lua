...
CoD.CamoRewardsCarouselItem = registerVal1
function CoD.CamoRewardsCarouselItem.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.CamoRewardsCarouselItem)
	registerVal2.id = "CamoRewardsCarouselItem"
	...
	local function __FUNC_C52_(arg0)
		registerVal3:setModel(arg0, arg1)
	end

	registerVal3:linkToElementModel(registerVal2, nil, false, __FUNC_C52_)
	...
	registerVal10.DefaultClip = __FUNC_CA2_
	local function __FUNC_1208_()
		registerVal2:setupElementClipCounter(6.000000)
		registerVal3:completeAnimation()
		registerVal3.FEButtonPanel0:completeAnimation()
		registerVal3.IndividualRewardItem1.Border:completeAnimation()
	...
	registerVal10.Focus = __FUNC_1208_
	local function __FUNC_185F_()
		registerVal2:setupElementClipCounter(4.000000)
		local function __FUNC_1D12_(arg0, arg1)
	...
	registerVal10.GainFocus = __FUNC_185F_
	local function __FUNC_267A_()
	...
	registerVal10.Over = __FUNC_267A_
	registerVal9.DefaultState = registerVal10
	registerVal2.clipsPerState = registerVal9
	local function __FUNC_2A31_(arg0)
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_2A31_)
