...
CoD.CamoDiamondRewardsCarouselItemInternal = registerVal1
function CoD.CamoDiamondRewardsCarouselItemInternal.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.CamoDiamondRewardsCarouselItemInternal)
	registerVal2.id = "CamoDiamondRewardsCarouselItemInternal"
	...
	registerVal9:setLeftRight(true, false, 32.230000, 243.000000)
	registerVal9:setTopBottom(true, false, -54.670000, 154.330000)
	registerVal9:setRGB(ColorSet.RewardCamo.r, ColorSet.RewardCamo.g, ColorSet.RewardCamo.b)
	...
	registerVal10:setLeftRight(true, false, 29.210000, 247.790000)
	registerVal10:setTopBottom(true, false, -44.670000, 166.010000)
	...
	registerVal10:linkToElementModel(registerVal2, "rewardCarouselItemImage", true, __FUNC_1A24_)
	...
	registerVal11.NotificationRewardBorder:setRGB(ColorSet.RewardCamo.r, ColorSet.RewardCamo.g, ColorSet.RewardCamo.b)
	local function __FUNC_1AD8_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal11:linkToElementModel(registerVal2, "reward1InfoVisible", true, __FUNC_1AD8_)
	local function __FUNC_1B6D_(arg0)
		registerVal11:setModel(arg0, arg1)
	end

	registerVal11:linkToElementModel(registerVal2, "reward1Info", false, __FUNC_1B6D_)
	...
	registerVal12.NotificationRewardBorder:setRGB(ColorSet.RewardCamo.r, ColorSet.RewardCamo.g, ColorSet.RewardCamo.b)
	...
	registerVal12:linkToElementModel(registerVal2, "reward2InfoVisible", true, __FUNC_1BBE_)
	local function __FUNC_1C51_(arg0)
		registerVal12:setModel(arg0, arg1)
	end

	registerVal12:linkToElementModel(registerVal2, "reward2Info", false, __FUNC_1C51_)
	...
	registerVal13.NotificationRewardBorder:setRGB(ColorSet.RewardCamo.r, ColorSet.RewardCamo.g, ColorSet.RewardCamo.b)
	local function __FUNC_1CA2_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal13:linkToElementModel(registerVal2, "reward3InfoVisible", true, __FUNC_1CA2_)
	local function __FUNC_1D35_(arg0)
		registerVal13:setModel(arg0, arg1)
	end

	registerVal13:linkToElementModel(registerVal2, "reward3Info", false, __FUNC_1D35_)
	...
	registerVal14.NotificationRewardBorder:setRGB(ColorSet.RewardCamo.r, ColorSet.RewardCamo.g, ColorSet.RewardCamo.b)
	local function __FUNC_1D86_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal14:linkToElementModel(registerVal2, "reward4InfoVisible", true, __FUNC_1D86_)
	local function __FUNC_1E19_(arg0)
		registerVal14:setModel(arg0, arg1)
	end

	registerVal14:linkToElementModel(registerVal2, "reward4Info", false, __FUNC_1E19_)
	...
	registerVal16:setRGB(ColorSet.RewardCamo.r, ColorSet.RewardCamo.g, ColorSet.RewardCamo.b)
	...
	registerVal17:setLeftRight(false, false, -130.000000, 130.000000)
	registerVal17:setTopBottom(true, false, 107.000000, 129.000000)
	...
	local function __FUNC_1E6A_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal17:linkToElementModel(registerVal2, "rewardCarouselItemTitle", true, __FUNC_1E6A_)
	registerVal2:addElement(registerVal17)
	registerVal2.CardTitle = registerVal17
	local registerVal18 = CoD.verticalScrollingTextBox18.new(arg0, arg1)
	registerVal18:setLeftRight(false, false, -119.000000, 119.000000)
	registerVal18:setTopBottom(true, false, 131.000000, 167.250000)
	registerVal18.textBox:setTTF("fonts/default.ttf")
	registerVal18.textBox:setAlignment(Enum.LUIAlignment.LUI_ALIGNMENT_CENTER)
	local function __FUNC_1F22_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
			registerVal18.textBox:setText(Engine.Localize(registerVal1))
		end
	end

	registerVal18:linkToElementModel(registerVal2, "rewardCarouselItemSubtitle", true, __FUNC_1F22_)
	registerVal2:addElement(registerVal18)
	registerVal2.verticalScrollingTextBox18 = registerVal18
	local function __FUNC_1FF7_(arg0)
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1FF7_)
