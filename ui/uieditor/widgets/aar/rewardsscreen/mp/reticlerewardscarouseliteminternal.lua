...
CoD.ReticleRewardsCarouselItemInternal = registerVal1
function CoD.ReticleRewardsCarouselItemInternal.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.ReticleRewardsCarouselItemInternal)
	registerVal2.id = "ReticleRewardsCarouselItemInternal"
	...
	registerVal9:setLeftRight(false, false, -105.770000, 105.000000)
	registerVal9:setTopBottom(true, false, -54.670000, 154.330000)
	registerVal9:setRGB(ColorSet.ReticleReward.r, ColorSet.ReticleReward.g, ColorSet.ReticleReward.b)
	...
	registerVal10:setLeftRight(true, false, 84.610000, 190.610000)
	registerVal10:setTopBottom(true, false, 11.480000, 116.480000)
	local function __FUNC_19F7_(arg0)
	...
	registerVal10:linkToElementModel(registerVal2, "rewardCarouselItemImage", true, __FUNC_19F7_)
	...
	registerVal11.NotificationRewardBorder:setRGB(ColorSet.ReticleReward.r, ColorSet.ReticleReward.g, ColorSet.ReticleReward.b)
	local function __FUNC_1AA8_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal11:linkToElementModel(registerVal2, "reward1InfoVisible", true, __FUNC_1AA8_)
	local function __FUNC_1B3D_(arg0)
		registerVal11:setModel(arg0, arg1)
	end

	registerVal11:linkToElementModel(registerVal2, "reward1Info", false, __FUNC_1B3D_)
	...
	registerVal12.NotificationRewardBorder:setRGB(ColorSet.ReticleReward.r, ColorSet.ReticleReward.g, ColorSet.ReticleReward.b)
	local function __FUNC_1B8E_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal12:linkToElementModel(registerVal2, "reward2InfoVisible", true, __FUNC_1B8E_)
	local function __FUNC_1C21_(arg0)
		registerVal12:setModel(arg0, arg1)
	end

	registerVal12:linkToElementModel(registerVal2, "reward2Info", false, __FUNC_1C21_)
	...
	registerVal13.NotificationRewardBorder:setRGB(ColorSet.ReticleReward.r, ColorSet.ReticleReward.g, ColorSet.ReticleReward.b)
	local function __FUNC_1C72_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal13:linkToElementModel(registerVal2, "reward3InfoVisible", true, __FUNC_1C72_)
	local function __FUNC_1D05_(arg0)
		registerVal13:setModel(arg0, arg1)
	end

	registerVal13:linkToElementModel(registerVal2, "reward3Info", false, __FUNC_1D05_)
	...
	registerVal14:setTopBottom(true, false, 364.000000, 425.000000)
	registerVal14.NotificationRewardBorder:setRGB(ColorSet.ReticleReward.r, ColorSet.ReticleReward.g, ColorSet.ReticleReward.b)
	local function __FUNC_1D56_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal14:linkToElementModel(registerVal2, "reward4InfoVisible", true, __FUNC_1D56_)
	local function __FUNC_1DE9_(arg0)
		registerVal14:setModel(arg0, arg1)
	end

	registerVal14:linkToElementModel(registerVal2, "reward4Info", false, __FUNC_1DE9_)
	...
	registerVal16:setRGB(ColorSet.ReticleReward.r, ColorSet.ReticleReward.g, ColorSet.ReticleReward.b)
	...
	registerVal17:setLeftRight(false, false, -119.000000, 119.000000)
	...
	registerVal17:linkToElementModel(registerVal2, "rewardCarouselItemSubtitle", true, __FUNC_1E3A_)
	...
	registerVal18:linkToElementModel(registerVal2, "rewardCarouselItemTitle", true, __FUNC_1F0F_)
	registerVal2:addElement(registerVal18)
	registerVal2.CardTitle = registerVal18
	local function __FUNC_1FC6_(arg0)
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1FC6_)
