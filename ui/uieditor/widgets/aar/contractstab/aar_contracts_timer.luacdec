...
CoD.AAR_Contracts_timer = registerVal1
function CoD.AAR_Contracts_timer.new(arg0, arg1)
	local registerVal3 = {}
	...
	registerVal2:setClass(CoD.AAR_Contracts_timer)
	registerVal2.id = "AAR_Contracts_timer"
	...
	registerVal3:setLeftRight(true, false, 0.000000, 53.000000)
	...
	registerVal4:setLeftRight(true, false, 62.000000, 151.000000)
	...
	registerVal6.DefaultClip = __FUNC_97F_
	...
	local function __FUNC_B71_(arg0, arg1, arg2)
		return AlwaysFalse()
	end

	registerVal8.condition = __FUNC_B71_
