...
CoD.PrestigeButton_label = registerVal1
function CoD.PrestigeButton_label.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.PrestigeButton_label)
	registerVal2.id = "PrestigeButton_label"
	...
	registerVal4:linkToElementModel(registerVal2, "itemIndex", true, __FUNC_7B2_)
	...
	registerVal4:registerEventHandler("menu_loaded", __FUNC_890_)
	local function __FUNC_935_(arg0, arg1)
		ScaleWidgetToLabel(registerVal2, arg0, 3.000000)
	end

	LUI.OverrideFunction_CallOriginalFirst(registerVal4, "setText", __FUNC_935_)
