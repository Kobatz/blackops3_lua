...
CoD.CombatRecordSummaryStat = registerVal1
function CoD.CombatRecordSummaryStat.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.CombatRecordSummaryStat)
	registerVal2.id = "CombatRecordSummaryStat"
	...
	registerVal4:setTopBottom(true, false, 20.000000, 46.000000)
