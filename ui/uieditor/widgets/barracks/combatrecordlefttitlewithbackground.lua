...
CoD.CombatRecordLeftTitleWithBackground = registerVal1
function CoD.CombatRecordLeftTitleWithBackground.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.CombatRecordLeftTitleWithBackground)
	registerVal2.id = "CombatRecordLeftTitleWithBackground"
	...
	registerVal4:setLeftRight(true, false, 4.000000, 253.000000)
	...
	LUI.OverrideFunction_CallOriginalFirst(registerVal4, "setText", __FUNC_961_)
	...
	registerVal6.DefaultClip = __FUNC_9C1_
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_A22_)
