...
CoD.AdminTabGroupDescFrame = registerVal1
function CoD.AdminTabGroupDescFrame.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.AdminTabGroupDescFrame)
	registerVal2.id = "AdminTabGroupDescFrame"
	...
	local function __FUNC_8D4_(arg0)
	...
	registerVal3:subscribeToGlobalModel(arg1, "SelectedGroup", "description", __FUNC_8D4_)
