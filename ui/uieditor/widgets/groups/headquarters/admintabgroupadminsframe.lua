...
local function __FUNC_2AB_(arg0, arg1)
	local registerVal4 = Engine.GetGlobalModel()
	local registerVal3 = Engine.GetModel(registerVal4, "socialRoot.tab")
	Engine.SetModelValue(registerVal3, "groupAdmins")
end

local function __FUNC_396_(arg0, arg1)
	AdminTabMakeNotFocusableIfDisabled(arg0, arg1)
end

local registerVal3 = InheritFrom(LUI.UIElement)
CoD.AdminTabGroupAdminsFrame = registerVal3
local function __FUNC_3FC_(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if __FUNC_2AB_ then
		__FUNC_2AB_(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.AdminTabGroupAdminsFrame)
	registerVal2.id = "AdminTabGroupAdminsFrame"
	...
	local function __FUNC_D46_(arg2, arg3)
	...
	registerVal3:registerEventHandler("gain_focus", __FUNC_D46_)
	...
	registerVal3:registerEventHandler("lose_focus", __FUNC_ED7_)
	local function __FUNC_FA6_(arg0, arg1, arg2, arg3)
		local registerVal4 = ListHasElements(arg0)
		if registerVal4 then
			SetSelectedFriendXUID(registerVal2, arg0, arg2)
			OpenAdminPrivilegesPopup(registerVal2, arg0, arg2)
			return true
		end
	end

	local function __FUNC_106E_(arg0, arg1, arg2)
	...
	arg0:AddButtonCallbackFunction(registerVal3, arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, __FUNC_FA6_, __FUNC_106E_, false)
	...
	registerVal6.DefaultClip = __FUNC_119F_
	registerVal5.DefaultState = registerVal6
	registerVal6 = {}
	local function __FUNC_153E_()
		registerVal2:setupElementClipCounter(2.000000)
		registerVal3:completeAnimation()
	...
	registerVal6.DefaultClip = __FUNC_153E_
	...
	local function __FUNC_1A15_()
		...
		registerVal2.GroupsNoConentDetail.HeaderIcon:setImage(RegisterImage("uie_t7_icon_menu_simple_customgames"))
		registerVal2.GroupsNoConentDetail.Header:setText(LocalizeToUpperString("GROUPS_ADMINS"))
		registerVal2.GroupsNoConentDetail.Desc:setText(Engine.Localize("GROUPS_ADMINS_DESC"))
		registerVal2.GroupsNoConentDetail.Glow2:setRGB(0.300000, 0.670000, 0.100000)
		registerVal2.clipFinished(registerVal4, {})
	end

	registerVal6.DefaultClip = __FUNC_1A15_
	registerVal5.NoContent = registerVal6
	registerVal2.clipsPerState = registerVal5
	local registerVal7 = {}
	local registerVal8 = {}
	registerVal8.stateName = "Disabled"
	local function __FUNC_1ECB_(arg0, arg2, arg3)
		return IsDisabled(arg2, arg1)
	end

	registerVal8.condition = __FUNC_1ECB_
	local registerVal9 = {}
	registerVal9.stateName = "NoContent"
	local function __FUNC_1F1C_(arg0, arg2, arg3)
		return HasNoGroupAdmin(arg1)
	end

	registerVal9.condition = __FUNC_1F1C_
	registerVal7 = {registerVal8, registerVal9}
	registerVal2:mergeStateConditions(registerVal7)
	local function __FUNC_1F71_(arg1)
		local registerVal4 = {}
	...
	registerVal2:linkToElementModel(registerVal2, "disabled", true, __FUNC_1F71_)
	...
	registerVal2:registerEventHandler("gain_focus", __FUNC_208E_)
	local function __FUNC_2192_(arg0)
		arg0.AdminsList:close()
		arg0.GroupsNoConentDetail:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_2192_)
	if __FUNC_396_ then
...
CoD.AdminTabGroupAdminsFrame.new = __FUNC_3FC_
