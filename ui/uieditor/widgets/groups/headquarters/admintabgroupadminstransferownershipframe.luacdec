...
local function __FUNC_2BC_(arg0, arg1)
	local registerVal4 = Engine.GetGlobalModel()
	local registerVal3 = Engine.GetModel(registerVal4, "socialRoot.tab")
	Engine.SetModelValue(registerVal3, "groupAdmins")
end

local function __FUNC_3AA_(arg0, arg1)
	AdminTabMakeNotFocusableIfDisabled(arg0, arg1)
end

local registerVal3 = InheritFrom(LUI.UIElement)
CoD.AdminTabGroupAdminsTransferOwnershipFrame = registerVal3
local function __FUNC_410_(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if __FUNC_2BC_ then
		__FUNC_2BC_(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.AdminTabGroupAdminsTransferOwnershipFrame)
	registerVal2.id = "AdminTabGroupAdminsTransferOwnershipFrame"
	...
	local function __FUNC_CDB_(arg2, arg3)
	...
	registerVal3:registerEventHandler("gain_focus", __FUNC_CDB_)
	local function __FUNC_E6B_(arg0, arg1)
	...
	registerVal3:registerEventHandler("lose_focus", __FUNC_E6B_)
	local function __FUNC_F3A_(arg0, arg1, arg2, arg3)
		SetSelectedFriendXUID(registerVal2, arg0, arg2)
		PromoteSelectedGroupAdminToOwner(registerVal2, arg0, arg2)
		return true
	end

	local function __FUNC_FDD_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT")
		return true
	end

	arg0:AddButtonCallbackFunction(registerVal3, arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, nil, __FUNC_F3A_, __FUNC_FDD_, false)
	...
	registerVal4.Glow2:setRGB(0.300000, 0.670000, 0.100000)
	...
	registerVal6.DefaultClip = __FUNC_10DA_
	registerVal5.DefaultState = registerVal6
	registerVal6 = {}
	local function __FUNC_1340_()
		registerVal2:setupElementClipCounter(2.000000)
		registerVal3:completeAnimation()
	...
	registerVal6.DefaultClip = __FUNC_1340_
	registerVal5.NoContent = registerVal6
	registerVal2.clipsPerState = registerVal5
	local registerVal7 = {}
	local registerVal8 = {}
	registerVal8.stateName = "NoContent"
	local function __FUNC_17F7_(arg0, arg2, arg3)
		return HasNoGroupAdmin(arg1)
	end

	registerVal8.condition = __FUNC_17F7_
	...
	registerVal2:registerEventHandler("gain_focus", __FUNC_1849_)
	local function __FUNC_194E_(arg0)
		arg0.AdminsList:close()
		arg0.GroupsNoConentDetail:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_194E_)
	if __FUNC_3AA_ then
		__FUNC_3AA_(registerVal2, arg1, arg0)
	end
	return registerVal2
end

CoD.AdminTabGroupAdminsTransferOwnershipFrame.new = __FUNC_410_
