...
CoD.GroupEmblemsTab = registerVal1
function CoD.GroupEmblemsTab.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.GroupEmblemsTab)
	registerVal2.id = "GroupEmblemsTab"
	...
	local function __FUNC_BBB_(arg0, arg2)
		EmblemSelect_GainFocus(registerVal2, arg0, arg1)
		return nil
	end

	registerVal5:registerEventHandler("list_item_gain_focus", __FUNC_BBB_)
	local function __FUNC_C20_(arg2, arg3)
	...
	registerVal5:registerEventHandler("gain_focus", __FUNC_C20_)
	local function __FUNC_DB3_(arg0, arg1)
	...
	registerVal5:registerEventHandler("lose_focus", __FUNC_DB3_)
	local function __FUNC_E82_(arg0, arg1, arg2, arg3)
	...
	local function __FUNC_FB5_(arg0, arg1, arg2)
	...
	arg0:AddButtonCallbackFunction(registerVal5, arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", __FUNC_E82_, __FUNC_FB5_, false)
	local registerVal8 = {}
	local registerVal9 = {}
	registerVal9.stateName = "EmptySlot"
	local function __FUNC_10F4_(arg0, arg2, arg3)
		local registerVal3 = Emblem_IsOccupied(arg2, arg1)
		return (not registerVal3)
	end

	registerVal9.condition = __FUNC_10F4_
	...
	registerVal2:registerEventHandler("gain_focus", __FUNC_1153_)
	local function __FUNC_1256_(arg0)
		arg0.emblemDrawWidget:close()
		arg0.emblemList:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1256_)
