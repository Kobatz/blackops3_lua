...
CoD.Promo_ZMDH_HeaderWidget = registerVal1
function CoD.Promo_ZMDH_HeaderWidget.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.Promo_ZMDH_HeaderWidget)
	registerVal2.id = "Promo_ZMDH_HeaderWidget"
	...
	registerVal3:setLeftRight(true, false, 0.000000, 176.000000)
	registerVal3:setTopBottom(true, false, 12.740000, 108.740000)
	registerVal3:setImage(RegisterImage("uie_t7_menu_community_bgb_header"))
	...
	registerVal6:setRGB(0.820000, 0.830000, 0.600000)
	...
	local function __FUNC_9AA_(arg0, arg1)
		ScaleWidgetToLabel(registerVal2, arg0, -159.000000)
	end

	LUI.OverrideFunction_CallOriginalFirst(registerVal6, "setText", __FUNC_9AA_)
	...
	registerVal8.DefaultClip = __FUNC_A09_
