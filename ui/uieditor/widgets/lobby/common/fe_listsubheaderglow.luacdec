...
CoD.FE_ListSubHeaderGlow = registerVal1
function CoD.FE_ListSubHeaderGlow.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.FE_ListSubHeaderGlow)
	registerVal2.id = "FE_ListSubHeaderGlow"
	...
	registerVal3:setImage(RegisterImage("uie_t7_menu_frontend_listsubheadglowfull"))
