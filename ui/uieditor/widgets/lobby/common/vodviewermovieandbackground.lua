...
CoD.VoDViewerMovieAndBackground = registerVal1
function CoD.VoDViewerMovieAndBackground.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.VoDViewerMovieAndBackground)
	registerVal2.id = "VoDViewerMovieAndBackground"
	...
	local function __FUNC_BE1_(arg0)
	...
	registerVal8:subscribeToGlobalModel(arg1, "VoDViewer", "stream", __FUNC_BE1_)
	...
	registerVal11.DefaultClip = __FUNC_C86_
	local function __FUNC_F51_()
		registerVal2:setupElementClipCounter(4.000000)
		...
		registerVal2.scorestreakVignetteContainer:setAlpha(0.500000)
		__FUNC_1311_(registerVal6, {})
		local function __FUNC_1535_(arg0, arg1)
			if not arg1.interrupted then
				arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			end
		...
		__FUNC_1759_(registerVal8, {})
		local function __FUNC_197D_(arg0, arg1)
			if not arg1.interrupted then
				arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			end
			arg0:setLeftRight(true, true, 166.670000, -166.670000)
		...
		__FUNC_197D_(registerVal9, {})
	end

	registerVal11.Windowed = __FUNC_F51_
	registerVal10.DefaultState = registerVal11
	registerVal11 = {}
	local function __FUNC_1BBF_()
	...
	registerVal11.DefaultClip = __FUNC_1BBF_
	local function __FUNC_2040_()
		registerVal2:setupElementClipCounter(4.000000)
		local function __FUNC_2397_(arg0, arg1)
			if not arg1.interrupted then
				arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			end
		...
		local function __FUNC_275E_(arg0, arg1)
			if not arg1.interrupted then
				arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			end
			arg0:setLeftRight(true, true, 0.000000, 0.000000)
		...
		registerVal2.TwitchStream0:setTopBottom(true, true, 97.000000, -97.000000)
		registerVal2.TwitchStream0:setScale(1.000000)
		__FUNC_275E_(registerVal8, {})
		local function __FUNC_2972_(arg0, arg1)
			if not arg1.interrupted then
				arg0:beginAnimation("keyframe", 300.000000, false, false, CoD.TweenType.Linear)
			end
			arg0:setLeftRight(true, true, 0.000000, 0.000000)
		...
		registerVal2.StartMenuframenoBG00:setAlpha(1.000000)
		registerVal2.StartMenuframenoBG00:setScale(1.000000)
		__FUNC_2972_(registerVal9, {})
	end

	registerVal11.DefaultState = __FUNC_2040_
	registerVal10.Windowed = registerVal11
	registerVal2.clipsPerState = registerVal10
	local function __FUNC_2BA4_(arg0)
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_2BA4_)
