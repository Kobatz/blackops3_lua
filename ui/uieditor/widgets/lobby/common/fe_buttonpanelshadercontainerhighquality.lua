...
CoD.FE_ButtonPanelShaderContainerHighQuality = registerVal1
function CoD.FE_ButtonPanelShaderContainerHighQuality.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.FE_ButtonPanelShaderContainerHighQuality)
	registerVal2.id = "FE_ButtonPanelShaderContainerHighQuality"
	...
	registerVal6.DefaultClip = __FUNC_952_
	registerVal5.DefaultState = registerVal6
	registerVal6 = {}
	local function __FUNC_ABC_()
		registerVal2:setupElementClipCounter(2.000000)
		registerVal3:completeAnimation()
	...
	registerVal6.DefaultClip = __FUNC_ABC_
	local function __FUNC_C23_()
	...
	registerVal6.DefaultState = __FUNC_C23_
	registerVal5.Transparent = registerVal6
	registerVal6 = {}
	local function __FUNC_EBD_()
		registerVal2:setupElementClipCounter(2.000000)
		registerVal3:completeAnimation()
		registerVal2.FEButtonPanel:setAlpha(0.000000)
		registerVal2.clipFinished(registerVal3, {})
	...
	registerVal2:subscribeToModel(registerVal7, __FUNC_1108_)
	local function __FUNC_1232_(arg0)
		arg0.FEButtonPanel:close()
		arg0.SafeHouseButtonPanel:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1232_)
