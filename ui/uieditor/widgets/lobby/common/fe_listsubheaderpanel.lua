...
CoD.FE_ListSubHeaderPanel = registerVal1
function CoD.FE_ListSubHeaderPanel.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.FE_ListSubHeaderPanel)
	registerVal2.id = "FE_ListSubHeaderPanel"
