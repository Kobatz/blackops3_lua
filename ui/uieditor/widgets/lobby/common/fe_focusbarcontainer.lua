...
CoD.FE_FocusBarContainer = registerVal1
function CoD.FE_FocusBarContainer.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.FE_FocusBarContainer)
	registerVal2.id = "FE_FocusBarContainer"
	...
	registerVal3:setShaderVector(0.000000, 0.041667, 0.500000, 0.000000, 0.000000)
	registerVal3:setupNineSliceShader(4.000000, 4.000000)
	registerVal2:addElement(registerVal3)
	registerVal2.FEFocusBarSolid = registerVal3
	local registerVal4 = LUI.UIImage.new()
	registerVal4:setLeftRight(true, true, -31.000000, 37.000000)
	registerVal4:setTopBottom(true, false, -3.210000, 11.210000)
	...
	local registerVal6 = {}
	local registerVal7 = {}
	local function __FUNC_8D7_()
		registerVal2:setupElementClipCounter(1.000000)
		local function __FUNC_9E6_(arg0, arg1)
			local function __FUNC_B5F_(arg0, arg1)
			...
			if arg1.interrupted then
				__FUNC_B5F_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 620.000000, false, false, CoD.TweenType.Linear)
			arg0:setAlpha(0.840000)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_B5F_)
		end

		registerVal4:completeAnimation()
		registerVal2.Glow2:setAlpha(0.690000)
		__FUNC_9E6_(registerVal4, {})
		registerVal2.nextClip = "DefaultClip"
	end

	registerVal7.DefaultClip = __FUNC_8D7_
