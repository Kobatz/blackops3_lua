...
CoD.prestigeRewardWidget_UI3D = registerVal1
function CoD.prestigeRewardWidget_UI3D.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.prestigeRewardWidget_UI3D)
	registerVal2.id = "prestigeRewardWidget_UI3D"
	...
	registerVal3:subscribeToGlobalModel(arg1, "CurrentWeapon", "weaponPrestigeUI3DText", __FUNC_88E_)
	...
	registerVal4:subscribeToGlobalModel(arg1, "CurrentWeapon", "weaponPrestigeUI3DText", __FUNC_992_)
	...
	local function __FUNC_A96_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal5:subscribeToGlobalModel(arg1, "CurrentWeapon", "weaponPrestigeUI3DText", __FUNC_A96_)
	...
	registerVal6:subscribeToGlobalModel(arg1, "CurrentWeapon", "weaponPrestigeUI3DText", __FUNC_B9A_)
	...
	registerVal7:subscribeToGlobalModel(arg1, "CurrentWeapon", "weaponPrestigeUI3DText", __FUNC_C9E_)
	...
	local function __FUNC_DA2_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal8:subscribeToGlobalModel(arg1, "CurrentWeapon", "weaponPrestigeUI3DText", __FUNC_DA2_)
	registerVal2:addElement(registerVal8)
	registerVal2.digit6 = registerVal8
	local function __FUNC_EA1_(arg0)
		arg0.digit1:close()
		arg0.digit2:close()
		arg0.digit3:close()
		arg0.digit4:close()
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_EA1_)
