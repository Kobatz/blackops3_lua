...
CoD.DetectNearbyEnemies_FarBack = registerVal1
function CoD.DetectNearbyEnemies_FarBack.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.DetectNearbyEnemies_FarBack)
	registerVal2.id = "DetectNearbyEnemies_FarBack"
	...
	registerVal2.DetectNearbyEnemiesFarBack = registerVal3
	local registerVal4 = {}
	local registerVal5 = {}
	local function __FUNC_745_()
		registerVal2:setupElementClipCounter(1.000000)
		registerVal3:completeAnimation()
		registerVal2.DetectNearbyEnemiesFarBack:setAlpha(0.000000)
		registerVal2.clipFinished(registerVal3, {})
	end

	registerVal5.DefaultClip = __FUNC_745_
	local function __FUNC_856_()
		...
		registerVal3:completeAnimation()
		registerVal2.DetectNearbyEnemiesFarBack:setAlpha(0.660000)
	...
	local function __FUNC_C79_()
		registerVal2:setupElementClipCounter(1.000000)
		registerVal3:completeAnimation()
		registerVal2.DetectNearbyEnemiesFarBack:setAlpha(1.000000)
		registerVal2.clipFinished(registerVal3, {})
	end
	...
	local function __FUNC_1029_(arg0, arg2, arg3)
		return IsEnemyDetected(arg1, "back", "far")
	end
