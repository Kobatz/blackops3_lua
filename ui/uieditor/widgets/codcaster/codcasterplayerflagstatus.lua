...
CoD.CodCasterPlayerFlagStatus = registerVal1
function CoD.CodCasterPlayerFlagStatus.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.CodCasterPlayerFlagStatus)
	registerVal2.id = "CodCasterPlayerFlagStatus"
	...
	registerVal5:setLeftRight(true, false, 32.000000, 254.000000)
	...
	registerVal6:setLeftRight(true, false, 32.000000, 254.000000)
	...
	registerVal7:setLeftRight(true, false, 8.000000, 27.000000)
	...
	registerVal9.DefaultClip = __FUNC_F37_
	registerVal8.DefaultState = registerVal9
	registerVal9 = {}
	local function __FUNC_1078_()
	...
	registerVal9.DefaultClip = __FUNC_1078_
	registerVal8.Flag_Held = registerVal9
	registerVal9 = {}
	local function __FUNC_1234_()
		registerVal2:setupElementClipCounter(2.000000)
		registerVal5:completeAnimation()
	...
	registerVal9.DefaultClip = __FUNC_1234_
	registerVal8.Flag_Away = registerVal9
	registerVal9 = {}
	local function __FUNC_1409_()
		registerVal2:setupElementClipCounter(2.000000)
		registerVal5:completeAnimation()
	...
	registerVal13.condition = __FUNC_16D8_
	...
	registerVal10 = Engine.GetModel(registerVal11, "CTF.friendlyFlagCarrier")
	...
	registerVal11 = Engine.GetModelForController(arg1)
	registerVal10 = Engine.GetModel(registerVal11, "CTF.friendlyFlagAway")
	...
	registerVal2:subscribeToModel(registerVal10, __FUNC_1851_)
	local function __FUNC_197A_(arg0)
		arg0.Panel:close()
		arg0.PlayerFlag:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_197A_)
