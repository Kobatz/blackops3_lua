...
CoD.CodCaster_Options_Slider_Control_Item = registerVal2
local function __FUNC_2FE_(arg0, arg1)
	...
	registerVal2:setClass(CoD.CodCaster_Options_Slider_Control_Item)
	registerVal2.id = "CodCaster_Options_Slider_Control_Item"
	...
	local function __FUNC_AB0_(arg0)
	...
	registerVal3:linkToElementModel(registerVal2, "text", true, __FUNC_AB0_)
	...
	local function __FUNC_B6A_(arg2, arg3)
	...
	registerVal4:registerEventHandler("button_action", __FUNC_B6A_)
	...
	local function __FUNC_C59_(arg2, arg3)
	...
	registerVal5:registerEventHandler("button_action", __FUNC_C59_)
	registerVal2:addElement(registerVal5)
	registerVal2.right = registerVal5
	local registerVal6 = {}
	local registerVal7 = {}
	local function __FUNC_D4A_()
	...
	registerVal7.DefaultClip = __FUNC_D4A_
	...
	registerVal7.Focus = __FUNC_F20_
	...
	registerVal7.DefaultClip = __FUNC_10AF_
	registerVal6.ArrowsHidden = registerVal7
	registerVal2.clipsPerState = registerVal6
	local function __FUNC_11FB_(arg0, arg2)
	...
	LUI.OverrideFunction_CallOriginalFirst(registerVal2, "setState", __FUNC_11FB_)
	local function __FUNC_13D0_(arg0)
		arg0.left:close()
		arg0.right:close()
		arg0.TextBox:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_13D0_)
	if __FUNC_23E_ then
...
CoD.CodCaster_Options_Slider_Control_Item.new = __FUNC_2FE_
