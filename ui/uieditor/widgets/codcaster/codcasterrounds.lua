...
CoD.CodCasterRounds = registerVal1
function CoD.CodCasterRounds.new(arg0, arg1)
	local registerVal3 = {}
	...
	registerVal2:setClass(CoD.CodCasterRounds)
	registerVal2.id = "CodCasterRounds"
	...
	local function __FUNC_B2B_(arg0)
	...
	registerVal5:subscribeToGlobalModel(arg1, "GameScore", "roundsPlayed", __FUNC_B2B_)
	...
	local function __FUNC_BE2_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal6:subscribeToGlobalModel(arg1, "GameScore", "roundLimit", __FUNC_BE2_)
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_CBC_)
