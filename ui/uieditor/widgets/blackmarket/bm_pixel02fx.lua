...
CoD.BM_Pixel02FX = registerVal1
function CoD.BM_Pixel02FX.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.BM_Pixel02FX)
	registerVal2.id = "BM_Pixel02FX"
