...
CoD.BlackMarketCODPointContainerSmall = registerVal1
function CoD.BlackMarketCODPointContainerSmall.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.BlackMarketCODPointContainerSmall)
	registerVal2.id = "BlackMarketCODPointContainerSmall"
	...
	local function __FUNC_A94_(arg0)
	...
	registerVal4:linkToElementModel(registerVal2, "itemCODPointCost", true, __FUNC_A94_)
	...
	local function __FUNC_B8F_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal5:subscribeToGlobalModel(arg1, "CryptoKeyProgress", "codPoints", __FUNC_B8F_)
	registerVal2:addElement(registerVal5)
	registerVal2.codpointBalance = registerVal5
	local registerVal6 = {}
	local registerVal7 = {}
	local function __FUNC_C87_()
	...
	registerVal7.DefaultClip = __FUNC_C87_
	...
	registerVal7.DefaultClip = __FUNC_DE2_
	...
	registerVal7.DefaultClip = __FUNC_113A_
	registerVal6.Shown = registerVal7
	registerVal7 = {}
	local function __FUNC_132C_()
		registerVal2:setupElementClipCounter(3.000000)
		registerVal3:completeAnimation()
		registerVal2.codpointIcon:setAlpha(1.000000)
		registerVal2.clipFinished(registerVal3, {})
	...
	registerVal7.DefaultClip = __FUNC_132C_
	...
	registerVal9.condition = __FUNC_1740_
	local registerVal10 = {}
	registerVal10.stateName = "ShownInsufficientFunds"
	local function __FUNC_17FA_(arg0, arg2, arg3)
	...
	registerVal10.condition = __FUNC_17FA_
	local registerVal11 = {}
	registerVal11.stateName = "Shown"
	local function __FUNC_190F_(arg0, arg2, arg3)
		return IsSelfModelValueGreaterThan(arg2, arg1, "itemCODPointCost", 0.000000)
	end

	registerVal11.condition = __FUNC_190F_
	local registerVal12 = {}
	registerVal12.stateName = "BalanceShownInsufficientFunds"
	local function __FUNC_1998_(arg0, arg2, arg3)
		local registerVal3 = IsSelfModelValueGreaterThan(arg2, arg1, "itemCODPointCost", 0.000000)
		if registerVal3 then
			registerVal3 = IsControllerModelValueGreaterThanOrEqualToSelfModelValue(arg2, arg1, "CryptoKeyProgress.codPoints", "itemCODPointCost")
		end
	...
	registerVal12.condition = __FUNC_1998_
	local registerVal13 = {}
	registerVal13.stateName = "BalanceShown"
	local function __FUNC_1AAF_(arg0, arg2, arg3)
		return IsSelfModelValueGreaterThan(arg2, arg1, "itemCODPointCost", 0.000000)
	end

	registerVal13.condition = __FUNC_1AAF_
	registerVal8 = {registerVal9, registerVal10, registerVal11, registerVal12, registerVal13}
	registerVal2:mergeStateConditions(registerVal8)
	local function __FUNC_1B38_(arg1)
		local registerVal4 = {}
	...
	registerVal2:subscribeToModel(registerVal8, __FUNC_1C5E_)
	local function __FUNC_1D8D_(arg0)
		arg0.codpointText:close()
		arg0.codpointBalance:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1D8D_)
