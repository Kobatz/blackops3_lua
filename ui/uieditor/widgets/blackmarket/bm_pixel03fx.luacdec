...
CoD.BM_Pixel03FX = registerVal1
function CoD.BM_Pixel03FX.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.BM_Pixel03FX)
	registerVal2.id = "BM_Pixel03FX"
	...
	local function __FUNC_85E_()
		...
		local function __FUNC_ADB_(arg0, arg1)
			local function __FUNC_C30_(arg0, arg1)
			...
			if arg1.interrupted then
				__FUNC_C30_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 100.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_C30_)
		end

		registerVal5:completeAnimation()
		registerVal2.Pixels03:setAlpha(0.000000)
		__FUNC_ADB_(registerVal5, {})
		registerVal6:completeAnimation()
		registerVal2.Pixels04:setAlpha(0.000000)
		registerVal2.clipFinished(registerVal6, {})
		local function __FUNC_F5D_(arg0, arg1)
			local function __FUNC_10B4_(arg0, arg1)
				if not arg1.interrupted then
					arg0:beginAnimation("keyframe", 679.000000, false, true, CoD.TweenType.Linear)
				end
				arg0:setAlpha(1.000000)
			...
			if arg1.interrupted then
				__FUNC_10B4_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 150.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_10B4_)
		end

		registerVal7:completeAnimation()
		registerVal2.mask:setAlpha(1.000000)
		registerVal2.mask:setScale(1.000000)
		__FUNC_F5D_(registerVal7, {})
	end

	registerVal9.DefaultClip = __FUNC_85E_
