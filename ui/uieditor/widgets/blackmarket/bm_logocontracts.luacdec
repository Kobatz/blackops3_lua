...
CoD.BM_LogoContracts = registerVal1
function CoD.BM_LogoContracts.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.BM_LogoContracts)
	registerVal2.id = "BM_LogoContracts"
	...
	registerVal6:setTopBottom(true, false, 52.000000, 73.000000)
	...
	LUI.OverrideFunction_CallOriginalFirst(registerVal6, "setText", __FUNC_98F_)
	...
	registerVal8.DefaultClip = __FUNC_9ED_
