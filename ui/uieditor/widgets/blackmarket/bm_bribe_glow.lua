...
CoD.BM_Bribe_glow = registerVal1
function CoD.BM_Bribe_glow.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.BM_Bribe_glow)
	registerVal2.id = "BM_Bribe_glow"
	...
	registerVal3:setImage(RegisterImage("uie_t7_blackmarket_bribe_bg_hover"))
	registerVal2:addElement(registerVal3)
	registerVal2.Bribeglow = registerVal3
	local registerVal4 = {}
	local registerVal5 = {}
	local function __FUNC_50D_()
	...
	registerVal5.DefaultClip = __FUNC_50D_
