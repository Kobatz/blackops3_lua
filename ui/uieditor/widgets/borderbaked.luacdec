...
CoD.BorderBaked = registerVal1
function CoD.BorderBaked.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.BorderBaked)
	registerVal2.id = "BorderBaked"
	...
	registerVal3:setImage(RegisterImage("uie_img_t7_menu_customclass_boxfull"))
