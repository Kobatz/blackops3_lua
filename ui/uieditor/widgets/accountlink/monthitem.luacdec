...
CoD.MonthItem = registerVal1
function CoD.MonthItem.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.MonthItem)
	registerVal2.id = "MonthItem"
	...
	registerVal2.Text:linkToElementModel(registerVal2, "month", true, __FUNC_AA6_)
	local registerVal8 = {}
	local registerVal9 = {}
	local function __FUNC_B38_()
	...
	registerVal9.DefaultClip = __FUNC_B38_
	local function __FUNC_CFF_()
		registerVal2:setupElementClipCounter(3.000000)
		registerVal4:completeAnimation()
		registerVal2.Text:setRGB(1.000000, 1.000000, 1.000000)
		registerVal2.clipFinished(registerVal4, {})
	...
	registerVal9.LoseFocus = __FUNC_CFF_
	local function __FUNC_F44_()
		registerVal2:setupElementClipCounter(3.000000)
		registerVal4:completeAnimation()
		registerVal2.Text:setRGB(1.000000, 1.000000, 1.000000)
		registerVal2.clipFinished(registerVal4, {})
	...
	registerVal9.Focus = __FUNC_F44_
	...
	registerVal9.DefaultClip = __FUNC_1106_
	registerVal8.Disabled = registerVal9
	registerVal2.clipsPerState = registerVal8
	local function __FUNC_1210_(arg0)
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1210_)
