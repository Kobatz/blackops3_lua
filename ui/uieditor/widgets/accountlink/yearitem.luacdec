...
CoD.YearItem = registerVal1
function CoD.YearItem.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.YearItem)
	registerVal2.id = "YearItem"
	...
	registerVal2.Text:linkToElementModel(registerVal2, "year", true, __FUNC_AA4_)
	local registerVal8 = {}
	local registerVal9 = {}
