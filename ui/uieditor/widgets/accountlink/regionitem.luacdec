...
CoD.RegionItem = registerVal1
function CoD.RegionItem.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.RegionItem)
	registerVal2.id = "RegionItem"
	...
	registerVal2.Text:linkToElementModel(registerVal2, "itemName", true, __FUNC_AAA_)
	local registerVal8 = {}
	local registerVal9 = {}
