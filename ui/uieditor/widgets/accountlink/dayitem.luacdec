...
CoD.DayItem = registerVal1
function CoD.DayItem.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.DayItem)
	registerVal2.id = "DayItem"
	...
	local function __FUNC_AA2_(arg0)
	...
	registerVal2.Text:linkToElementModel(registerVal2, "day", true, __FUNC_AA2_)
	local registerVal8 = {}
	local registerVal9 = {}
	...
	registerVal9.DefaultClip = __FUNC_B34_
	...
	registerVal9.LoseFocus = __FUNC_CFB_
	local function __FUNC_F40_()
		registerVal2:setupElementClipCounter(3.000000)
		registerVal4:completeAnimation()
		registerVal2.Text:setRGB(1.000000, 1.000000, 1.000000)
		registerVal2.clipFinished(registerVal4, {})
	...
	registerVal9.Focus = __FUNC_F40_
	...
	registerVal9.DefaultClip = __FUNC_1102_
