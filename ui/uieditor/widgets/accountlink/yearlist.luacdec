...
CoD.YearList = registerVal1
function CoD.YearList.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.YearList)
	registerVal2.id = "YearList"
	...
	local function __FUNC_C5C_(arg0, arg2)
	...
	registerVal3:registerEventHandler("button_action", __FUNC_C5C_)
	...
	registerVal5:setDataSource("Year")
	registerVal5:setWidgetType(CoD.YearItem)
	registerVal5:setVerticalCount(5.000000)
	registerVal5:setVerticalScrollbar(CoD.verticalScrollbarNew)
	local function __FUNC_D27_(arg0, arg2)
		ToggleDropdownListInUse_Console(registerVal2, arg1)
		UpdateState(registerVal2, arg2)
		AccountLink_SelectYear(registerVal2, arg0, arg1)
		return nil
	end

	registerVal5:registerEventHandler("list_item_button_action", __FUNC_D27_)
	...
	registerVal7.DefaultClip = __FUNC_EEC_
	registerVal6.InUse = registerVal7
	registerVal2.clipsPerState = registerVal6
	local registerVal8 = {}
	local registerVal9 = {}
	registerVal9.stateName = "InUse"
	local function __FUNC_FEB_(arg0, arg1, arg2)
		return DropdownListIsInUse_Console(arg1)
	end

	registerVal9.condition = __FUNC_FEB_
	registerVal8 = {registerVal9}
	registerVal2:mergeStateConditions(registerVal8)
	local function __FUNC_1049_(arg0, arg2)
	...
	LUI.OverrideFunction_CallOriginalFirst(registerVal2, "setState", __FUNC_1049_)
	registerVal3.id = "DropdownRoot"
	registerVal5.id = "DropdownList"
	local function __FUNC_10ED_(arg0, arg1)
	...
	registerVal2:registerEventHandler("gain_focus", __FUNC_10ED_)
	local function __FUNC_11F4_(arg0)
		arg0.DropdownRoot:close()
		arg0.DropdownList:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_11F4_)
