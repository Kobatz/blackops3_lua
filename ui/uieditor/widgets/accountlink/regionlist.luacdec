...
CoD.RegionList = registerVal1
function CoD.RegionList.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.RegionList)
	registerVal2.id = "RegionList"
	...
	local function __FUNC_C6A_(arg0, arg2)
	...
	registerVal3:registerEventHandler("button_action", __FUNC_C6A_)
	...
	registerVal5:setDataSource("DropdownListTest")
	registerVal5:setWidgetType(CoD.DropdownItem)
	registerVal5:setVerticalCount(5.000000)
	registerVal5:setVerticalScrollbar(CoD.verticalScrollbarNew)
	local function __FUNC_D33_(arg0, arg2)
		ToggleDropdownListInUse_Console(registerVal2, arg1)
		UpdateState(registerVal2, arg2)
		AccountLink_SelectRegion(registerVal2, arg0, arg1)
		return nil
	end

	registerVal5:registerEventHandler("list_item_button_action", __FUNC_D33_)
	...
	registerVal7.DefaultClip = __FUNC_DF8_
	registerVal6.DefaultState = registerVal7
	registerVal7 = {}
	local function __FUNC_EFC_()
		registerVal2:setupElementClipCounter(1.000000)
		registerVal5:completeAnimation()
	...
	registerVal7.DefaultClip = __FUNC_EFC_
	registerVal6.InUse = registerVal7
	registerVal2.clipsPerState = registerVal6
	local registerVal8 = {}
	local registerVal9 = {}
	registerVal9.stateName = "InUse"
	local function __FUNC_FFB_(arg0, arg1, arg2)
		return DropdownListIsInUse_Console(arg1)
	end

	registerVal9.condition = __FUNC_FFB_
	registerVal8 = {registerVal9}
	registerVal2:mergeStateConditions(registerVal8)
	local function __FUNC_1059_(arg0, arg2)
	...
	LUI.OverrideFunction_CallOriginalFirst(registerVal2, "setState", __FUNC_1059_)
	registerVal3.id = "DropdownRoot"
	registerVal5.id = "DropdownList"
	local function __FUNC_10FD_(arg0, arg1)
	...
	registerVal2:registerEventHandler("gain_focus", __FUNC_10FD_)
	local function __FUNC_1204_(arg0)
		arg0.DropdownRoot:close()
		arg0.DropdownList:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1204_)
