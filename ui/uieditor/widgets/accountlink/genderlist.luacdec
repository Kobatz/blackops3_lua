...
CoD.GenderList = registerVal1
function CoD.GenderList.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.GenderList)
	registerVal2.id = "GenderList"
	...
	local function __FUNC_C66_(arg0, arg2)
	...
	registerVal3:registerEventHandler("button_action", __FUNC_C66_)
	...
	registerVal5:setDataSource("Gender")
	registerVal5:setWidgetType(CoD.GenderItem)
	registerVal5:setVerticalCount(5.000000)
	registerVal5:setVerticalScrollbar(CoD.verticalScrollbarNew)
	local function __FUNC_D2F_(arg0, arg2)
		ToggleDropdownListInUse_Console(registerVal2, arg1)
		UpdateState(registerVal2, arg2)
		AccountLink_SelectGender(registerVal2, arg0, arg1)
		return nil
	end

	registerVal5:registerEventHandler("list_item_button_action", __FUNC_D2F_)
	...
	registerVal7.DefaultClip = __FUNC_DF4_
	registerVal6.DefaultState = registerVal7
	registerVal7 = {}
	local function __FUNC_EF8_()
		registerVal2:setupElementClipCounter(1.000000)
		registerVal5:completeAnimation()
	...
	registerVal7.DefaultClip = __FUNC_EF8_
	registerVal6.InUse = registerVal7
	registerVal2.clipsPerState = registerVal6
	local registerVal8 = {}
	local registerVal9 = {}
	registerVal9.stateName = "InUse"
	local function __FUNC_FF7_(arg0, arg1, arg2)
		return DropdownListIsInUse_Console(arg1)
	end

	registerVal9.condition = __FUNC_FF7_
	registerVal8 = {registerVal9}
	registerVal2:mergeStateConditions(registerVal8)
	local function __FUNC_1055_(arg0, arg2)
	...
	LUI.OverrideFunction_CallOriginalFirst(registerVal2, "setState", __FUNC_1055_)
	registerVal3.id = "DropdownRoot"
	registerVal5.id = "DropdownList"
	local function __FUNC_10F9_(arg0, arg1)
	...
	registerVal2:registerEventHandler("gain_focus", __FUNC_10F9_)
	local function __FUNC_1200_(arg0)
		arg0.DropdownRoot:close()
		arg0.DropdownList:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_1200_)
