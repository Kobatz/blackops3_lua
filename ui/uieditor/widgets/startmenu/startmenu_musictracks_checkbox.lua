...
CoD.StartMenu_MusicTracks_Checkbox = registerVal1
function CoD.StartMenu_MusicTracks_Checkbox.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.StartMenu_MusicTracks_Checkbox)
	registerVal2.id = "StartMenu_MusicTracks_Checkbox"
	...
	registerVal8.DefaultClip = __FUNC_972_
	...
	registerVal2:linkToElementModel(registerVal2, "selected", true, __FUNC_FD4_)
	local function __FUNC_10F2_(arg0)
		arg0.focusBorder:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_10F2_)
