...
local function __FUNC_281_(arg0, arg1)
	CoD.perController[arg1].controlsCategoryPC = "combat"
end
...
CoD.StartMenu_Options_PC_CombatControls = registerVal3
local function __FUNC_3B8_(arg0, arg1)
	...
	registerVal2:setClass(CoD.StartMenu_Options_PC_CombatControls)
	registerVal2.id = "StartMenu_Options_PC_CombatControls"
	...
	local function __FUNC_B63_(arg0)
	...
	registerVal5:linkToElementModel(registerVal3, "description", true, __FUNC_B63_)
	...
	registerVal5:linkToElementModel(registerVal3, "label", true, __FUNC_C3B_)
	...
	registerVal2:registerEventHandler("gain_focus", __FUNC_D2B_)
	...
	if __FUNC_31C_ then
		__FUNC_31C_(registerVal2, arg1, arg0)
	end
	return registerVal2
end

CoD.StartMenu_Options_PC_CombatControls.new = __FUNC_3B8_
