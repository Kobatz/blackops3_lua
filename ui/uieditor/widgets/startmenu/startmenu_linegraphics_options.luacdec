...
CoD.StartMenu_lineGraphics_Options = registerVal1
function CoD.StartMenu_lineGraphics_Options.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.StartMenu_lineGraphics_Options)
	registerVal2.id = "StartMenu_lineGraphics_Options"
	...
	registerVal5:setTopBottom(true, false, 155.000000, 207.000000)
	...
	registerVal9:setTopBottom(true, false, 439.000000, 491.000000)
	...
	registerVal2.pixelc000 = registerVal10
	local registerVal11 = LUI.UIImage.new()
	registerVal11:setLeftRight(true, false, 0.000000, 16.000000)
	registerVal11:setTopBottom(true, false, 583.000000, 635.000000)
	...
	registerVal2.pixelc100 = registerVal11
	...
	registerVal2.pixelc0000 = registerVal12
