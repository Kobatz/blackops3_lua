...
local function __FUNC_283_(arg0, arg1)
	CoD.perController[arg1].controlsCategoryPC = "interact"
end

local function __FUNC_31E_(arg0, arg1)
	local registerVal4 = {}
...
CoD.StartMenu_Options_PC_InteractControls = registerVal3
local function __FUNC_3B8_(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if __FUNC_283_ then
		__FUNC_283_(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.StartMenu_Options_PC_InteractControls)
	registerVal2.id = "StartMenu_Options_PC_InteractControls"
	...
	registerVal5:linkToElementModel(registerVal3, "description", true, __FUNC_B65_)
	local function __FUNC_C3F_(arg0)
		local registerVal1 = Engine.GetModelValue(arg0)
		if registerVal1 then
	...
	registerVal5:linkToElementModel(registerVal3, "label", true, __FUNC_C3F_)
	...
	registerVal2:registerEventHandler("gain_focus", __FUNC_D2F_)
	local function __FUNC_E33_(arg0)
		arg0.keybindList:close()
		arg0.optionInfo:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_E33_)
	if __FUNC_31E_ then
...
CoD.StartMenu_Options_PC_InteractControls.new = __FUNC_3B8_
