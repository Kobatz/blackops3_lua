...
CoD.ChooseClass_ClassSetTabPip_InGame = registerVal1
function CoD.ChooseClass_ClassSetTabPip_InGame.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.ChooseClass_ClassSetTabPip_InGame)
	registerVal2.id = "ChooseClass_ClassSetTabPip_InGame"
	...
	registerVal6.DefaultClip = __FUNC_8AE_
	registerVal5.DefaultState = registerVal6
	registerVal6 = {}
	local function __FUNC_AF5_()
		registerVal2:setupElementClipCounter(2.000000)
		registerVal3:completeAnimation()
	...
	registerVal6.DefaultClip = __FUNC_AF5_
	registerVal5.Selected = registerVal6
	registerVal2.clipsPerState = registerVal5
	local registerVal7 = {}
	local registerVal8 = {}
	registerVal8.stateName = "Selected"
	local function __FUNC_EB0_(arg0, arg2, arg3)
		return IsControllerModelValueEqualToSelfModelValue(arg2, arg1, "classSetValue", "classSetId")
	end

	registerVal8.condition = __FUNC_EB0_
	registerVal7 = {registerVal8}
	registerVal2:mergeStateConditions(registerVal7)
	registerVal8 = Engine.GetModelForController(arg1)
	registerVal7 = Engine.GetModel(registerVal8, "classSetValue")
	local function __FUNC_F58_(arg1)
		local registerVal4 = {}
		registerVal4.name = "model_validation"
		registerVal4.menu = arg0
		local registerVal5 = Engine.GetModelValue(arg1)
		registerVal4.modelValue = registerVal5
		registerVal4.modelName = "classSetValue"
		arg0:updateElementState(registerVal2, registerVal4)
	end

	registerVal2:subscribeToModel(registerVal7, __FUNC_F58_)
	local function __FUNC_107B_(arg1)
		local registerVal4 = {}
		registerVal4.name = "model_validation"
		registerVal4.menu = arg0
		local registerVal5 = Engine.GetModelValue(arg1)
	...
	registerVal2:linkToElementModel(registerVal2, "classSetId", true, __FUNC_107B_)
