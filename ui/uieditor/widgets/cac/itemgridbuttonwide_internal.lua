...
CoD.ItemGridButtonWide_Internal = registerVal1
function CoD.ItemGridButtonWide_Internal.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.ItemGridButtonWide_Internal)
	registerVal2.id = "ItemGridButtonWide_Internal"
	...
	registerVal6:setLeftRight(false, false, -29.000000, 29.000000)
	registerVal6:setTopBottom(false, true, -62.000000, -4.000000)
	...
	registerVal2.nameLabel:linkToElementModel(registerVal2, "name", true, __FUNC_A0D_)
	local registerVal9 = {}
	local registerVal10 = {}
	...
	registerVal10.DefaultClip = __FUNC_AC6_
	registerVal9.DefaultState = registerVal10
	registerVal10 = {}
	local function __FUNC_C1F_()
		registerVal2:setupElementClipCounter(2.000000)
		registerVal7:completeAnimation()
		registerVal2.alertIcon:setAlpha(0.000000)
		registerVal2.clipFinished(registerVal7, {})
	...
	registerVal10.DefaultClip = __FUNC_C1F_
	...
	registerVal10.DefaultClip = __FUNC_D7C_
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_EDC_)
