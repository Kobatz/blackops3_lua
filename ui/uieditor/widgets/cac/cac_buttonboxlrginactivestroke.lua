...
CoD.cac_ButtonBoxLrgInactiveStroke = registerVal1
function CoD.cac_ButtonBoxLrgInactiveStroke.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.cac_ButtonBoxLrgInactiveStroke)
	registerVal2.id = "cac_ButtonBoxLrgInactiveStroke"
	...
	registerVal3:setShaderVector(0.000000, 0.142857, 0.142857, 0.000000, 0.000000)
	...
	registerVal5.DefaultClip = __FUNC_60A_
