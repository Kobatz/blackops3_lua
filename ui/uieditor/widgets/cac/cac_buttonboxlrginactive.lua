...
CoD.cac_ButtonBoxLrgInactive = registerVal1
function CoD.cac_ButtonBoxLrgInactive.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.cac_ButtonBoxLrgInactive)
	registerVal2.id = "cac_ButtonBoxLrgInactive"
	...
	registerVal3:setShaderVector(0.000000, 0.056338, 0.231884, 0.357143, 0.357143)
	registerVal3:setupNineSliceShader(16.000000, 16.000000)
	registerVal2:addElement(registerVal3)
	registerVal2.Image = registerVal3
	local registerVal4 = {}
	local registerVal5 = {}
	local function __FUNC_60C_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal5.DefaultClip = __FUNC_60C_
