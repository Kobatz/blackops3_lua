...
CoD.ConsoleText = registerVal1
function CoD.ConsoleText.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.ConsoleText)
	registerVal2.id = "ConsoleText"
	...
	registerVal3:setLeftRight(true, false, 0.000000, 330.000000)
	...
	local function __FUNC_74E_()
		...
		__FUNC_829_(registerVal3, {})
	end

	registerVal5.FadeOut = __FUNC_74E_
	local function __FUNC_9DD_()
		...
		__FUNC_ABE_(registerVal3, {})
	end

	registerVal5.FadeIn = __FUNC_9DD_
