...
CoD.Games = registerVal1
function CoD.Games.new(arg0, arg1)
	local registerVal3 = {}
	...
	registerVal2:setClass(CoD.Games)
	registerVal2.id = "Games"
	...
	registerVal3:setText(Engine.Localize("MENU_GAME_CAPS"))
	...
	registerVal5:subscribeToGlobalModel(arg1, "GameScore", "roundsPlayed", __FUNC_903_)
	...
	registerVal6:subscribeToGlobalModel(arg1, "GameScore", "roundLimit", __FUNC_9BA_)
	...
	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_A94_)
