...
CoD.ScoreInfo_PanelScaleContainer = registerVal1
function CoD.ScoreInfo_PanelScaleContainer.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.ScoreInfo_PanelScaleContainer)
	registerVal2.id = "ScoreInfo_PanelScaleContainer"
	...
	registerVal3:setTopBottom(false, true, -8.000000, 0.000000)
	registerVal3:setImage(RegisterImage("uie_t7_cp_hud_scorewidget_panelll"))
	...
	registerVal4:setImage(RegisterImage("uie_t7_cp_hud_scorewidget_panellm"))
	...
	registerVal5:setTopBottom(false, true, -8.000000, 0.000000)
	registerVal5:setImage(RegisterImage("uie_t7_cp_hud_scorewidget_panellr"))
	...
	registerVal6:setImage(RegisterImage("uie_t7_cp_hud_scorewidget_panelml"))
	...
	registerVal7:setImage(RegisterImage("uie_t7_cp_hud_scorewidget_panelmm"))
	...
	registerVal8:setImage(RegisterImage("uie_t7_cp_hud_scorewidget_panelmr"))
	...
	registerVal9:setImage(RegisterImage("uie_t7_cp_hud_scorewidget_panelul"))
	...
	registerVal10:setImage(RegisterImage("uie_t7_cp_hud_scorewidget_panelum"))
	...
	registerVal11:setImage(RegisterImage("uie_t7_cp_hud_scorewidget_panelur"))
