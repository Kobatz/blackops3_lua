...
CoD.PrematchCountdown_2xpWeaponLabel = registerVal1
function CoD.PrematchCountdown_2xpWeaponLabel.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.PrematchCountdown_2xpWeaponLabel)
	registerVal2.id = "PrematchCountdown_2xpWeaponLabel"
	...
	local function __FUNC_903_(arg0, arg1)
		ScaleWidgetToLabelCentered(registerVal2, arg0, 15.000000)
	end

	LUI.OverrideFunction_CallOriginalFirst(registerVal5, "setText", __FUNC_903_)
	registerVal2:addElement(registerVal5)
	registerVal2.MatchText = registerVal5
	local function __FUNC_969_(arg0)
		arg0.FEButtonPanel0:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_969_)
