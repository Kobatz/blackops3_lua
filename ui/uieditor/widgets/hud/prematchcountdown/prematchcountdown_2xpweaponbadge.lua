...
CoD.PrematchCountdown_2xpWeaponBadge = registerVal1
function CoD.PrematchCountdown_2xpWeaponBadge.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.PrematchCountdown_2xpWeaponBadge)
	registerVal2.id = "PrematchCountdown_2xpWeaponBadge"
	...
	registerVal3:setImage(RegisterImage("uie_t7_hud_mp_notifications_2xp_weapon"))
	...
	registerVal6.DefaultClip = __FUNC_8E6_
	...
	registerVal6.DefaultClip = __FUNC_A3E_
	registerVal5.french = registerVal6
	registerVal2.clipsPerState = registerVal5
	local registerVal7 = {}
	local registerVal8 = {}
	registerVal8.stateName = "french"
	local function __FUNC_B96_(arg0, arg1, arg2)
		return IsCurrentLanguageFrench()
	end

	registerVal8.condition = __FUNC_B96_
