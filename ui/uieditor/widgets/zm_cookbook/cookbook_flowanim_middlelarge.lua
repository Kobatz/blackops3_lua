...
CoD.Cookbook_FlowAnim_MiddleLarge = registerVal1
function CoD.Cookbook_FlowAnim_MiddleLarge.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.Cookbook_FlowAnim_MiddleLarge)
	registerVal2.id = "Cookbook_FlowAnim_MiddleLarge"
	...
	registerVal4:setTopBottom(true, false, -52.000000, 209.000000)
	registerVal4:setRGB(0.000000, 0.000000, 0.000000)
	registerVal4:setXRot(180.000000)
	registerVal4:setImage(RegisterImage("uie_t7_zm_cookbook_flow_middlemask"))
