...
CoD.Cookbook_FlowAnim_Middle = registerVal1
function CoD.Cookbook_FlowAnim_Middle.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.Cookbook_FlowAnim_Middle)
	registerVal2.id = "Cookbook_FlowAnim_Middle"
	...
	local registerVal5 = {}
	local registerVal6 = {}
	local function __FUNC_6E0_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.DefaultClip = __FUNC_6E0_
