...
CoD.Cookbook_FlowAnim = registerVal1
function CoD.Cookbook_FlowAnim.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.Cookbook_FlowAnim)
	registerVal2.id = "Cookbook_FlowAnim"
