...
CoD.vhud_agr_internal = registerVal1
function CoD.vhud_agr_internal.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.vhud_agr_internal)
	registerVal2.id = "vhud_agr_internal"
	...
	local registerVal5 = CoD.vhud_agr_reticle.new(arg0, arg1)
	...
	registerVal5:linkToElementModel(registerVal2, nil, false, __FUNC_B4B_)
	local function __FUNC_B9A_(arg0, arg2)
		local registerVal5 = {}
		registerVal5.elementName = "vhudagrreticle"
	...
	registerVal5:registerEventHandler("menu_loaded", __FUNC_B9A_)
	local registerVal8 = {}
	local registerVal9 = {}
	...
	local function __FUNC_CFE_(arg1)
		local registerVal4 = {}
	...
	registerVal5:linkToElementModel(registerVal5, "zoomed", true, __FUNC_CFE_)
	registerVal2:addElement(registerVal5)
	registerVal2.vhudagrreticle = registerVal5
	...
	registerVal8:linkToElementModel(registerVal2, "bindings", false, __FUNC_E18_)
	local function __FUNC_E6A_(arg0, arg2)
	...
	registerVal8:registerEventHandler("menu_loaded", __FUNC_E6A_)
	registerVal2:addElement(registerVal8)
	registerVal2.vhudagrButtonContainer = registerVal8
	local function __FUNC_EFD_(arg0)
		arg0.vhudagrreticle:close()
		arg0.vhudagrButtonContainer:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_EFD_)
