...
CoD.vhud_hellstorm_AltWidget = registerVal1
function CoD.vhud_hellstorm_AltWidget.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.vhud_hellstorm_AltWidget)
	registerVal2.id = "vhud_hellstorm_AltWidget"
