...
CoD.vhud_hellstorm_timebar = registerVal1
function CoD.vhud_hellstorm_timebar.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.vhud_hellstorm_timebar)
	registerVal2.id = "vhud_hellstorm_timebar"
	...
	registerVal3:setRGB(0.910000, 0.670000, 0.250000)
	...
	local function __FUNC_A66_(arg0)
	...
	registerVal6:linkToElementModel(registerVal2, "remainingTime", true, __FUNC_A66_)
	...
	local function __FUNC_BBC_(arg0)
		arg0.vhudModDNITime00:close()
		arg0.vhudModDNITime0:close()
		arg0.Bar:close()
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal2, "close", __FUNC_BBC_)
