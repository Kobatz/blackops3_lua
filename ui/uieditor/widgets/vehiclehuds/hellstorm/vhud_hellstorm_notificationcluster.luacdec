...
CoD.vhud_hellstorm_NotificationCluster = registerVal1
function CoD.vhud_hellstorm_NotificationCluster.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.vhud_hellstorm_NotificationCluster)
	registerVal2.id = "vhud_hellstorm_NotificationCluster"
	...
	registerVal5:setText(Engine.Localize("MENU_HUD_VEHICLE_CLUSTER"))
	...
	registerVal2.CLUSTER = registerVal5
	local registerVal6 = LUI.UIText.new()
	registerVal6:setLeftRight(true, true, 0.000000, 0.000000)
	registerVal6:setTopBottom(false, false, -9.000000, 7.000000)
	registerVal6:setText(Engine.Localize("MENU_HUD_VEHICLE_CLUSTER"))
	...
	registerVal2.CLUSTER0 = registerVal6
