...
CoD.VehicleGround_ModT1 = registerVal1
function CoD.VehicleGround_ModT1.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.VehicleGround_ModT1)
	registerVal2.id = "VehicleGround_ModT1"
	...
	registerVal3:setImage(RegisterImage("uie_t7_cp_hud_vehicle_ground_modulest1"))
	registerVal3:setMaterial(LUI.UIImage.GetCachedMaterial("ui_add"))
	registerVal2:addElement(registerVal3)
	registerVal2.Image4 = registerVal3
	local registerVal4 = LUI.UIImage.new()
	registerVal4:setLeftRight(true, false, 12.000000, 20.000000)
	...
	local function __FUNC_761_()
		...
		local function __FUNC_86E_(arg0, arg1)
			local function __FUNC_9C4_(arg0, arg1)
				local function __FUNC_B3F_(arg0, arg1)
				...
				if arg1.interrupted then
					__FUNC_B3F_(arg0, arg1)
					return 
				end
				arg0:beginAnimation("keyframe", 9.000000, false, false, CoD.TweenType.Linear)
				arg0:setAlpha(0.000000)
				arg0:registerEventHandler("transition_complete_keyframe", __FUNC_B3F_)
			end

			if arg1.interrupted then
				__FUNC_9C4_(arg0, arg1)
				return 
			end
			arg0:beginAnimation("keyframe", 100.000000, false, false, CoD.TweenType.Linear)
			arg0:registerEventHandler("transition_complete_keyframe", __FUNC_9C4_)
		end

		registerVal4:completeAnimation()
		registerVal2.Image0:setAlpha(1.000000)
		__FUNC_86E_(registerVal4, {})
	...
	registerVal6.DefaultClip = __FUNC_CF1_
	...
	local function __FUNC_DB0_(arg1)
		local registerVal4 = {}
	...
	registerVal2:linkToElementModel(registerVal2, "vehicleType", true, __FUNC_DB0_)
