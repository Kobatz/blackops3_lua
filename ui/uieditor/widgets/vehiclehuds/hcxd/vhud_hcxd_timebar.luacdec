...
CoD.vhud_hcxd_Timebar = registerVal1
function CoD.vhud_hcxd_Timebar.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.vhud_hcxd_Timebar)
	registerVal2.id = "vhud_hcxd_Timebar"
	...
	registerVal3:setRGB(0.810000, 0.960000, 1.000000)
	...
	registerVal4:setRGB(0.810000, 0.960000, 1.000000)
	...
	registerVal5:setRGB(0.810000, 0.960000, 1.000000)
