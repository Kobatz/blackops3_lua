...
CoD.vhud_ms_NotificationBox = registerVal1
function CoD.vhud_ms_NotificationBox.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.vhud_ms_NotificationBox)
	registerVal2.id = "vhud_ms_NotificationBox"
	...
	registerVal5:setTopBottom(false, false, -7.640000, 8.360000)
	registerVal5:setText(Engine.Localize("MENU_HUD_VEHICLE_ALT"))
	...
	LUI.OverrideFunction_CallOriginalFirst(registerVal5, "setText", __FUNC_A8F_)
	registerVal2:addElement(registerVal5)
	registerVal2.ALTtext = registerVal5
