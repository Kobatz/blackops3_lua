...
CoD.vhud_ms_NotificationFlir = registerVal1
function CoD.vhud_ms_NotificationFlir.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.vhud_ms_NotificationFlir)
	registerVal2.id = "vhud_ms_NotificationFlir"
	...
	registerVal3:setTopBottom(true, true, 0.000000, -1.150000)
	registerVal3:setRGB(0.420000, 0.930000, 1.000000)
	...
	registerVal6:setText(Engine.Localize("MENU_HUD_VEHICLE_IR"))
	...
	local function __FUNC_C65_(arg0, arg1)
		ScaleWidgetToLabelCenteredWithMinimum(registerVal2, arg0, 25.000000, 81.000000)
	end

	LUI.OverrideFunction_CallOriginalFirst(registerVal6, "setText", __FUNC_C65_)
	registerVal2:addElement(registerVal6)
	registerVal2.FLIR = registerVal6
	...
	registerVal9.DefaultClip = __FUNC_CE1_
	local function __FUNC_E3B_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal9.StartUp = __FUNC_E3B_
	registerVal8.DefaultState = registerVal9
	registerVal9 = {}
	local function __FUNC_E9A_()
		registerVal2:setupElementClipCounter(3.000000)
		registerVal3:completeAnimation()
		registerVal2.GlowOrangeOver:setAlpha(0.250000)
		registerVal2.GlowOrangeOver:setScale(1.200000)
		registerVal2.clipFinished(registerVal3, {})
		registerVal6:completeAnimation()
		registerVal2.FLIR:setAlpha(1.000000)
	...
	registerVal9.DefaultClip = __FUNC_E9A_
