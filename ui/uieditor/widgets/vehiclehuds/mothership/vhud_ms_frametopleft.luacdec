...
CoD.vhud_ms_FrameTopLeft = registerVal1
function CoD.vhud_ms_FrameTopLeft.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.vhud_ms_FrameTopLeft)
	registerVal2.id = "vhud_ms_FrameTopLeft"
	...
	registerVal2.msTopFrameLeft = registerVal4
	local registerVal5 = {}
	local registerVal6 = {}
	local function __FUNC_767_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.DefaultClip = __FUNC_767_
	local function __FUNC_7C6_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.StartUp = __FUNC_7C6_
	local function __FUNC_826_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.Zoom = __FUNC_826_
	...
	registerVal6.DefaultClip = __FUNC_886_
	local function __FUNC_8E6_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.DefaultState = __FUNC_8E6_
