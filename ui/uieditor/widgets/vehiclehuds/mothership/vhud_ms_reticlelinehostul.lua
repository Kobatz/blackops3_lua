...
CoD.vhud_ms_ReticleLineHostUL = registerVal1
function CoD.vhud_ms_ReticleLineHostUL.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.vhud_ms_ReticleLineHostUL)
	registerVal2.id = "vhud_ms_ReticleLineHostUL"
	...
	registerVal2.msReticleHostUpperL = registerVal4
	local registerVal5 = {}
	local registerVal6 = {}
	...
	registerVal6.DefaultClip = __FUNC_774_
	local function __FUNC_7D6_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.StartUp = __FUNC_7D6_
	local function __FUNC_836_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.Zoom = __FUNC_836_
	...
	registerVal6.DefaultClip = __FUNC_896_
	local function __FUNC_8F6_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.DefaultState = __FUNC_8F6_
