...
CoD.vhud_ms_FrameBottomRight = registerVal1
function CoD.vhud_ms_FrameBottomRight.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.vhud_ms_FrameBottomRight)
	registerVal2.id = "vhud_ms_FrameBottomRight"
	...
	registerVal2.msBottomFrameRight = registerVal4
	local registerVal5 = {}
	local registerVal6 = {}
	...
	registerVal6.DefaultClip = __FUNC_773_
	local function __FUNC_7D2_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.StartUp = __FUNC_7D2_
	local function __FUNC_832_()
		registerVal2:setupElementClipCounter(0.000000)
	end

	registerVal6.Zoom = __FUNC_832_
	...
	registerVal6.DefaultState = __FUNC_8F2_
