...
CoD.vhud_dart_NotificationAltBox = registerVal1
function CoD.vhud_dart_NotificationAltBox.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(false)
	registerVal2:setClass(CoD.vhud_dart_NotificationAltBox)
	registerVal2.id = "vhud_dart_NotificationAltBox"
	...
	registerVal2.boxNormal = registerVal3
	...
	registerVal2.boxAdd = registerVal4
	...
	LUI.OverrideFunction_CallOriginalFirst(registerVal5, "setText", __FUNC_A87_)
