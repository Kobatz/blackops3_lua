...
CoD.vhud_turret_damageicon = registerVal1
function CoD.vhud_turret_damageicon.new(arg0, arg1)
	local registerVal2 = LUI.UIElement.new()
	if PreLoadFunc then
		PreLoadFunc(registerVal2, arg1)
	end
	registerVal2:setUseStencil(true)
	registerVal2:setClass(CoD.vhud_turret_damageicon)
	registerVal2.id = "vhud_turret_damageicon"
	...
	registerVal3:setLeftRight(false, false, -48.820000, 49.180000)
	registerVal3:setTopBottom(false, false, -48.770000, 49.230000)
	registerVal3:setRGB(1.000000, 0.830000, 0.390000)
	registerVal3:setAlpha(0.200000)
	registerVal3:setZoom(-50.000000)
	registerVal3:setImage(RegisterImage("uie_t7_cp_hud_vehicle_turret_damageiconlinergb"))
	registerVal3:setMaterial(LUI.UIImage.GetCachedMaterial("ui_add"))
	registerVal2:addElement(registerVal3)
	registerVal2.Line0 = registerVal3
	local registerVal4 = LUI.UIImage.new()
	registerVal4:setLeftRight(false, false, -48.820000, 49.180000)
	registerVal4:setTopBottom(false, false, -48.770000, 49.230000)
	registerVal4:setAlpha(0.800000)
	registerVal4:setImage(RegisterImage("uie_t7_cp_hud_vehicle_turret_damageiconred"))
	...
	local function __FUNC_899_(arg0)
	...
	registerVal4:linkToElementModel(registerVal2, "damage", true, __FUNC_899_)
	registerVal2:addElement(registerVal4)
	registerVal2.Red = registerVal4
	local registerVal5 = LUI.UIImage.new()
	registerVal5:setLeftRight(false, false, -48.820000, 49.180000)
	registerVal5:setTopBottom(false, false, -48.770000, 49.230000)
	registerVal5:setRGB(1.000000, 0.830000, 0.390000)
	registerVal5:setImage(RegisterImage("uie_t7_cp_hud_vehicle_turret_damageiconlinergb"))
