...
function LUI.createMenu.EditCodCasterDisplaySettings(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("EditCodCasterDisplaySettings")
	if PreLoadFunc then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "EditCodCasterDisplaySettings.buttonPrompts")
	...
	local function __FUNC_136E_(arg1, arg2, arg3)
		return IsGlobalModelValueEqualTo(arg2, arg0, "hideWorldForStreamer", 0.000000)
	end

	registerVal8.condition = __FUNC_136E_
	...
	registerVal4:subscribeToModel(registerVal7, __FUNC_13FA_)
	...
	registerVal5.titleLabel:setText(Engine.Localize(LocalizeToUpperString("CODCASTER_DISPLAY_SETTINGS")))
	registerVal5.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText(Engine.Localize(LocalizeToUpperString("CODCASTER_DISPLAY_SETTINGS")))
	...
	registerVal6:setTopBottom(true, false, 147.000000, 621.000000)
	registerVal6:setDataSource("CodCasterDisplaySettingsButtonList")
	registerVal6:setWidgetType(CoD.codcaster_options_slider)
	registerVal6:setVerticalCount(14.000000)
	registerVal6:setHorizontalScrollbar(CoD.verticalCounter)
	local function __FUNC_1522_(arg1, arg2)
	...
	registerVal6:registerEventHandler("gain_focus", __FUNC_1522_)
	...
	registerVal1:AddButtonCallbackFunction(registerVal6, arg0, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", __FUNC_1782_, __FUNC_1820_, false)
	...
	local function __FUNC_1963_(arg0)
	...
	registerVal8:linkToElementModel(registerVal6, "displayText", true, __FUNC_1963_)
	...
	registerVal9:linkToElementModel(registerVal6, "hintText", true, __FUNC_1A41_)
	...
	local function __FUNC_1B9D_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_1B17_, __FUNC_1B9D_, false)
	...
	local function __FUNC_1C99_(arg1)
		...
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "EditCodCasterDisplaySettings.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_1C99_)
