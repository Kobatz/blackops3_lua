...
function LUI.createMenu.Challenges_Operations(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Challenges_Operations")
	if PreLoadFunc then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Challenges_Operations.buttonPrompts")
	...
	local function __FUNC_16E2_(arg0, arg1, arg2)
		return IsInGame()
	end

	registerVal7.condition = __FUNC_16E2_
	...
	registerVal6:setTopBottom(false, false, -275.000000, -235.000000)
	...
	registerVal1.TabFrame = registerVal9
	...
	registerVal11.titleLabel:setText(Engine.Localize("MENU_OPERATIONS_CAPS"))
	registerVal11.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText(Engine.Localize("MENU_OPERATIONS_CAPS"))
	registerVal11.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.FeatureIcon.FeatureIcon:setImage(RegisterImage("uie_barracks_assignments_icon"))
	...
	local function __FUNC_172A_(arg1)
		registerVal12:setModel(arg1, arg0)
	end

	registerVal12:subscribeToGlobalModel(arg0, "PerController", "identityBadge", __FUNC_172A_)
	local function __FUNC_177A_(arg1)
		registerVal12.CallingCard.CallingCardsFrameWidget:setModel(arg1, arg0)
	end

	registerVal12:subscribeToGlobalModel(arg0, "PerController", nil, __FUNC_177A_)
	registerVal1:addElement(registerVal12)
	registerVal1.SelfIdentityBadge = registerVal12
	local registerVal13 = CoD.FE_TabBar.new(registerVal1, arg0)
	registerVal13:setLeftRight(true, false, 0.000000, 2496.000000)
	registerVal13:setTopBottom(true, false, 86.000000, 127.000000)
	registerVal13.Tabs.grid:setWidgetType(CoD.paintshopTabWidget_SM)
	registerVal13.Tabs.grid:setHorizontalCount(9.000000)
	registerVal13.Tabs.grid:setDataSource("OperationsTabs")
	local function __FUNC_1818_(arg1, arg2)
		Challenges_UpdateListFromTabChanged(registerVal1, arg1, arg0)
		return nil
	end

	registerVal13:registerEventHandler("list_active_changed", __FUNC_1818_)
	registerVal1:addElement(registerVal13)
	registerVal1.FETabBar = registerVal13
	local registerVal14 = CoD.StartMenu_LeftGraphics.new(registerVal1, arg0)
	registerVal14:setLeftRight(true, false, 17.000000, 78.870000)
	registerVal14:setTopBottom(true, false, 75.000000, 674.000000)
	registerVal1:addElement(registerVal14)
	registerVal1.StartMenuLeftGraphics = registerVal14
	local function __FUNC_188D_(arg0)
	...
	registerVal9:linkToElementModel(registerVal13.Tabs.grid, "tabWidget", true, __FUNC_188D_)
	local function __FUNC_192A_(arg0, arg1, arg2, arg3)
		GoBackAndUpdateSelectedChallengesButton(arg1, arg2)
		return true
	end

	local function __FUNC_199D_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_192A_, __FUNC_199D_, false)
	registerVal9.id = "TabFrame"
	...
	local function __FUNC_1A99_(arg1)
		...
		arg1.TabFrame:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Challenges_Operations.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_1A99_)
