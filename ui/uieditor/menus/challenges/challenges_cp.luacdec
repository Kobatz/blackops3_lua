...
local function __FUNC_3DD_(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Challenges_CP")
	if PreLoadFunc then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Challenges_CP.buttonPrompts")
	...
	local registerVal10 = CoD.Challenges_CP_Summary.new(registerVal1, arg0)
	...
	registerVal1.CPSummaryFrame = registerVal10
	...
	registerVal10.id = "CPSummaryFrame"
	...
	if not registerVal15 then
		...
		registerVal17.controller = arg0
		registerVal1.CPSummaryFrame:processEvent(registerVal17)
	end
	local function __FUNC_1679_(arg1)
		arg1.StartMenuBackground0:close()
		arg1.FEButtonPanelShaderContainer0:close()
		arg1.CPSummaryFrame:close()
		arg1.MenuFrame:close()
		arg1.Tabs:close()
		arg1.FEMenuLeftGraphics:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Challenges_CP.buttonPrompts"))
	end
...
LUI.createMenu.Challenges_CP = __FUNC_3DD_
