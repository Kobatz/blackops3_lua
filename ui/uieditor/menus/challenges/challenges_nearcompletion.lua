...
function LUI.createMenu.Challenges_NearCompletion(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Challenges_NearCompletion")
	if PreLoadFunc then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Challenges_NearCompletion.buttonPrompts")
	...
	local function __FUNC_14EA_(arg0, arg1, arg2)
		return IsInGame()
	end

	registerVal7.condition = __FUNC_14EA_
	...
	local registerVal10 = CoD.Challenges_FrameWidget_NearCompletion.new(registerVal1, arg0)
	...
	registerVal1.NearCompletionFrame = registerVal10
	...
	registerVal12.titleLabel:setText(Engine.Localize("MENU_NEAR_COMPLETION_CAPS"))
	registerVal12.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText(Engine.Localize("MENU_NEAR_COMPLETION_CAPS"))
	...
	local function __FUNC_1584_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_1532_, __FUNC_1584_, false)
	registerVal10.id = "NearCompletionFrame"
	...
	if not registerVal15 then
		...
		registerVal17.controller = arg0
		registerVal1.NearCompletionFrame:processEvent(registerVal17)
	end
	local function __FUNC_1681_(arg1)
		arg1.StartMenuBackground0:close()
		arg1.FEButtonPanelShaderContainer0:close()
		arg1.NearCompletionFrame:close()
		arg1.MenuFrame:close()
		arg1.Tabs:close()
		arg1.FEMenuLeftGraphics:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Challenges_NearCompletion.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_1681_)
