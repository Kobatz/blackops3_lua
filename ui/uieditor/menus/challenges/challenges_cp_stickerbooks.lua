...
function LUI.createMenu.Challenges_CP_Stickerbooks(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Challenges_CP_Stickerbooks")
	if PreLoadFunc then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Challenges_CP_Stickerbooks.buttonPrompts")
	...
	local function __FUNC_1640_(arg0, arg1, arg2)
		return IsInGame()
	end

	registerVal7.condition = __FUNC_1640_
	...
	local function __FUNC_168A_(arg1)
		registerVal12:setModel(arg1, arg0)
	end

	registerVal12:subscribeToGlobalModel(arg0, "PerController", "identityBadge", __FUNC_168A_)
	local function __FUNC_16DA_(arg1)
		registerVal12.CallingCard.CallingCardsFrameWidget:setModel(arg1, arg0)
	end

	registerVal12:subscribeToGlobalModel(arg0, "PerController", nil, __FUNC_16DA_)
	...
	registerVal13.Tabs.grid:setDataSource("CPChallengesTabs")
	local function __FUNC_1778_(arg1, arg2)
		Challenges_UpdateListFromTabChanged(registerVal1, arg1, arg0)
		return nil
	end

	registerVal13:registerEventHandler("list_active_changed", __FUNC_1778_)
	...
	local function __FUNC_17ED_(arg0)
	...
	registerVal9:linkToElementModel(registerVal13.Tabs.grid, "tabWidget", true, __FUNC_17ED_)
	local function __FUNC_188A_(arg0, arg1, arg2, arg3)
		GoBackAndUpdateSelectedChallengesButton(arg1, arg2)
		return true
	end

	local function __FUNC_18FD_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_188A_, __FUNC_18FD_, false)
	...
	local function __FUNC_19F9_(arg1)
		...
		arg1.TabFrame:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Challenges_CP_Stickerbooks.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_19F9_)
