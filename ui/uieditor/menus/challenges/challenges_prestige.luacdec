...
function LUI.createMenu.Challenges_Prestige(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Challenges_Prestige")
	if PreLoadFunc then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Challenges_Prestige.buttonPrompts")
	...
	local function __FUNC_178B_(arg0, arg1, arg2)
		return IsInGame()
	end

	registerVal7.condition = __FUNC_178B_
	...
	registerVal12.titleLabel:setText(Engine.Localize("MENU_EMBLEM_BACKGROUND_PRESTIGETAB"))
	registerVal12.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText(Engine.Localize("MENU_EMBLEM_BACKGROUND_PRESTIGETAB"))
	...
	registerVal13:subscribeToGlobalModel(arg0, "PerController", "identityBadge", __FUNC_17D2_)
	local function __FUNC_1822_(arg1)
		registerVal13.CallingCard.CallingCardsFrameWidget:setModel(arg1, arg0)
	end

	registerVal13:subscribeToGlobalModel(arg0, "PerController", nil, __FUNC_1822_)
	...
	registerVal14:setTopBottom(true, false, 86.000000, 127.000000)
	registerVal14.Tabs.grid:setWidgetType(CoD.paintshopTabWidget_SM)
	registerVal14.Tabs.grid:setHorizontalCount(10.000000)
	registerVal14.Tabs.grid:setDataSource("PrestigeTabs")
	local function __FUNC_18C0_(arg1, arg2)
		Challenges_UpdateListFromTabChanged(registerVal1, arg1, arg0)
		return nil
	end

	registerVal14:registerEventHandler("list_active_changed", __FUNC_18C0_)
	...
	local function __FUNC_1935_(arg0)
	...
	registerVal10:linkToElementModel(registerVal14.Tabs.grid, "tabWidget", true, __FUNC_1935_)
	local function __FUNC_19D2_(arg0, arg1, arg2, arg3)
		GoBackAndUpdateSelectedChallengesButton(arg1, arg2)
		return true
	end

	local function __FUNC_1A45_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_19D2_, __FUNC_1A45_, false)
	...
	local function __FUNC_1B41_(arg1)
		...
		arg1.TabFrame:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Challenges_Prestige.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_1B41_)
