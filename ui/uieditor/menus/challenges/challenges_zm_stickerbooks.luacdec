...
function LUI.createMenu.Challenges_ZM_Stickerbooks(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Challenges_ZM_Stickerbooks")
	if PreLoadFunc then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Challenges_ZM_Stickerbooks.buttonPrompts")
	...
	registerVal13.Tabs.grid:setDataSource("ZMChallengesTabs")
	...
	local function __FUNC_19F9_(arg1)
		...
		arg1.TabFrame:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Challenges_ZM_Stickerbooks.buttonPrompts"))
	end
