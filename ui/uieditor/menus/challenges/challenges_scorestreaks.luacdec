...
function LUI.createMenu.Challenges_Scorestreaks(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Challenges_Scorestreaks")
	if PreLoadFunc then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Challenges_Scorestreaks.buttonPrompts")
	...
	local function __FUNC_1698_(arg0, arg1, arg2)
		return IsInGame()
	end

	registerVal7.condition = __FUNC_1698_
	...
	registerVal12.titleLabel:setText(Engine.Localize("MENU_SCORESTREAKS_CAPS"))
	registerVal12.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText(Engine.Localize("MENU_SCORESTREAKS_CAPS"))
	...
	local function __FUNC_16E2_(arg1)
		registerVal13:setModel(arg1, arg0)
	end

	registerVal13:subscribeToGlobalModel(arg0, "PerController", "identityBadge", __FUNC_16E2_)
	local function __FUNC_1732_(arg1)
		registerVal13.CallingCard.CallingCardsFrameWidget:setModel(arg1, arg0)
	end

	registerVal13:subscribeToGlobalModel(arg0, "PerController", nil, __FUNC_1732_)
	...
	registerVal14.Tabs.grid:setDataSource("ScorestreaksTabs")
	local function __FUNC_17D0_(arg1, arg2)
		Challenges_UpdateListFromTabChanged(registerVal1, arg1, arg0)
		return nil
	end

	registerVal14:registerEventHandler("list_active_changed", __FUNC_17D0_)
	...
	local function __FUNC_1845_(arg0)
	...
	registerVal10:linkToElementModel(registerVal14.Tabs.grid, "tabWidget", true, __FUNC_1845_)
	local function __FUNC_18E2_(arg0, arg1, arg2, arg3)
		GoBackAndUpdateSelectedChallengesButton(arg1, arg2)
		return true
	end

	local function __FUNC_1955_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_18E2_, __FUNC_1955_, false)
	...
	local function __FUNC_1A51_(arg1)
		...
		arg1.TabFrame:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Challenges_Scorestreaks.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_1A51_)
