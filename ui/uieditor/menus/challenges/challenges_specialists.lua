...
function LUI.createMenu.Challenges_Specialists(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Challenges_Specialists")
	if PreLoadFunc then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Challenges_Specialists.buttonPrompts")
	...
	local function __FUNC_1696_(arg0, arg1, arg2)
		return IsInGame()
	end

	registerVal7.condition = __FUNC_1696_
	...
	registerVal12.titleLabel:setText(Engine.Localize("HEROES_SPECIALISTS_CAPS"))
	registerVal12.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText(Engine.Localize("HEROES_SPECIALISTS_CAPS"))
	...
	registerVal13:subscribeToGlobalModel(arg0, "PerController", "identityBadge", __FUNC_16DE_)
	local function __FUNC_172E_(arg1)
		registerVal13.CallingCard.CallingCardsFrameWidget:setModel(arg1, arg0)
	end

	registerVal13:subscribeToGlobalModel(arg0, "PerController", nil, __FUNC_172E_)
	...
	registerVal14.Tabs.grid:setDataSource("SpecialistsTabs")
	local function __FUNC_17CC_(arg1, arg2)
		Challenges_UpdateListFromTabChanged(registerVal1, arg1, arg0)
		return nil
	end

	registerVal14:registerEventHandler("list_active_changed", __FUNC_17CC_)
	...
	registerVal10:linkToElementModel(registerVal14.Tabs.grid, "tabWidget", true, __FUNC_1841_)
	local function __FUNC_18DE_(arg0, arg1, arg2, arg3)
		GoBackAndUpdateSelectedChallengesButton(arg1, arg2)
		return true
	end

	local function __FUNC_1951_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_18DE_, __FUNC_1951_, false)
	...
	local function __FUNC_1A4D_(arg1)
		...
		arg1.TabFrame:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Challenges_Specialists.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_1A4D_)
