...
local function __FUNC_2F9_(arg0, arg1)
	...
	local function __FUNC_3EF_(arg0, arg2)
	...
	arg0:registerEventHandler("occlusion_change", __FUNC_3EF_)
end

local function __FUNC_616_(arg0, arg1)
	CoD.FileshareUtility.SetFileshareMode(arg1, Enum.FileshareMode.FILESHARE_MODE_USER)
end

local function __FUNC_703_(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("MyShowcase")
	if __FUNC_616_ then
		__FUNC_616_(registerVal1, arg0)
	end
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "MyShowcase.buttonPrompts")
	...
	local function __FUNC_1790_(arg0, arg1, arg2)
		return IsInGame()
	end

	registerVal7.condition = __FUNC_1790_
	...
	registerVal9.titleLabel:setText(FileshareGetShowcaseTitle(arg0, "MENU_MEDIA_MYSHOWCASE"))
	registerVal9.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText(FileshareGetShowcaseTitle(arg0, "MENU_MEDIA_MYSHOWCASE"))
	...
	local function __FUNC_17DA_(arg1)
		registerVal10:setModel(arg1, arg0)
	end

	registerVal10:subscribeToGlobalModel(arg0, "PerController", "identityBadge", __FUNC_17DA_)
	local function __FUNC_182A_(arg1)
		registerVal10.CallingCard.CallingCardsFrameWidget:setModel(arg1, arg0)
	end

	registerVal10:subscribeToGlobalModel(arg0, "PerController", nil, __FUNC_182A_)
	...
	local function __FUNC_19D5_(arg1, arg2)
		...
		ShowcaseUpdateSelfIdentityWidget(registerVal1, arg0)
		if not nil then
	...
	registerVal1:registerEventHandler("menu_loaded", __FUNC_19D5_)
	local function __FUNC_1B27_(arg0, arg1, arg2, arg3)
	...
	local function __FUNC_1C09_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_1B27_, __FUNC_1C09_, false)
	local function __FUNC_1D05_(arg0, arg1, arg2, arg3)
	...
	local function __FUNC_1D5D_(arg0, arg1, arg2)
	...
	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_START, "O", __FUNC_1D05_, __FUNC_1D5D_, false)
	local function __FUNC_1E82_(arg1)
		SetIsInFileshare(arg0, "false")
	end

	LUI.OverrideFunction_CallOriginalFirst(registerVal1, "close", __FUNC_1E82_)
	...
	local function __FUNC_1EE5_(arg1)
		...
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "MyShowcase.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_1EE5_)
	if __FUNC_2F9_ then
...
LUI.createMenu.MyShowcase = __FUNC_703_
