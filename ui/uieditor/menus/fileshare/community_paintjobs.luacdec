...
function LUI.createMenu.Community_Paintjobs(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Community_Paintjobs")
	if PreLoadFunc then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Community_Paintjobs.buttonPrompts")
	...
	registerVal3:setTopBottom(true, false, 125.000000, 653.000000)
	...
	registerVal8.titleLabel:setText(Engine.Localize("GROUPS_PAINTJOBS_CAPS"))
	registerVal8.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText(Engine.Localize("GROUPS_PAINTJOBS_CAPS"))
	registerVal8.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.FeatureIcon:setImage(RegisterImage("uie_t7_mp_icon_header_paintshop"))
	...
	registerVal11:setLeftRight(true, false, -1.000000, 2495.000000)
	registerVal11:setTopBottom(true, false, 84.000000, 125.000000)
	registerVal11.Tabs.grid:setDataSource("FilesharePublishedPaintjobTabs")
	registerVal11.Tabs.grid:setHorizontalCount(11.000000)
	local function __FUNC_11DA_(arg1, arg2)
		FilesharePublishedTabChanged(registerVal1, arg1, arg0)
		return nil
	end

	registerVal11:registerEventHandler("list_active_changed", __FUNC_11DA_)
	registerVal1:addElement(registerVal11)
	registerVal1.TabList = registerVal11
	local function __FUNC_1246_(arg0, arg1)
	...
	registerVal1:registerEventHandler("menu_loaded", __FUNC_1246_)
	local function __FUNC_12DE_(arg0, arg1, arg2, arg3)
		GoBack(registerVal1, arg2)
		return true
	end

	local function __FUNC_1330_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MP_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_12DE_, __FUNC_1330_, false)
	...
	local function __FUNC_142B_(arg1)
		...
		arg1.TabList:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Community_Paintjobs.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_142B_)
