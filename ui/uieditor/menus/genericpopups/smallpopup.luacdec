...
local function __FUNC_290_(arg0, arg1)
	...
	local function __FUNC_4B3_(arg0, arg1)
		local function __FUNC_547_(arg2, arg3)
			arg1(arg0, arg2, arg3.controller)
		end
...
local function __FUNC_5A0_(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("SmallPopup")
	if PreLoadFunc then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "SmallPopup.buttonPrompts")
	...
	registerVal4:subscribeToGlobalModel(arg0, "Controller", "secondary_button_image", __FUNC_1445_)
	...
	local function __FUNC_151F_(arg1, arg2)
	...
	registerVal9:registerEventHandler("gain_focus", __FUNC_151F_)
	local function __FUNC_16AF_(arg0, arg1)
	...
	registerVal9:registerEventHandler("lose_focus", __FUNC_16AF_)
	local function __FUNC_177E_(arg0, arg1, arg2, arg3)
		GoBack(registerVal1, arg2)
		return true
	end

	local function __FUNC_17D0_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal9, arg0, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", __FUNC_177E_, __FUNC_17D0_, false)
	...
	registerVal11.DefaultClip = __FUNC_18CE_
	registerVal10.DefaultState = registerVal11
	registerVal11 = {}
	local function __FUNC_1B97_()
	...
	registerVal11.DefaultClip = __FUNC_1B97_
	registerVal10.Processing = registerVal11
	registerVal1.clipsPerState = registerVal10
	local function __FUNC_1EBC_(arg0, arg1, arg2, arg3)
		GenericSmallPopupGoBack(registerVal1, arg2)
		return true
	end

	local function __FUNC_1F21_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "")
		return false
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_1EBC_, __FUNC_1F21_, false)
	...
	local function __FUNC_2014_(arg1)
		arg1.BackGround:close()
		arg1.BackButtonPrompt:close()
		arg1.Spinner:close()
		arg1.OkButton:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "SmallPopup.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_2014_)
	if __FUNC_290_ then
...
LUI.createMenu.SmallPopup = __FUNC_5A0_
