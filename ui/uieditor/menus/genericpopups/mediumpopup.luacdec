...
local function __FUNC_5BC_(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("MediumPopup")
	if PreLoadFunc then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "MediumPopup.buttonPrompts")
	...
	local function __FUNC_14CB_(arg0)
	...
	registerVal4:subscribeToGlobalModel(arg0, "Controller", "secondary_button_image", __FUNC_14CB_)
	...
	local function __FUNC_2454_(arg1)
		...
		arg1.OkButton:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "MediumPopup.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_2454_)
	if __FUNC_291_ then
		__FUNC_291_(registerVal1, arg0)
	end
	return registerVal1
end

LUI.createMenu.MediumPopup = __FUNC_5BC_
