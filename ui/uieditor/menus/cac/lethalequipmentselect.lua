...
local function __FUNC_38F_(arg0, arg1)
	local registerVal2 = IsCampaign()
	if registerVal2 then
		arg0.disableBlur = true
	end
	CoD.GenericCACSelectionPreLoadFunc(arg0, arg1)
end

local function __FUNC_448_(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("LethalEquipmentSelect")
	if __FUNC_38F_ then
		__FUNC_38F_(registerVal1, arg0)
	end
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "LethalEquipmentSelect.buttonPrompts")
	...
	registerVal5.background.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText(Engine.Localize("MPUI_PRIMARYGRENADE_CAPS"))
	...
	local function __FUNC_1448_(arg0)
	...
	registerVal5:linkToElementModel(registerVal1, "name", true, __FUNC_1448_)
	local registerVal8 = {}
	local registerVal9 = {}
	registerVal9.stateName = "GridLayout"
	local function __FUNC_158C_(arg0, arg1, arg2)
		return AlwaysTrue()
	end

	registerVal9.condition = __FUNC_158C_
	registerVal8 = {registerVal9}
	registerVal5:mergeStateConditions(registerVal8)
	registerVal1:addElement(registerVal5)
	registerVal1.selectMenuWidget = registerVal5
	local function __FUNC_15D8_(arg0)
		local registerVal1 = Engine.GetModelValue(Engine.GetModel(arg0, "loadoutSlot"))
		if registerVal1 ~= "primarygrenade" then
		end
		return true
	end

	local registerVal6 = LUI.UIList.new(registerVal1, arg0, 7.000000, 0.000000, __FUNC_15D8_, true, false, 0.000000, 0.000000, false, false)
	...
	local function __FUNC_16AE_(arg1)
		local registerVal2 = {}
	...
	registerVal6:linkToElementModel(registerVal6, "itemIndex", true, __FUNC_16AE_)
	local function __FUNC_186A_(arg1, arg2)
	...
	registerVal6:registerEventHandler("list_item_gain_focus", __FUNC_186A_)
	local function __FUNC_199D_(arg1, arg2)
	...
	registerVal6:registerEventHandler("gain_focus", __FUNC_199D_)
	...
	registerVal6:registerEventHandler("lose_focus", __FUNC_1B2F_)
	local function __FUNC_1BFE_(arg0, arg1, arg2, arg3)
	...
	local function __FUNC_1F5B_(arg0, arg1, arg2)
	...
	registerVal1:AddButtonCallbackFunction(registerVal6, arg0, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", __FUNC_1BFE_, __FUNC_1F5B_, true)
	...
	local function __FUNC_2273_(arg1, arg2)
	...
	registerVal7:registerEventHandler("menu_loaded", __FUNC_2273_)
	...
	registerVal8:subscribeToModel(registerVal11, __FUNC_2350_)
	registerVal1:addElement(registerVal8)
	registerVal1.PregameTimerOverlay = registerVal8
	local function __FUNC_247D_(arg1)
		registerVal5:setModel(arg1, arg0)
	end

	registerVal5:linkToElementModel(registerVal6, nil, false, __FUNC_247D_)
	local function __FUNC_24CE_(arg0, arg1)
	...
	registerVal1:registerEventHandler("menu_loaded", __FUNC_24CE_)
	local function __FUNC_2566_(arg0, arg1, arg2, arg3)
		GoBack(registerVal1, arg2)
		PlaySoundSetSound(registerVal1, "menu_no_selection")
		return true
	end

	local function __FUNC_25FE_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_2566_, __FUNC_25FE_, false)
	local function __FUNC_26F9_(arg0, arg1, arg2, arg3)
	...
	local function __FUNC_2765_(arg0, arg1, arg2)
	...
	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_RSTICK_PRESSED, nil, __FUNC_26F9_, __FUNC_2765_, false)
	...
	local function __FUNC_28B7_(arg1)
		...
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "LethalEquipmentSelect.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_28B7_)
...
LUI.createMenu.LethalEquipmentSelect = __FUNC_448_
