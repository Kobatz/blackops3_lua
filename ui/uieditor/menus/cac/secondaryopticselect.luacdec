...
local function __FUNC_70B_(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("SecondaryOpticSelect")
	if __FUNC_352_ then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "SecondaryOpticSelect.buttonPrompts")
	...
	registerVal5.background.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText(Engine.Localize(GetSecondaryAttachmentMenuTitle(arg0, "MPUI_OPTICS_CAPS")))
	...
	local function __FUNC_1792_(arg0, arg1, arg2)
		return AlwaysTrue()
	end

	registerVal9.condition = __FUNC_1792_
	...
	local function __FUNC_17DC_(arg1)
		local registerVal2 = {}
	...
	registerVal6:linkToElementModel(registerVal6, "itemIndex", true, __FUNC_17DC_)
	...
	registerVal6:registerEventHandler("list_item_gain_focus", __FUNC_199A_)
	local function __FUNC_1AAB_(arg1, arg2)
	...
	registerVal6:registerEventHandler("gain_focus", __FUNC_1AAB_)
	...
	registerVal6:registerEventHandler("lose_focus", __FUNC_1C3B_)
	local function __FUNC_1D0A_(arg0, arg1, arg2, arg3)
	...
	local function __FUNC_1DA1_(arg0, arg1, arg2)
	...
	registerVal1:AddButtonCallbackFunction(registerVal6, arg0, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", __FUNC_1D0A_, __FUNC_1DA1_, true)
	registerVal9 = {}
	local registerVal10 = {}
	registerVal10.stateName = "New"
	local function __FUNC_1EDB_(arg1, arg2, arg3)
		return IsCACAttachmentNew(arg1, arg2, arg0)
	end

	registerVal10.condition = __FUNC_1EDB_
	local registerVal11 = {}
	registerVal11.stateName = "NotAvailable"
	local function __FUNC_1F38_(arg0, arg1, arg2)
		return AlwaysFalse()
	end

	registerVal11.condition = __FUNC_1F38_
	...
	registerVal6:linkToElementModel(registerVal6, "itemIndex", true, __FUNC_1F85_)
	...
	local function __FUNC_20A3_(arg1, arg2)
	...
	registerVal7:registerEventHandler("menu_loaded", __FUNC_20A3_)
	...
	registerVal8:subscribeToModel(registerVal11, __FUNC_2180_)
	...
	registerVal5:linkToElementModel(registerVal6, nil, false, __FUNC_22AD_)
	...
	registerVal5:linkToElementModel(registerVal6, "name", true, __FUNC_22FE_)
	local function __FUNC_2440_(arg1)
		registerVal5.selectionInfoWidget.WeaponAttributesInternal:setModel(arg1, arg0)
	end

	registerVal5:linkToElementModel(registerVal6, "weaponAttributes", false, __FUNC_2440_)
	local function __FUNC_24E9_(arg1, arg2)
	...
	registerVal1:registerEventHandler("menu_opened", __FUNC_24E9_)
	local function __FUNC_25BD_(arg0, arg1)
	...
	registerVal1:registerEventHandler("menu_loaded", __FUNC_25BD_)
	...
	local function __FUNC_2811_(arg1)
		...
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "SecondaryOpticSelect.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_2811_)
	if __FUNC_5FA_ then
...
LUI.createMenu.SecondaryOpticSelect = __FUNC_70B_
