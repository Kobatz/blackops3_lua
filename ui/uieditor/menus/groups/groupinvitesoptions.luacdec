...
local function __FUNC_21D_(arg0, arg1)
	arg0.animateInFromOffset = 355.000000
end

local function __FUNC_26E_(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("GroupInvitesOptions")
	if __FUNC_21D_ then
		__FUNC_21D_(registerVal1, arg0)
	end
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "GroupInvitesOptions.buttonPrompts")
	...
	registerVal6:setDataSource("GroupInvitesOverviewButtonList")
	local function __FUNC_14C4_(arg1, arg2)
		ClassOptionsSetHintText(registerVal1, arg1, arg0)
		return nil
	end

	registerVal6:registerEventHandler("list_item_gain_focus", __FUNC_14C4_)
	local function __FUNC_152D_(arg1, arg2)
	...
	registerVal6:registerEventHandler("gain_focus", __FUNC_152D_)
	...
	registerVal6:registerEventHandler("lose_focus", __FUNC_16BF_)
	local function __FUNC_178E_(arg0, arg1, arg2, arg3)
		ProcessListAction(registerVal1, arg0, arg2)
		return true
	end

	local function __FUNC_17EF_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal6, arg0, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", __FUNC_178E_, __FUNC_17EF_, false)
	...
	registerVal7:setText(Engine.Localize("GROUPS_GROUP_INVITES_OPTIONS_CAPS"))
	...
	registerVal11:setTopBottom(true, false, 234.000000, 254.000000)
	...
	registerVal12:setTopBottom(true, false, 239.500000, 248.500000)
	...
	registerVal11:linkToElementModel(registerVal6, "hintText", true, __FUNC_18EA_)
	local registerVal15 = {}
	local registerVal16 = {}
	registerVal16.stateName = "Campaign"
	local function __FUNC_19A2_(arg0, arg1, arg2)
		return IsCampaign()
	end

	registerVal16.condition = __FUNC_19A2_
	local registerVal17 = {}
	registerVal17.stateName = "ClassSets"
	local function __FUNC_19EC_(arg1, arg2, arg3)
	...
	registerVal17.condition = __FUNC_19EC_
	...
	local function __FUNC_1A8E_(arg0)
		local registerVal4 = {}
	...
	registerVal1:subscribeToModel(registerVal15, __FUNC_1A8E_)
	...
	registerVal1:registerEventHandler("ui_keyboard_input", __FUNC_1BB4_)
	local function __FUNC_1C85_(arg0, arg1, arg2, arg3)
		GoBack(registerVal1, arg2)
		ClearSavedState(registerVal1, arg2)
		return true
	end

	local function __FUNC_1D01_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_1C85_, __FUNC_1D01_, false)
	...
	local function __FUNC_1DFD_(arg1)
		arg1.optionsList:close()
		arg1.fefooterRighSlideIn:close()
		arg1.HintText:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "GroupInvitesOptions.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_1DFD_)
...
LUI.createMenu.GroupInvitesOptions = __FUNC_26E_
