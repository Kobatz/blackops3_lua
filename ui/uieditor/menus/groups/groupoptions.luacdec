...
local function __FUNC_266_(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("GroupOptions")
	if __FUNC_216_ then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "GroupOptions.buttonPrompts")
	...
	registerVal6:setDataSource("GroupHeadquartersOverviewButtonList")
	local function __FUNC_14AB_(arg1, arg2)
		ClassOptionsSetHintText(registerVal1, arg1, arg0)
		return nil
	end

	registerVal6:registerEventHandler("list_item_gain_focus", __FUNC_14AB_)
	local function __FUNC_1511_(arg1, arg2)
	...
	registerVal6:registerEventHandler("gain_focus", __FUNC_1511_)
	local function __FUNC_16A3_(arg0, arg1)
	...
	registerVal6:registerEventHandler("lose_focus", __FUNC_16A3_)
	local function __FUNC_1772_(arg0, arg1, arg2, arg3)
		ProcessListAction(registerVal1, arg0, arg2)
		return true
	end

	local function __FUNC_17D3_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "MENU_SELECT")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal6, arg0, Enum.LUIButton.LUI_KEY_XBA_PSCROSS, "ENTER", __FUNC_1772_, __FUNC_17D3_, false)
	...
	registerVal7:setText(Engine.Localize("GROUPS_GROUP_OPTIONS_CAPS"))
	...
	registerVal11:setTopBottom(true, false, 308.000000, 328.000000)
	...
	registerVal12:setTopBottom(true, false, 313.500000, 322.500000)
	...
	registerVal11:linkToElementModel(registerVal6, "hintText", true, __FUNC_18CE_)
	local registerVal15 = {}
	local registerVal16 = {}
	registerVal16.stateName = "Campaign"
	local function __FUNC_1986_(arg0, arg1, arg2)
		return IsCampaign()
	end

	registerVal16.condition = __FUNC_1986_
	local registerVal17 = {}
	registerVal17.stateName = "ClassSets"
	local function __FUNC_19D0_(arg1, arg2, arg3)
	...
	registerVal17.condition = __FUNC_19D0_
	...
	local function __FUNC_1A72_(arg0)
		local registerVal4 = {}
	...
	registerVal1:subscribeToModel(registerVal15, __FUNC_1A72_)
	...
	registerVal1:registerEventHandler("ui_keyboard_input", __FUNC_1B98_)
	local function __FUNC_1C69_(arg0, arg1, arg2, arg3)
		GoBack(registerVal1, arg2)
		ClearSavedState(registerVal1, arg2)
		return true
	end

	local function __FUNC_1CE5_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_1C69_, __FUNC_1CE5_, false)
	...
	local function __FUNC_1DE1_(arg1)
		arg1.optionsList:close()
		arg1.fefooterRighSlideIn:close()
		arg1.HintText:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "GroupOptions.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_1DE1_)
...
LUI.createMenu.GroupOptions = __FUNC_266_
