...
local function __FUNC_359_(arg0)
	for index3=0.000000, 255.000000, 1.000000 do
		...
		local registerVal8 = LUI.startswith(registerVal7.loadoutSlot, "specialty")
		if registerVal7 and 0.000000 <= registerVal7.allocation and registerVal8 then
			...
			local function __FUNC_70E_(arg0)
				return Engine.GetItemRestrictionState(arg0.itemIndex)
			end

			local function __FUNC_7A0_(arg0)
			...
			table.insert({}, CoD.OptionsUtility.CreateItemRestrictionSettings(arg0, registerVal7.name, "", ("CompetitiveSettings_ItemRestriction_" .. registerVal16), registerVal16, registerVal7.image, CoD.OptionsUtility.GametypeSettingsSetItemRestrictionState, registerVal19, __FUNC_70E_, __FUNC_7A0_))
		end
	end
	local function __FUNC_879_(arg0, arg1)
		...
		if registerVal2.loadoutSlot == registerVal3.loadoutSlot then
	...
	table.sort({}, __FUNC_879_)
	return {}
end

local function __FUNC_A04_(arg0, arg1, arg2)
	...
	local registerVal5 = arg1:subscribeToModel(registerVal4, __FUNC_B75_, false)
	arg1.updateSubscription = registerVal5
end

local registerVal3 = DataSourceHelpers.ListSetup("CompetitiveSettingsPerkOptions", __FUNC_359_, nil, nil, __FUNC_A04_)
DataSources.CompetitiveSettingsPerkOptions = registerVal3
local function __FUNC_BCA_(arg0, arg1)
	arg0.disablePopupOpenCloseAnim = true
end

local function __FUNC_C1D_(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Competitive_Settings_Perks")
	if __FUNC_BCA_ then
		__FUNC_BCA_(registerVal1, arg0)
	end
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Competitive_Settings_Perks.buttonPrompts")
	registerVal1.buttonModel = registerVal2
	registerVal1.anyChildUsesUpdateState = true
	registerVal3 = CoD.GameSettings_Background.new(registerVal1, arg0)
	registerVal3:setLeftRight(true, true, 0.000000, 0.000000)
	registerVal3:setTopBottom(true, true, 0.000000, 0.000000)
	registerVal3.MenuFrame.titleLabel:setText(Engine.Localize("MPUI_PERKS_CAPS"))
	registerVal3.MenuFrame.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText(Engine.Localize("MPUI_PERKS_CAPS"))
	...
	registerVal4:setDataSource("CompetitiveSettingsPerkOptions")
	...
	local function __FUNC_182E_(arg1, arg2)
	...
	registerVal4:registerEventHandler("gain_focus", __FUNC_182E_)
	local function __FUNC_19B9_(arg0, arg1)
	...
	registerVal4:registerEventHandler("lose_focus", __FUNC_19B9_)
	local function __FUNC_1A8A_(arg0, arg1, arg2, arg3)
		OpenGameSettingsOptionsMenu(registerVal1, arg0, arg2, arg1)
		return true
	end

	local function __FUNC_1AF9_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_START, "MENU_OPTIONS")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal4, arg0, Enum.LUIButton.LUI_KEY_START, "O", __FUNC_1A8A_, __FUNC_1AF9_, false)
	...
	local function __FUNC_1BF1_(arg0, arg1, arg2)
		return AlwaysTrue()
	end

	registerVal9.condition = __FUNC_1BF1_
	registerVal8 = {registerVal9}
	registerVal5:mergeStateConditions(registerVal8)
	registerVal1:addElement(registerVal5)
	registerVal1.CompetitiveSettingsSelectedItemInfo = registerVal5
	local function __FUNC_1C3C_(arg0, arg1, arg2, arg3)
	...
	local function __FUNC_1D0A_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MENU_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_1C3C_, __FUNC_1D0A_, false)
	...
	local function __FUNC_1E05_(arg1)
		arg1.GameSettingsBackground:close()
		arg1.Options:close()
		arg1.CompetitiveSettingsSelectedItemInfo:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Competitive_Settings_Perks.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_1E05_)
...
LUI.createMenu.Competitive_Settings_Perks = __FUNC_C1D_
