...
local function __FUNC_362_(arg0)
	for index3=0.000000, 255.000000, 1.000000 do
		...
		if registerVal7 and 0.000000 <= registerVal7.allocation then
			if registerVal7.loadoutSlot == "primarygadget" or registerVal7.loadoutSlot == "secondarygadget" then
...
local function __FUNC_906_(arg0, arg1, arg2)
	...
	local function __FUNC_A75_()
		arg1:updateDataSource(false)
	end

	local registerVal5 = arg1:subscribeToModel(registerVal4, __FUNC_A75_, false)
	arg1.updateSubscription = registerVal5
end

local registerVal3 = DataSourceHelpers.ListSetup("CompetitiveSettingsEquipmentOptions", __FUNC_362_, nil, nil, __FUNC_906_)
DataSources.CompetitiveSettingsEquipmentOptions = registerVal3
local function __FUNC_ACA_(arg0, arg1)
	arg0.disablePopupOpenCloseAnim = true
end

local function __FUNC_B1D_(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Competitive_Settings_Equipment")
	if __FUNC_ACA_ then
		__FUNC_ACA_(registerVal1, arg0)
	end
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Competitive_Settings_Equipment.buttonPrompts")
	registerVal1.buttonModel = registerVal2
	registerVal1.anyChildUsesUpdateState = true
	registerVal3 = CoD.GameSettings_Background.new(registerVal1, arg0)
	registerVal3:setLeftRight(true, true, 0.000000, 0.000000)
	registerVal3:setTopBottom(true, true, 0.000000, 0.000000)
	registerVal3.MenuFrame.titleLabel:setText(Engine.Localize("MENU_EQUIPMENT_CAPS"))
	registerVal3.MenuFrame.cac3dTitleIntermediary0.FE3dTitleContainer0.MenuTitle.TextBox1.Label0:setText(Engine.Localize("MENU_EQUIPMENT_CAPS"))
	...
	registerVal4:setDataSource("CompetitiveSettingsEquipmentOptions")
	...
	local function __FUNC_173F_(arg1, arg2)
	...
	registerVal4:registerEventHandler("gain_focus", __FUNC_173F_)
	...
	registerVal4:registerEventHandler("lose_focus", __FUNC_18C9_)
	local function __FUNC_199A_(arg0, arg1, arg2, arg3)
		OpenGameSettingsOptionsMenu(registerVal1, arg0, arg2, arg1)
		return true
	end

	local function __FUNC_1A09_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_START, "MENU_OPTIONS")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal4, arg0, Enum.LUIButton.LUI_KEY_START, "O", __FUNC_199A_, __FUNC_1A09_, false)
	...
	registerVal9.condition = __FUNC_1B01_
	registerVal8 = {registerVal9}
	registerVal5:mergeStateConditions(registerVal8)
	registerVal1:addElement(registerVal5)
	registerVal1.CompetitiveSettingsSelectedItemInfo = registerVal5
	local function __FUNC_1B4C_(arg0, arg1, arg2, arg3)
	...
	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_1B4C_, __FUNC_1C1A_, false)
	...
	local function __FUNC_1D15_(arg1)
		arg1.GameSettingsBackground:close()
		arg1.Options:close()
		arg1.CompetitiveSettingsSelectedItemInfo:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Competitive_Settings_Equipment.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_1D15_)
...
LUI.createMenu.Competitive_Settings_Equipment = __FUNC_B1D_
