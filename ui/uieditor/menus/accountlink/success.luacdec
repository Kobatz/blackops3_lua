...
function LUI.createMenu.Success(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Success")
	if PreLoadFunc then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Success.buttonPrompts")
	...
	registerVal4:setLeftRight(true, false, 489.000000, 791.000000)
	registerVal4:setTopBottom(true, false, 275.050000, 311.050000)
	registerVal4:setText(Engine.Localize("ACCOUNT_LINK_SUCCESS"))
	...
	local function __FUNC_A1F_(arg1, arg2)
	...
	registerVal5:registerEventHandler("button_action", __FUNC_A1F_)
	...
	local function __FUNC_B74_(arg1)
		...
		arg1.button0:close()
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Success.buttonPrompts"))
	end
