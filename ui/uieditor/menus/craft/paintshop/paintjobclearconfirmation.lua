...
local function __FUNC_299_(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("PaintjobClearConfirmation")
	if __FUNC_1E8_ then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "PaintjobClearConfirmation.buttonPrompts")
	...
	registerVal3.Title:setText(Engine.Localize("MENU_PAINTJOB_DELETE_CONFIRMATION"))
	registerVal3.ButtonList:setDataSource("PaintjobOptionsClearButtonList")
	...
	local function __FUNC_A03_(arg1)
		...
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "PaintjobClearConfirmation.buttonPrompts"))
	end
...
LUI.createMenu.PaintjobClearConfirmation = __FUNC_299_
