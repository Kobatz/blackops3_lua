...
local function __FUNC_340_(arg0, arg1)
	CoD.StoreUtility.InitSingleCategoryStoreMenu(arg0, arg1, "MAPPACKS")
end

local function __FUNC_3F2_(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Store_DLC")
	if __FUNC_340_ then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Store_DLC.buttonPrompts")
	...
	local function __FUNC_1293_(arg1)
		registerVal7:setModel(arg1, arg0)
	end

	registerVal7:subscribeToGlobalModel(arg0, "PerController", "identityBadge", __FUNC_1293_)
	local function __FUNC_12E2_(arg1)
		registerVal7.CallingCard.CallingCardsFrameWidget:setModel(arg1, arg0)
	end

	registerVal7:subscribeToGlobalModel(arg0, "PerController", nil, __FUNC_12E2_)
	...
	local function __FUNC_1380_(arg1, arg2)
	...
	registerVal1:registerEventHandler("menu_loaded", __FUNC_1380_)
	...
	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_1412_, __FUNC_14CF_, false)
	local function __FUNC_15C7_(arg0, arg1, arg2, arg3)
	...
	local function __FUNC_163E_(arg0, arg1, arg2)
	...
	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, nil, __FUNC_15C7_, __FUNC_163E_, false)
	local function __FUNC_176C_(arg1)
	...
	LUI.OverrideFunction_CallOriginalFirst(registerVal1, "close", __FUNC_176C_)
	...
	registerVal1:subscribeToGlobalModel(arg0, "PerController", "StoreRoot.ready", __FUNC_1871_)
	...
	local function __FUNC_195A_(arg1)
		arg1.frame:close()
		...
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Store_DLC.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_195A_)
...
LUI.createMenu.Store_DLC = __FUNC_3F2_
