...
local function __FUNC_34C_(arg0, arg1)
	...
	local function __FUNC_41A_(arg0, arg2)
		if not arg2.occluded and arg2.occludedBy and arg2.occludedBy.id == "Menu.Store_CodPoints" then
			CoD.perController[arg1].selectedStoreCategory = "OUTFITS"
			ForceNotifyControllerModel(arg1, "StoreRoot.ready")
		end
		arg0.originalOcclusionChange(arg0, arg2)
	end

	arg0:registerEventHandler("occlusion_change", __FUNC_41A_)
end

local function __FUNC_5DA_(arg0, arg1)
	CoD.StoreUtility.InitSingleCategoryStoreMenu(arg0, arg1, "OUTFITS")
end

local function __FUNC_689_(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Store_Outfits")
	if __FUNC_5DA_ then
		__FUNC_5DA_(registerVal1, arg0)
	end
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Store_Outfits.buttonPrompts")
	...
	registerVal7:subscribeToGlobalModel(arg0, "PerController", "identityBadge", __FUNC_14EB_)
	local function __FUNC_153A_(arg1)
		registerVal7.CallingCard.CallingCardsFrameWidget:setModel(arg1, arg0)
	end

	registerVal7:subscribeToGlobalModel(arg0, "PerController", nil, __FUNC_153A_)
	...
	local function __FUNC_15D8_(arg0, arg1, arg2, arg3)
		GoBack(registerVal1, arg2)
		ClearMenuSavedState(arg1)
		return true
	end

	local function __FUNC_1655_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MP_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_15D8_, __FUNC_1655_, false)
	local function __FUNC_174F_(arg0, arg1, arg2, arg3)
	...
	local function __FUNC_17C6_(arg0, arg1, arg2)
	...
	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, nil, __FUNC_174F_, __FUNC_17C6_, false)
	local function __FUNC_18F4_(arg1)
		SetControllerModelValue(arg0, "StoreRoot.isCategoryListinFocus", 0.000000)
		SetGlobalModelValueArg("UpdateOnStoreClose", 1.000000)
	end

	LUI.OverrideFunction_CallOriginalFirst(registerVal1, "close", __FUNC_18F4_)
	local function __FUNC_19D4_(arg1)
	...
	registerVal1:subscribeToGlobalModel(arg0, "PerController", "StoreRoot.ready", __FUNC_19D4_)
	...
	local function __FUNC_1ABE_(arg1)
		...
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Store_Outfits.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_1ABE_)
	if __FUNC_34C_ then
...
LUI.createMenu.Store_Outfits = __FUNC_689_
