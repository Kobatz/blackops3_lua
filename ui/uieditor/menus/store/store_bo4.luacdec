...
local function __FUNC_340_(arg0, arg1)
	CoD.StoreUtility.InitSingleCategoryStoreMenu(arg0, arg1, "BO4")
end

local function __FUNC_3ED_(arg0)
	local registerVal1 = CoD.Menu.NewForUIEditor("Store_BO4")
	if __FUNC_340_ then
	...
	local registerVal2 = Engine.CreateModel(registerVal3, "Store_BO4.buttonPrompts")
	...
	local function __FUNC_128F_(arg1)
		registerVal7:setModel(arg1, arg0)
	end

	registerVal7:subscribeToGlobalModel(arg0, "PerController", "identityBadge", __FUNC_128F_)
	local function __FUNC_12DE_(arg1)
		registerVal7.CallingCard.CallingCardsFrameWidget:setModel(arg1, arg0)
	end

	registerVal7:subscribeToGlobalModel(arg0, "PerController", nil, __FUNC_12DE_)
	...
	local function __FUNC_137C_(arg1, arg2)
	...
	registerVal1:registerEventHandler("menu_loaded", __FUNC_137C_)
	local function __FUNC_140E_(arg0, arg1, arg2, arg3)
	...
	local function __FUNC_14CB_(arg0, arg1, arg2)
		CoD.Menu.SetButtonLabel(arg1, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, "MP_BACK")
		return true
	end

	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBB_PSCIRCLE, nil, __FUNC_140E_, __FUNC_14CB_, false)
	local function __FUNC_15C3_(arg0, arg1, arg2, arg3)
	...
	registerVal1:AddButtonCallbackFunction(registerVal1, arg0, Enum.LUIButton.LUI_KEY_XBX_PSSQUARE, nil, __FUNC_15C3_, __FUNC_163A_, false)
	local function __FUNC_1768_(arg1)
	...
	LUI.OverrideFunction_CallOriginalFirst(registerVal1, "close", __FUNC_1768_)
	local function __FUNC_186D_(arg1)
	...
	registerVal1:subscribeToGlobalModel(arg0, "PerController", "StoreRoot.ready", __FUNC_186D_)
	...
	local function __FUNC_1956_(arg1)
		arg1.frame:close()
		...
		local registerVal3 = Engine.GetModelForController(arg0)
		Engine.UnsubscribeAndFreeModel(Engine.GetModel(registerVal3, "Store_BO4.buttonPrompts"))
	end

	LUI.OverrideFunction_CallOriginalSecond(registerVal1, "close", __FUNC_1956_)
...
LUI.createMenu.Store_BO4 = __FUNC_3ED_
